...
import { CCharaConfDebuff } from '../../../roro/m/js/CCharaConfDebuff.js';
...
import { IsLongRange } from '../../../roro/m/js/equip.js';
import { weaponsize, zokusei } from '../../../roro/m/js/etc.js';
import {
...
import { MOB_CONF_BUF_ID_DAMAGE_DIVIDE, MOB_CONF_BUF_ID_MAX_PAIN, n_B_KYOUKA } from '../../../roro/m/js/mobconfbuf.js';
import {
...
import { MONSTER_ID_PLAYER, MonsterObjNew } from '../../../roro/m/js/monster.dat.js';
import { GetMonseterElmBasicType } from '../../../roro/m/js/monster.h.js';
import {
...
import {
         ...
         TIME_ITEM_ID_ADD_ELEMENTAL_POISON_ATK_50,
...
//			wbairitu = 700;		// 旧仕様
		...
		case SKILL_ID_METEOR_STORM_BUSTER: {
			...
			if (battleCalcInfo.parentSkillId === undefined) {
				...
				wbairitu += 5 * n_A_ActiveSkillLV * madogaku;			// 習得済みスキル条件
				wbairitu += 3 * GetTotalSpecStatus(MIG_PARAM_ID_SPL);	// 特性ステータス補正
				// 最終倍率
				wbairitu *= n_A_BaseLV / 100;												// BaseLv補正
				wbairitu = Math.floor(wbairitu);
