...
import {
         ...
         CARD_ID_BABY_HALLUCIGENIA, CARD_ID_BANSHEE, CARD_ID_BLUE_OSIDOS,
         CARD_ID_BOGYAKUNO_COELACANTH, CARD_ID_BOW_GUARDIAN, CARD_ID_BUGISGIS,
         CARD_ID_CATHERINE_GAEBOLG, CARD_ID_COTNESS, CARD_ID_EDDGA, CARD_ID_EFREET,
         CARD_ID_EKIO, CARD_ID_ENCHANT_ANSOKUNO_NIEVE_SEISHIN,
         CARD_ID_ENCHANT_ANSOKUNO_NIEVE_TAIRYOKU, CARD_ID_ENCHANT_A_STR,
         CARD_ID_ENCHANT_ENERGY_CHIMEINO_ICHIGEKI, CARD_ID_ENCHANT_ENERGY_MADO,
         CARD_ID_ENCHANT_ENERGY_SHUGORYU, CARD_ID_ENCHANT_E_FIRE,
         CARD_ID_ENCHANT_E_GROUND, CARD_ID_ENCHANT_E_WATER, CARD_ID_ENCHANT_E_WIND,
         CARD_ID_ENCHANT_FUKUTSU, CARD_ID_ENCHANT_KINGYUKYU, CARD_ID_ENCHANT_KYOKAIKYU,
         CARD_ID_ENCHANT_MEIYONO_NIEVE_MEICHU, CARD_ID_ENCHANT_SENZAI_KAIHO_MECHANIC,
         CARD_ID_ENCHANT_SHINO_NIEVE_MABO, CARD_ID_ENCHANT_SHINO_NIEVE_TAIRYOKU,
         CARD_ID_ERIOT, CARD_ID_E_EA1L, CARD_ID_FRUS, CARD_ID_FUINSARETA_EFREET,
         CARD_ID_FUSHINO_GUNDAN, CARD_ID_GEMINI, CARD_ID_GERTIE_UH_MVP,
         CARD_ID_GESUI_CLAMP, CARD_ID_GIBBET, CARD_ID_GIGANTES, CARD_ID_GOAT,
         CARD_ID_GOKU, CARD_ID_GOLD_OSIDOS, CARD_ID_HALLUCIGENIA, CARD_ID_HEART_HUNTER,
         CARD_ID_HEART_HUNTER_AT, CARD_ID_HENINO_COELACANTH,
         CARD_ID_INISHIENO_FLAME_SHOOTER, CARD_ID_INISHIENO_MEGLIS,
         CARD_ID_INISHIENO_WOOTANG_SHOOTER, CARD_ID_JEJERIN, CARD_ID_JESTER,
         CARD_ID_KAPPA, CARD_ID_KONTONNO_HUNTERFLY, CARD_ID_KONTONNO_KILLER_MANTICE,
         CARD_ID_KYODAI_WHISPER, CARD_ID_LEO, CARD_ID_LICHT_HERRSCHER, CARD_ID_LOLA,
         CARD_ID_LOVA_KIMA, CARD_ID_LOVA_RURU, CARD_ID_LOVA_SHINKA_KIMA,
         CARD_ID_LOVA_SHINKA_RURU, CARD_ID_MARYOKU_CHUDOKU_PLAGA,
         CARD_ID_MECHANIC_HAWARD_MVP, CARD_ID_MEGALITH, CARD_ID_MINSTREL_ARFOSIO_MVP,
         CARD_ID_MUGENNO_EDDGA, CARD_ID_PISCES, CARD_ID_PLASMA_RAT,
         CARD_ID_POWERFUL_SKELETON, CARD_ID_POWERFUL_S_SKELETON,
         CARD_ID_PRESENT_HOSOTANTOSHA, CARD_ID_RANDEL_RORENCE_MVP, CARD_ID_REMOVER,
         CARD_ID_RIDEWORD, CARD_ID_ROCKSTEP, CARD_ID_ROYAL_GUARD_RANDEL_MVP,
         CARD_ID_SAGITTARIUS, CARD_ID_SERPENTARIUS, CARD_ID_SHINKAINO_CEDORA,
         CARD_ID_SHINSONO_KOO_GLOZA, CARD_ID_SHOGUN_DAEHYON, CARD_ID_SHURA_CHENG_MVP,
         CARD_ID_SIDE_RIDER, CARD_ID_SORCERER_CERIA_MVP, CARD_ID_STING,
         CARD_ID_SWORD_GUARDIAN, CARD_ID_TOP_BLADE_RIDER, CARD_ID_TRENTINI,
         CARD_ID_WAKUWAKU, CARD_ID_WANDERER_TRENTINI_MVP, CARD_ID_WARLOCK_CATHERINE_MVP,
         CARD_ID_ZYUKIHE, CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_EFREET,
...
import {
         ...
         CARD_REGION_ID_ACCESSORY_ANY, CARD_REGION_ID_ANY, CARD_REGION_ID_ARMS_LEFT_1,
         CARD_REGION_ID_ARMS_LEFT_2, CARD_REGION_ID_ARMS_LEFT_3,
         CARD_REGION_ID_ARMS_LEFT_4, CARD_REGION_ID_ARMS_LEFT_ANY,
         CARD_REGION_ID_ARMS_RIGHT_1, CARD_REGION_ID_ARMS_RIGHT_2,
         CARD_REGION_ID_ARMS_RIGHT_3, CARD_REGION_ID_ARMS_RIGHT_4,
         CARD_REGION_ID_ARMS_RIGHT_ANY, CARD_REGION_ID_BODY, CARD_REGION_ID_BODY_ANY,
         ...
         CARD_REGION_ID_HEAD_MID_ANY, CARD_REGION_ID_HEAD_TOP,
         CARD_REGION_ID_HEAD_TOP_ANY, CARD_REGION_ID_HEAD_UNDER,
         CARD_REGION_ID_HEAD_UNDER_ANY, CARD_REGION_ID_SHIELD, CARD_REGION_ID_SHIELD_ANY,
...
import {
         ...
         ITEM_ID_AKUMASUHAISHANO_KUTSU, ITEM_ID_AMANOZYAKUNO_KIMEN, ITEM_ID_ANEMOS_SHIELD,
         ITEM_ID_ANGELING_SUITS, ITEM_ID_ANSONINO_FUKU, ITEM_ID_ANTIMAGIC_SUIT,
         ITEM_ID_ANUBISNO_BOSHI, ITEM_ID_ARCHER_FIGURE, ITEM_ID_ASSAULT_SUIT,
         ITEM_ID_AVENGER_SHOTGUN, ITEM_ID_BANGUNGOT_BOOTS, ITEM_ID_BARREL_HELM,
         ITEM_ID_BATTLE_FOOK, ITEM_ID_BAYANI_BANGUNGOT_BOOTS, ITEM_ID_BECHEL_AXE,
         ITEM_ID_BLAZING_SOUL, ITEM_ID_BLUTO_ARCWAND, ITEM_ID_BLUTO_CLEAVER,
         ITEM_ID_BLUTO_DUMASCUS, ITEM_ID_BLUTO_FUMASHURIKEN, ITEM_ID_BLUTO_GATLINGGUN,
         ITEM_ID_BLUTO_GRENADEGUN, ITEM_ID_BLUTO_GUITAR, ITEM_ID_BLUTO_HANDGUN,
         ITEM_ID_BLUTO_HUNTER_BOW, ITEM_ID_BLUTO_KATAR, ITEM_ID_BLUTO_MORNINGSTAR,
         ITEM_ID_BLUTO_RARIET, ITEM_ID_BLUTO_RIFLE, ITEM_ID_BLUTO_SHOTGUN,
         ITEM_ID_BLUTO_SPEAR, ITEM_ID_BOSS_BO, ITEM_ID_BRUNHILD, ITEM_ID_CACRAM,
         ITEM_ID_CHALEUR_SHOES, ITEM_ID_CHAMELEON_ARMER, ITEM_ID_CHAPUCHAPU_NYANPU_HAT,
         ITEM_ID_CHEMICAL_GLOVE, ITEM_ID_CHIKARANO_GLOVE, ITEM_ID_CHIKARANO_ZIKU_BOOTS,
         ITEM_ID_CHIKARANO_ZIKU_BOOTS_S1, ITEM_ID_CHINMOKUNO_SHIKKOSHA,
         ITEM_ID_CHIRYOKUNO_ZIKU_BOOTS, ITEM_ID_CHIRYOKUNO_ZIKU_BOOTS_S1, ITEM_ID_CHRONOS,
         ITEM_ID_DAISHIZENNO_GUITAR, ITEM_ID_DAISHIZENNO_ROPE, ITEM_ID_DAKATSU_DAIZENSHU,
         ITEM_ID_DAKITSUKI_SYAMNEKO, ITEM_ID_DARK_RING, ITEM_ID_DARK_TRIAD,
         ITEM_ID_DEATH_BRINGER, ITEM_ID_DIABOLOS_BOOTS, ITEM_ID_DIA_DE_MUERTOS,
         ITEM_ID_DIVA_AXE, ITEM_ID_DIVA_BLADE, ITEM_ID_DIVA_CRAW, ITEM_ID_DIVA_CRAYMORE,
         ITEM_ID_DIVA_DAGGER, ITEM_ID_DIVA_FOXTAIL, ITEM_ID_DIVA_FUMA_SHURIKEN,
         ITEM_ID_DIVA_GATLINGGUN, ITEM_ID_DIVA_GRENADEGUN, ITEM_ID_DIVA_HANDGUN,
         ITEM_ID_DIVA_KATAR, ITEM_ID_DIVA_MACE, ITEM_ID_DIVA_MANT, ITEM_ID_DIVA_RANCE,
         ITEM_ID_DIVA_RIFLE, ITEM_ID_DIVA_SHOES, ITEM_ID_DIVA_SHOTGUN, ITEM_ID_DIVA_SPEAR,
         ITEM_ID_DIVA_TWOHAND_AXE, ITEM_ID_DIVA_WING, ITEM_ID_DOOM_SLAYER,
         ITEM_ID_DORAM_CAPE, ITEM_ID_DORAM_SHOES, ITEM_ID_DORAM_SUITS,
         ITEM_ID_DRAGON_CLOTH, ITEM_ID_DRAKE_COAT, ITEM_ID_DRIVER_BAND_AKA,
         ITEM_ID_DRIVER_BAND_KIRO, ITEM_ID_EIHWAZ_KNIFE, ITEM_ID_EIYUNO_YUBIWA,
         ITEM_ID_EMERALD_RING, ITEM_ID_ENRYUNO_YOROI, ITEM_ID_ESLANNO_SHIRT,
         ITEM_ID_ESPRIT_SHOES, ITEM_ID_EUROPA_ROBE, ITEM_ID_EXCELION_LEG,
         ITEM_ID_EXELION_SHIELD, ITEM_ID_EXELION_SUIT, ITEM_ID_FAFNIR_BREATH,
         ITEM_ID_FAFNIR_HELM, ITEM_ID_FAIRLY_CLOTH, ITEM_ID_FAIRY_OF_EDEN,
         ITEM_ID_FAIRY_OF_EDEN_T1, ITEM_ID_FIFTH_ELEMENT, ITEM_ID_FROID_SHOES,
         ITEM_ID_FULL_FORCE, ITEM_ID_FURIONI_WING, ITEM_ID_FURUBITA_BLAZINGSOUL,
         ITEM_ID_FURUBITA_KAZENO_SASAYAKI, ITEM_ID_FURUBITA_MEISAIUSAGI,
         ITEM_ID_FURUBITA_MIDASS, ITEM_ID_FURUBITA_SHUGONOKANNMURI,
         ITEM_ID_FUSHICHONO_KANMURI, ITEM_ID_FUSHICHONO_RING, ITEM_ID_FUYUSURU_ARTIFACT,
         ITEM_ID_GAIA_SHIELD, ITEM_ID_GALAXY_CIRCLET, ITEM_ID_GAMBLER_SEAL,
         ITEM_ID_GATE_KEEPER_DD, ITEM_ID_GEFENIA_MIZUNO_KOSHO, ITEM_ID_GHOSTRING_SUITS,
         ITEM_ID_GIGANT_AXE, ITEM_ID_GIGANT_BOOTS, ITEM_ID_GIGANT_LANCE,
         ITEM_ID_GIKONO_ZIKU_BOOTS, ITEM_ID_GIKONO_ZIKU_BOOTS_S1,
         ITEM_ID_GLORIOUS_FUKYUYO_SHOES, ITEM_ID_GLORIOUS_FUKYUYO_SUIT,
         ITEM_ID_GLORIOUS_MUFFLER, ITEM_ID_GLORIOUS_RYOSANGATA_SHOES,
         ITEM_ID_GLORIOUS_RYOSANGATA_SUIT, ITEM_ID_GLORIOUS_SHOES, ITEM_ID_GLORIOUS_SUIT,
         ITEM_ID_GODS_HELM, ITEM_ID_GOYUMUSONO_MIKOSHI, ITEM_ID_GRACE_ANIMAL_ROBE,
         ITEM_ID_GRACE_CONFIDENCIAL_MAIL, ITEM_ID_GRACE_CRUCIFORM_SUIT,
         ITEM_ID_GRACE_CULTIVATION_COAT, ITEM_ID_GRACE_HOLY_ROBE,
         ITEM_ID_GRACE_MAGMA_SUIT, ITEM_ID_GRACE_MENUS_SUIT, ITEM_ID_GRACE_PSYCHIC_ROBE,
         ITEM_ID_GRACE_PUNISHMENT_ROBE, ITEM_ID_GRACE_RAINSTORM_SUIT,
         ITEM_ID_GRACE_SCULL_ROBE, ITEM_ID_GRACE_TENCHI_SUIT, ITEM_ID_GUARDIAN_OF_SOUL,
         ITEM_ID_GWIBERNO_KAWA, ITEM_ID_HADENA_PHANTOM_MASK, ITEM_ID_HAGALAZ_KNIFE,
         ITEM_ID_HAIHANENO_BOOTS, ITEM_ID_HAKUYOKYUNO_SPEAR, ITEM_ID_HEAVENLY_ORDER,
         ITEM_ID_HITSUKISHINZI, ITEM_ID_HORGRENNO_SEIREN_HUMMER, ITEM_ID_HUNTING_SPEAR,
         ITEM_ID_HYAKUSENRENMANO_OMAMORI, ITEM_ID_IDUNNNO_HANEMIMI,
         ITEM_ID_ILLUSION_BOOTS, ITEM_ID_ILLUSION_CAP, ITEM_ID_ILLUSION_DOOM_SLAYER,
         ITEM_ID_ILLUSION_GOIBHNIUNO_GUNKA, ITEM_ID_ILLUSION_GOIBHNIUNO_KABUTO,
         ITEM_ID_ILLUSION_GOIBHNIUNO_KATAKAZARI, ITEM_ID_ILLUSION_GOIBHNIUNO_YOROI,
         ITEM_ID_ILLUSION_MILITARY_BOOTS, ITEM_ID_ILLUSION_MUFFLER,
         ITEM_ID_ILLUSION_RENGEKINO_TSUME, ITEM_ID_ILLUSION_RING, ITEM_ID_ILLUSION_SHOES,
         ITEM_ID_ILUSION_LEG_1, ITEM_ID_ILUSION_LEG_2, ITEM_ID_IMPERIAL_ANIMAL_ROBE,
         ITEM_ID_IMPERIAL_CONFIDENCIAL_MAIL, ITEM_ID_IMPERIAL_CRUCIFORM_SUIT,
         ITEM_ID_IMPERIAL_CULTIVATION_COAT, ITEM_ID_IMPERIAL_GLORY,
         ...
         ITEM_ID_IMPERIAL_SCULL_ROBE, ITEM_ID_IMPERIAL_TENCHI_SUIT, ITEM_ID_IRON_NAIL,
         ITEM_ID_JUNGLE_CARBIN, ITEM_ID_KAGAKUSHANO_MANT, ITEM_ID_KAIRYOGATA_POWERED_SUIT,
         ITEM_ID_KAKUSE_FULL_FORCE, ITEM_ID_KANO_KNIFE, ITEM_ID_KARD,
         ITEM_ID_KARYUDONO_MANT, ITEM_ID_KAWAII_KUSANO_NECKLACE, ITEM_ID_KENSENO_OKAN,
         ITEM_ID_KENZYANO_KUTSU, ITEM_ID_KIBONO_UWABAKI,
         ITEM_ID_KIKAININGYOYO_KASOKUSOCHI_KAI, ITEM_ID_KIKAININGYOYO_ZOFUKUSOCHI_KAI,
         ITEM_ID_KINGYUKYUNO_SWORD, ITEM_ID_KINKINO_MADOSHO,
         ITEM_ID_KIRAKIRA_NYANNYAN_CHOKER, ITEM_ID_KISHINNO_MEIYU, ITEM_ID_KIYOSANO_GLOVE,
         ITEM_ID_KIZOKUNO_KAMEN, ITEM_ID_KODAIZYUNO_TSUE, ITEM_ID_KOINNO_TSURUHASHI,
         ITEM_ID_KOKYU_DORAM_CAPE, ITEM_ID_KOKYU_DORAM_SHOES, ITEM_ID_KOKYU_DORAM_SUITS,
         ITEM_ID_KONGOSEKINO_KUTSU, ITEM_ID_KONGOSEKINO_TATE,
         ITEM_ID_KOREIZYUTSUSHINO_GAITO, ITEM_ID_KORYUNO_TENYOKU,
         ITEM_ID_KOUNNO_ZIKU_BOOTS, ITEM_ID_KOUNNO_ZIKU_BOOTS_S1, ITEM_ID_KOYANO_YOZINBO,
         ITEM_ID_KRASNAYA, ITEM_ID_KUROHANO_SUIT, ITEM_ID_KUROITOODOSHI_DOMARU,
         ITEM_ID_KUWAETA_ICHIGO, ITEM_ID_KYOKAIKYUNO_AXE, ITEM_ID_KYOZINNO_KAGO,
         ITEM_ID_LACRYMA_STICK, ITEM_ID_LAGUZ_KNIFE, ITEM_ID_LAMORT_SHOES,
         ITEM_ID_LEVAIN_SHOES, ITEM_ID_LIEN_SHOES, ITEM_ID_LINDWURMNO_KAWA,
         ITEM_ID_LOLANO_PLATEMAIL, ITEM_ID_LONG_HORN, ITEM_ID_LUMIERE_SHOES,
         ITEM_ID_MAHONO_STOLE, ITEM_ID_MAKATSUKYUNO_THIEF_BOW, ITEM_ID_MAKKANA_DRESSHAT,
         ITEM_ID_MARYOKUNO_KUSANO_NECKLACE, ITEM_ID_MATAGINO_KENNATA,
         ITEM_ID_MAZYUNO_MAIL, ITEM_ID_MENTAL_STICK, ITEM_ID_METEOR_STRIKE,
         ITEM_ID_MIDASSNO_SASAYAKI, ITEM_ID_MIRRORAGE_AXE, ITEM_ID_MIRRORAGE_BLADE,
         ITEM_ID_MIRRORAGE_CRAW, ITEM_ID_MIRRORAGE_CRAYMORE, ITEM_ID_MIRRORAGE_DAGGER,
         ITEM_ID_MIRRORAGE_FOXTAIL, ITEM_ID_MIRRORAGE_FUMA_SHURIKEN,
         ITEM_ID_MIRRORAGE_GATLINGGUN, ITEM_ID_MIRRORAGE_GRENADEGUN,
         ITEM_ID_MIRRORAGE_HANDGUN, ITEM_ID_MIRRORAGE_KATAR, ITEM_ID_MIRRORAGE_MACE,
         ITEM_ID_MIRRORAGE_MANT, ITEM_ID_MIRRORAGE_RANCE, ITEM_ID_MIRRORAGE_RIFLE,
         ITEM_ID_MIRRORAGE_SHOES, ITEM_ID_MIRRORAGE_SHOTGUN, ITEM_ID_MIRRORAGE_SPEAR,
         ITEM_ID_MIRRORAGE_TWOHAND_AXE, ITEM_ID_MIRRORAGE_WING,
         ITEM_ID_MOENTO_HAKUMANO_YUBIWA, ITEM_ID_MOKOFUWA_SHARK_PAJAMA,
         ITEM_ID_MUBYOSOKUSAINO_OMAMORI, ITEM_ID_MYSTERY_WING, ITEM_ID_NABUNO_HOOD,
         ITEM_ID_NAMONAKI_KENNSHINO_BOOTS, ITEM_ID_NATURAL_CLOTH, ITEM_ID_NECTAR_SUIT,
         ITEM_ID_NEKOZYARASHINO_MOKEI, ITEM_ID_NIEVE_VALLETTA, ITEM_ID_NORTHERN_CROSS,
         ITEM_ID_NOVICE_FIGURE, ITEM_ID_ODINNO_SHUKUFUKU_FRIGG_SET,
         ITEM_ID_OGATA_MAJESTIC_GOAT, ITEM_ID_OKINA_NEKOZYARASHINO_MOKEI,
         ITEM_ID_OMOCHANO_YUBIWA, ITEM_ID_ONDINENO_YARI, ITEM_ID_ONIMARU,
         ITEM_ID_ORCA_CLOTH, ITEM_ID_PARACELSUS_COAT, ITEM_ID_PARACELSUS_GLOVE,
         ITEM_ID_PLATINUM_ARBITRATOR, ITEM_ID_POISON_SHOES, ITEM_ID_POROROCA_SHOES,
         ITEM_ID_POWERED_CHIP, ITEM_ID_PRETTY_URIBO_SHOES, ITEM_ID_PROTECT_FEATHER,
         ITEM_ID_RADOONNO_KAWA, ITEM_ID_REQUIEM_BOOTS, ITEM_ID_REQUIEM_MANT,
         ITEM_ID_REQUIEM_ROBE, ITEM_ID_REQUIEM_SUIT, ITEM_ID_RING_OF_JUPITER,
         ITEM_ID_RINRIN_NYAN_KABERU, ITEM_ID_RUNA_BOW, ITEM_ID_RUNE_BOOTS,
         ITEM_ID_RUNE_CIRCLET, ITEM_ID_RUNE_HELM, ITEM_ID_SABAKINO_KUTSU,
         ITEM_ID_SABITA_ARM, ITEM_ID_SANSO_BOMBE, ITEM_ID_SANTANO_HIGE,
         ITEM_ID_SCARABA_HIGHHEEL, ITEM_ID_SCHMITTNO_HELM, ITEM_ID_SEIGINO_KANMURI,
         ITEM_ID_SEIKONA_NEKOZYARASHINO_MOKEI, ITEM_ID_SEINARU_HAKUI,
         ITEM_ID_SENSAINA_NEKOZYARASHINO_MOKEI, ITEM_ID_SENSHISHANO_MANT,
         ITEM_ID_SEVEN_ELEVEN_HEADPHONE, ITEM_ID_SHADOW_CROWN, ITEM_ID_SHEPHARD_CLOTH,
         ITEM_ID_SHIELD_RING, ITEM_ID_SHIKENKAN_BOOTS, ITEM_ID_SHIKKOSHANO_MANT,
         ITEM_ID_SHIKKOUSHANO_SHOES, ITEM_ID_SHINSENNA_KUSANO_NECKLACE,
         ITEM_ID_SHIRONO_KISHIDANNO_YOROI, ITEM_ID_SHIRYOMAZYUTSUSHINO_NITTOBO,
         ITEM_ID_SHISHIKYUNO_MACE, ITEM_ID_SHISHINO_KAMEN,
         ITEM_ID_SHITENSHINO_HANAKANMURI, ITEM_ID_SHUKUSEINO_KUTSU,
         ITEM_ID_SHUNBINNO_ZIKU_BOOTS, ITEM_ID_SHUNBINNO_ZIKU_BOOTS_S1,
         ITEM_ID_SHUZINNO_FUKU, ITEM_ID_SKIN_OF_SHADOW, ITEM_ID_SKTOM,
         ITEM_ID_SNIPING_VEIL, ITEM_ID_SOL_SHOES, ITEM_ID_SOMBRE_SHOES,
         ITEM_ID_SOZIKYUNO_ROPE, ITEM_ID_SOZIKYUNO_VIOLIN, ITEM_ID_SPRINT_MAIL,
         ITEM_ID_STRAWBERRY_HAT, ITEM_ID_STUFF_OF_CURSING, ITEM_ID_SURVIVAL_SHOES,
         ITEM_ID_SUVEL, ITEM_ID_SWORDMAN_FIGURE, ITEM_ID_TAIRYOKUNO_GLOVE,
         ITEM_ID_TAIRYOKUNO_ZIKU_BOOTS, ITEM_ID_TAIRYOKUNO_ZIKU_BOOTS_S1,
         ITEM_ID_TAKOHIKI_HOCHO, ITEM_ID_TARE_LEAF, ITEM_ID_TATSUINUNO_UDEWA,
         ITEM_ID_TATSUZINNO_ONO, ITEM_ID_TATSUZINNO_ONO_S2, ITEM_ID_TENBINKYUNO_DIADEM,
         ITEM_ID_TENBINKYUNO_KRASNAYA, ITEM_ID_TENGUNO_GETA, ITEM_ID_TENKATSUKYUNO_KATAR,
         ITEM_ID_TOKUSEN_DORAM_CAPE, ITEM_ID_TOKUSEN_DORAM_SHOES,
         ITEM_ID_TOKUSEN_DORAM_SUITS, ITEM_ID_TOZANGUTSU, ITEM_ID_TOZOKUNO_YUBIWA,
         ITEM_ID_TRAVELER_RING, ITEM_ID_TRAVELER_SHOES, ITEM_ID_TSUGAKU_BAG,
         ITEM_ID_TUPOONNO_KAWA, ITEM_ID_TURTLE_FOX_TAIL, ITEM_ID_TWIN_HEAD_DRAGON_BOOTS,
         ITEM_ID_TWIN_HEAD_DRAGON_MAIL, ITEM_ID_URUZ_GREAVE, ITEM_ID_URUZ_PLATE,
         ITEM_ID_VALKIRIE_SHOES, ITEM_ID_VALKYRIE_HAMMER, ITEM_ID_VALKYRIE_KNIFE,
         ITEM_ID_VARIANT_SHOES, ITEM_ID_VERMIN_CLOTH, ITEM_ID_VICIOUS_CLOTH,
         ITEM_ID_WAKUWAKU_MANT, ITEM_ID_WHITE_FEATHER, ITEM_ID_WORK_CAP,
         ITEM_ID_YOICHINO_KATAKAE, ITEM_ID_YOZINBONO_SCARF, ITEM_ID_YSF01_GREEVE,
         ITEM_ID_YUSHANO_BROACH, ITEM_ID_YUSHANO_MAGIC_COAT, ITEM_ID_ZIKEIDANNNO_SUITS,
         ITEM_ID_ZIKU_BOOTS, ITEM_ID_ZINBAKYUNO_HUNTER_BOW, ITEM_ID_ZYANENNO_BOW,
         ITEM_ID_ZYANENNO_DAGGER, ITEM_ID_ZYANENNO_FIST, ITEM_ID_ZYANENNO_FUMASHURIKEN,
         ITEM_ID_ZYANENNO_HANDGUN, ITEM_ID_ZYANENNO_KATAR, ITEM_ID_ZYANENNO_LANCE,
         ITEM_ID_ZYANENNO_MACE, ITEM_ID_ZYANENNO_SAVOR, ITEM_ID_ZYANENNO_SPEAR,
         ITEM_ID_ZYANENNO_TWOHAND_AXE, ITEM_ID_ZYANENNO_TWOHAND_SWORD,
         ITEM_ID_ZYASPER_CIRCLET, ITEM_ID_ZYASPER_RING, ITEM_ID_ZYUNREISHANO_KUTSU,
         ITEM_SET_ID_AEGIR_RING_AEGIR_SHOES, ITEM_SET_ID_BOTONO_SCARF_GLASS,
         ITEM_SET_ID_BOTONO_SCARF_SUNGLASS, ITEM_SET_ID_CHALEUR_SHOES_CHALEUR_MANT,
         ITEM_SET_ID_DAITOZOKUNO_TEKUSARI_ASHIKUSARI,
         ITEM_SET_ID_DAITOZOKUNO_TEKUSARI_SHUZINNO_FUKU,
         ITEM_SET_ID_DIAVOLOS_WING_DIAVOLOS_ARMOR,
         ITEM_SET_ID_DIAVOLOS_WING_DIAVOLOS_BOOTS,
         ITEM_SET_ID_EINHERJERNO_YOROI_SEINSHISHANO_MANT,
         ITEM_SET_ID_ESPRIT_SHOES_ESPRIT_MANT, ITEM_SET_ID_FROID_SHOES_FROID_MANT,
         ITEM_SET_ID_FRONTIER_BOOTS_DAISHIZENNO_GUITAR,
         ITEM_SET_ID_FRONTIER_BOOTS_DAISHIZENNO_ROPE,
         ITEM_SET_ID_FURUBITA_SANDAL_DRAINCARD,
         ITEM_SET_ID_FURUBITA_TATENASHINO_YOROI_REFINE,
         ITEM_SET_ID_FURUKU_PINKIRONO_ARE_SANDAL,
         ITEM_SET_ID_FUSHICHONO_NEKOZYARASHI_FLAME_BIRD,
         ITEM_SET_ID_FUSHIGINA_HATO_WALHALLA_IDOL,
         ITEM_SET_ID_FUYUSURU_KENZYONO_ISHI_AMISTRL_CAP,
         ITEM_SET_ID_FUYUSURU_KENZYONO_ISHI_TARE_LEAF, ITEM_SET_ID_GOFUSEKI_PEORTH_PLATE,
         ITEM_SET_ID_GOYUMUSONO_MIKOSHI_GOYUMUSONO_KACCHU,
         ITEM_SET_ID_GUARDIAN_PROCESSOR_GUARDIAN_UNIT,
         ITEM_SET_ID_GURENNO_STOLE_NOROWARETA_ROYAL_KNIGHT,
         ITEM_SET_ID_HASANSHANO_KAMEN_OKANEWO_USHINATTAMONONO_KOKORO,
         ITEM_SET_ID_HIGHLEVEL_ZYUKIHE,
         ITEM_SET_ID_HIKOSEN_SUIT_HIKOSEN_MANT_HIKOSEN_BOOTS,
         ...
         ITEM_SET_ID_HOSHITAMAGO_BADGE_ACADEMY_BADGE, ITEM_SET_ID_ILLUSION_MORRIGAN_SET,
         ...
         ITEM_SET_ID_KIKAININGYOYO_ZOFUKUSOCHI_KAI_ERIOT_CARD,
         ITEM_SET_ID_KUROHANO_SUIT_ARTIFACT, ITEM_SET_ID_LAMORT_SHOES_LAMORT_MANT,
         ITEM_SET_ID_LEVAIN_SHOES_LEVAIN_MANT, ITEM_SET_ID_LIEN_SHOES_LIEN_MANT,
         ITEM_SET_ID_LOLANO_PLATEMAIL_LOLANO_KUSARITEKKYU,
         ITEM_SET_ID_LUMIERE_SHOES_LUMIERE_MANT,
         ...
         ITEM_SET_ID_NABUNO_CLOTH_ARTIFACT, ITEM_SET_ID_NIEVE_VALLETTA_NIEVE_ARMS,
         ITEM_SET_ID_NIZIIRONO_NEKOZYARASHI_RAIN_BO,
         ITEM_SET_ID_ODINNO_SHUKUFUKU_MAGNI_SET, ITEM_SET_ID_OKAKAN_HANABIRA,
         ITEM_SET_ID_ORCLORDNO_YOROI_ORCLORD_CARD,
         ITEM_SET_ID_OZYANO_MAIL_OZYANO_MANT_OZYANO_BOOTS,
         ITEM_SET_ID_PARACELSUS_GLOVE_HAO,
         ITEM_SET_ID_PELLROCKNO_SUIT_PELLROCKNO_MANT_PELLROCKNO_BOOTS,
         ITEM_SET_ID_PHANTOM_OF_MASKARADE_FUINSARETA_MAKENSHI_THANATOSNO_SHINENTAI_CARD,
         ITEM_SET_ID_PHANTOM_OF_MASKARADE_MAKENSHI_THANATOSNO_SHINENTAI_CARD,
         ITEM_SET_ID_PLATINUM_RING_WEDDING_GOODS, ITEM_SET_ID_POISON_SHOES_POISON_MANT,
         ITEM_SET_ID_PROTECT_FEATHER_HANENO_BERET,
         ITEM_SET_ID_QUILL_PENRING_SMALL_BOOK_PENDANT, ITEM_SET_ID_RIOTCHIP_A_HIT,
         ITEM_SET_ID_RIOTCHIP_Z_CASTFIXED, ITEM_SET_ID_RIOTCHIP_Z_CLAIRVOYANCE,
         ITEM_SET_ID_RIOTCHIP_Z_IMMORTAL, ITEM_SET_ID_RIOTCHIP_Z_KILLGAIN,
         ITEM_SET_ID_RIOTCHIP_Z_KNOCKBACK, ITEM_SET_ID_RIOTCHIP_Z_NODISPELL,
         ITEM_SET_ID_RIOTCHIP_Z_REINCARNATION,
         ITEM_SET_ID_RUNAWAY_ACCELERATOR_T_POWER_BOOST,
         ITEM_SET_ID_RUNE_BOOTS_CONTINENTAL_GUARDNO_INSHO,
         ITEM_SET_ID_SCARABA_HIGHHEEL_CARGA_MACE,
         ITEM_SET_ID_SHINMA_BAPHOMETNO_TSUNO_BLOODY_CROSS,
         ITEM_SET_ID_SHUGOKISHINO_KUBIKAZARI_IMPERIAL_FEATHER,
         ITEM_SET_ID_SHUZINNOFUKU_ASHIKUSARI, ITEM_SET_ID_SOL_SHOES_SOL_MANT,
         ITEM_SET_ID_SOMBRE_SHOES_SOMBRE_MANT, ITEM_SET_ID_SPRINT_GLOVE_SPRINT_MAIL,
         ITEM_SET_ID_SPRINT_GLOVE_SPRINT_SHOES,
         ...
         ITEM_SET_ID_TATENASHINO_YOROI_RSX_0806,
         ITEM_SET_ID_TATENASHINO_YOROI_TATENASHINO_KABUTO,
         ITEM_SET_ID_ULTIMATE_MODE_CHANGER_PEORTH_PLATE, ITEM_SET_ID_URUZ_PLATE_ARTIFACT,
         ITEM_SET_ID_WAKUWAKU_MANT_WAKUWAKU, ITEM_SET_ID_WHITE_FEATHER_PIPE_TABACCO,
...
import {
         ...
         SKILL_ID_BREAK_THROUGH, SKILL_ID_BUKI_KENKYU, SKILL_ID_BUKKOKEN,
         SKILL_ID_CAMOUFLAGE, SKILL_ID_CARROT_BEAT, SKILL_ID_CART_BOOST_GENETIC,
         SKILL_ID_CART_BOOST_WS, SKILL_ID_CART_KAIZO, SKILL_ID_CHATTERING,
         SKILL_ID_CLOAKING_EXCEED, SKILL_ID_CONCENTRATION,
         SKILL_ID_COUNT_OF_RG_FOR_BANDING, SKILL_ID_CRAZY_WEED, SKILL_ID_CROSS_IMPACT,
         SKILL_ID_DAICHINO_TAMASHI, SKILL_ID_DAITENHOSUI, SKILL_ID_DANCENO_RENSHU,
         SKILL_ID_DEBOTION, SKILL_ID_DEFENDER, SKILL_ID_DOUBLE_STRAFING,
         SKILL_ID_DRAGON_TRAINING, SKILL_ID_EBI_PARTY, SKILL_ID_EBI_ZANMAI,
         SKILL_ID_ELEMENTAL_SYMPASY, SKILL_ID_ENDLESS_HUMMING_VOICE, SKILL_ID_ENDURE,
         SKILL_ID_ENERGY_COAT, SKILL_ID_ESCAPE, SKILL_ID_FAINT_BOMB, SKILL_ID_FAITH,
         SKILL_ID_FAW_MAGIC_DECOY, SKILL_ID_FIGHTING_SPIRIT, SKILL_ID_FORCE_OF_BANGUARD,
         SKILL_ID_FRIGNO_UTA, SKILL_ID_FU_COUNT_OF_FU, SKILL_ID_FU_ELEMENT_OF_FU,
         SKILL_ID_GAKKINO_RENSHU, SKILL_ID_GENZYUTSU_ZANGETSU, SKILL_ID_GOHO,
         SKILL_ID_GROOMING, SKILL_ID_HEAT_BARREL, SKILL_ID_HOMLV_FOR_PYROCLASTIC,
         SKILL_ID_HPSPCONF_FOR_GENZYUTSU_ZANGETSU, SKILL_ID_IGNITION_BREAK,
         SKILL_ID_ILLUSION_DOOPING, SKILL_ID_INCREASING_ACCURACY, SKILL_ID_INSPIRATION,
         SKILL_ID_INUHAKKA_METEOR, SKILL_ID_INUHAKKA_SHOWER, SKILL_ID_KAINA,
         SKILL_ID_KATAR_SHUREN, SKILL_ID_KEIKAI, SKILL_ID_KEN_SEISAKU,
         SKILL_ID_KEN_SHUREN, SKILL_ID_KEN_SHUREN_GENETIC, SKILL_ID_KINGS_GRACE,
         SKILL_ID_KNUCKLE_SEISAKU, SKILL_ID_LAUDAAGNUS, SKILL_ID_LAUDARAMUS,
         SKILL_ID_LESSON, SKILL_ID_MACE_SEISAKU, SKILL_ID_MAELSTORM,
         SKILL_ID_MAGURO_SHIELD, SKILL_ID_MAINFRAME_KAIZO, SKILL_ID_MATATABINO_NEKKO,
         SKILL_ID_MATATABI_LANCE, SKILL_ID_MEDITATIO, SKILL_ID_MEIKYO_SHISUI,
         SKILL_ID_MORYUKEN, SKILL_ID_MURENO_CHIKARA, SKILL_ID_MYAUMYAU,
         SKILL_ID_NODOWO_NARASU, SKILL_ID_NYAN_GRASS, SKILL_ID_NYAN_TAMASHI,
         SKILL_ID_OFFERTORIUM, SKILL_ID_ONO_SEISAKU, SKILL_ID_ONO_SHUREN,
         SKILL_ID_ONO_SHUREN_MECHANIC, SKILL_ID_OTORO, SKILL_ID_OVERED_BOOST,
         SKILL_ID_PIKKI_TSUKI, SKILL_ID_PILE_BUNKER,
         SKILL_ID_PLANT_KEI_SHUTOKU_LEVEL_GOKEI, SKILL_ID_PLATINUM_ALTER,
         SKILL_ID_PLATINUM_ALTER_COIN_COUNT, SKILL_ID_PRESTAGE, SKILL_ID_PYROCLASTIC,
         SKILL_ID_RADIUS, SKILL_ID_RENCHUHOGEKI, SKILL_ID_RENDASHO, SKILL_ID_RUNE_MASTERY,
         SKILL_ID_RYOTEKEN_SEISAKU, SKILL_ID_SANREI_ITTAI, SKILL_ID_SAVAGENO_TAMASHI,
         SKILL_ID_SEAFOOD_KEI_SHUTOKU_LEVEL_GOKEI, SKILL_ID_SECRAMENT,
         SKILL_ID_SEIMEINO_CHIKARA, SKILL_ID_SEIMEINO_TAMASHI, SKILL_ID_SENKO_RENGEKI,
         SKILL_ID_SENRYU_SHOTEN, SKILL_ID_SERE, SKILL_ID_SERE_MODE,
         SKILL_ID_SERE_SUPPORT_SKILL, SKILL_ID_SEVERE_RAINSTORM, SKILL_ID_SHAPE_SHIFT,
         SKILL_ID_SHIELD_SPELL_ATK_PLUS, SKILL_ID_SHIELD_SPELL_DEF_PLUS,
         SKILL_ID_SHIELD_SPELL_LV_1, SKILL_ID_SHINSENNA_EBI, SKILL_ID_SHIRYO_HYOI,
         SKILL_ID_SHUCHURYOKU_KOZYO, SKILL_ID_SINGLE_ACTION,
         SKILL_ID_SKILL_LV_DEFENDER_FOR_PRESTAGE, SKILL_ID_SNAKE_EYE, SKILL_ID_SONIC_WAVE,
         SKILL_ID_SORYUKYAKU, SKILL_ID_SOUL_DRAIN, SKILL_ID_SOUL_ENERGY_KENKYU,
         SKILL_ID_STONE_HARD_SKIN, SKILL_ID_SUMMON_AGNI, SKILL_ID_SUMMON_AQUA,
         SKILL_ID_SUMMON_TERA, SKILL_ID_SUMMON_VENTOS, SKILL_ID_TANKEN_SEISAKU,
         SKILL_ID_TAROUNO_KIZU, SKILL_ID_TEKKEN, SKILL_ID_TELECHINESIS_INSTENCE,
         SKILL_ID_TENKETSU_HAN, SKILL_ID_TENKETSU_KAI, SKILL_ID_TENKETSU_KATSU,
...
import { n_A_PassSkill4, n_A_PassSkill7, n_A_PassSkill8, UsedSkillSearch } from "./skillstate.js";
...
import { ApplySpecModify, GetTotalPureBasicStatus } from "./hmjob-bridge.js";
...
import {
    ...
    ELM_ID_VANITY, ELM_ID_WATER, ELM_ID_WIND,
...
import {
    ...
    ITEM_KIND_KATAR, ITEM_KIND_KNIFE, ITEM_KIND_MUSICAL, ITEM_KIND_SWORD, ITEM_KIND_SWORD_2HAND, ITEM_KIND_WHIP,
} from "./const/EnumItemKind.js";
import {
    ITEM_SP_ATK_PLUS, ITEM_SP_BODY_ELEMENT, ITEM_SP_DEF_PLUS, ITEM_SP_ELEMENTAL, ITEM_SP_HIT_PLUS, ITEM_SP_MAXHP_PLUS,
    ITEM_SP_MAXHP_UP, ITEM_SP_MAXSP_PLUS, ITEM_SP_MAXSP_UP, ITEM_SP_MDEF_PLUS,
} from "./const/EnumItemSpId.js";
import {
    JOB_ID_ARCBISHOP, JOB_ID_CRUSADER, JOB_ID_GENETIC, JOB_ID_GILOTINCROSS, JOB_ID_KAGERO, JOB_ID_MECHANIC,
    JOB_ID_MINSTREL, JOB_ID_OBORO, JOB_ID_RANGER, JOB_ID_ROYALGUARD, JOB_ID_RUNEKNIGHT, JOB_ID_SHURA,
    JOB_ID_SORCERER, JOB_ID_SUMMONER, JOB_ID_WANDERER, JOB_ID_WARLOCK,
