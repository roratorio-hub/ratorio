...
import {
    ...
    ITEM_SP_EQUIPMENT_LOCATION_ACCESSORY, ITEM_SP_EQUIPMENT_LOCATION_BODY, ITEM_SP_EQUIPMENT_LOCATION_GENERAL, ITEM_SP_EQUIPMENT_LOCATION_HEAD_MID, ITEM_SP_EQUIPMENT_LOCATION_SHOES, ITEM_SP_EQUIPMENT_LOCATION_SHOULDER, ITEM_SP_EXP_UP_ALL,
	...
	if (spId >= baseFlag) {
		...
		switch (equipmentLocation) {
            ...
            case toSafeBigInt(ITEM_SP_EQUIPMENT_LOCATION_HEAD_MID) / baseFlag:
                ...
                break;
            case toSafeBigInt(ITEM_SP_EQUIPMENT_LOCATION_GENERAL) / baseFlag:
                condTextEquipmentLocation = "一般装備";
                break;
		}
