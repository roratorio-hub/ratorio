...
ItemObjNew[5378] = [5378,72,192,0,1900000,0,0,200,"[シャドウ] シーズナルウェポン","シイスナルウエホン","",194,1,100076,2,7000076,10,9000076,20,0];
ItemObjNew[5379] = [5379,73,192,0,2000000,0,0,200,"[シャドウ] シーズナルシールド","シイスナルシイルト","",194,1,100076,1,7000076,5,9000076,10,0];
ItemObjNew[5380] = [5380,77,192,0,1800000,0,0,200,"[シャドウ] シーズナルアーマー","シイスナルアアマア","",194,1,100076,1,7000076,5,9000076,10,0];
ItemObjNew[5381] = [5381,80,192,0,2100000,0,0,200,"[シャドウ] シーズナルシューズ","シイスナルシユウス","",194,1,100076,1,7000076,5,9000076,10,0];
ItemObjNew[5382] = [5382,82,192,0,2200000,0,0,200,"[シャドウ] シーズナルイヤリング","シイスナルイヤリンク","",194,1,100076,1,7000076,5,9000076,10,0];
ItemObjNew[5383] = [5383,83,192,0,2300000,0,0,200,"[シャドウ] シーズナルペンダント","シイスナルヘンタント","",194,1,100076,1,7000076,5,9000076,10,0];
// --- 2024/12/18 ---
...
ItemObjNew[5787] = [5787,72,192,0,0,0,0,200,"[シャドウ] ヒーローウェポン","シャドウヒーローウェポン","",100017,10,100100,10,7000017,20,7000100,20,7000155,20,9000017,30,9000100,30,9000155,30,0];
ItemObjNew[5788] = [5788,83,192,0,0,0,0,200,"[シャドウ] ヒーローペンダント","シャドウヒーローペンダント","",100080,1,7000080,2,7000089,2,7000155,20,9000080,3,9000089,3,9000155,30,0];

ItemObjNew[5789] = [5789,60,166,100,0,1,100,200,"アバドン","アバドン","精錬値が9以上の時、[フェイントボム]使用時、20秒間、[アンリミット]Lv5状態になる。<br>装備解除時、[アンリミット]を解除する",243,7,100000000006102,1,100000000006109,1,100000000006305,1,100000000006307,1,100260,7,7000012,10,7000079,5,7000077,5,9000194,1,10000262,15,0];
ItemObjNew[5790] = [5790,52,163,0,0,0,10,200,"くわえたクラブのエース","クワエタクラブノエース","",243,3,100000000000260,1,100000000000265,1,0];
ItemObjNew[5791] = [5791,52,175,0,0,0,10,200,"クラナネミエリーの傍観者","クラナネミエリーノボウカンシャ","",243,3,100000000000260,1,100000000000265,1,0];
ItemObjNew[5792] = [5792,62,192,38,0,1,40,200,"ディメンションクリミナルアーク","ディメンションクリミナルアーク","精錬値が9以上の時、追加で物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる<br>精錬値が10の時、追加で[Mクラウドキル]で受けるダメージ - 50%",79,5,77,5,243,5,44000000012,20,44000000074,25,100015,2,100016,2,100231,1,5000217,10,5000262,10,5000269,10,7000086,25,7000262,15,7000269,15,9000068,15,10000260,15,10000265,15,0];
ItemObjNew[5793] = [5793,100,0,0,0,0,0,0,0,0,"物理・魔法攻撃命中時、一定確率で20秒間、リフレッシュLv1状態になる",0];
