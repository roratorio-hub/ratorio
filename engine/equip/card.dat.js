...
export const CardObjNew = [
		...
		[1678,99,"シンソウの王",,"",600000000000000007n,10,0],
		...
		[1975,99,"英雄の凱歌",,"",600000000000000101n,1,0],
		...
		[2711,99,"雪花の魔力(練魔I)",,"",73,-20,100000000000089,1,0],
...
CardObjNew[4464] = [4464,100,0,"","",20292,100,20293,100,0];
	...
	CardObjNew[4540] = [4540,99,"潜在解放(アビスチェイサーXXII)","センザイカイホウアビスチェイサー22","",0];
	CardObjNew[4541] = [4541,100,0,"","",20307,100,0];
	CardObjNew[4542] = [4542,99,"潜在解放(アークメイジXXIV)","センザイカイホウアークメイジ24","",0];
	CardObjNew[4543] = [4543,100,0,"","",20064,500,20063,500,20054,500,0];
	CardObjNew[4544] = [4544,99,"潜在解放(ナイトウォッチXX)","センザイカイホウナイトウォッチ20","",0];
	CardObjNew[4545] = [4545,100,0,"","",20220,200,0];
