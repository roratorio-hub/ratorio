...
import { skills as skills_swordman_1_swordman } from "./skill/swordman/1-swordman.js";
import { skills as skills_swordman_2a_knight } from "./skill/swordman/2a-knight.js";
import { skills as skills_swordman_2b_crusader } from "./skill/swordman/2b-crusader.js";
import { skills as skills_swordman_3a_lord_knight } from "./skill/swordman/3a-lord-knight.js";
import { skills as skills_swordman_3b_paladin } from "./skill/swordman/3b-paladin.js";
import { skills as skills_swordman_4a_rune_knight } from "./skill/swordman/4a-rune-knight.js";
import { skills as skills_swordman_4b_royal_guard } from "./skill/swordman/4b-royal-guard.js";
import { skills as skills_swordman_5a_dragon_knight } from "./skill/swordman/5a-dragon-knight.js";
import { skills as skills_swordman_5b_imperial_guard } from "./skill/swordman/5b-imperial-guard.js";
import { skills as skills_magician_1_magician } from "./skill/magician/1-magician.js";
import { skills as skills_magician_2a_wizard } from "./skill/magician/2a-wizard.js";
import { skills as skills_magician_2b_sage } from "./skill/magician/2b-sage.js";
import { skills as skills_magician_3a_high_wizard } from "./skill/magician/3a-high-wizard.js";
import { skills as skills_magician_3b_professor } from "./skill/magician/3b-professor.js";
import { skills as skills_magician_4a_warlock } from "./skill/magician/4a-warlock.js";
import { skills as skills_magician_4b_sorcerer } from "./skill/magician/4b-sorcerer.js";
import { skills as skills_magician_5a_arch_mage } from "./skill/magician/5a-arch-mage.js";
import { skills as skills_magician_5b_elemental_master } from "./skill/magician/5b-elemental-master.js";
import { skills as skills_archer_1_archer } from "./skill/archer/1-archer.js";
import { skills as skills_archer_2a_hunter } from "./skill/archer/2a-hunter.js";
import { skills as skills_archer_2b_bard_dancer } from "./skill/archer/2b-bard-dancer.js";
import { skills as skills_archer_3a_sniper } from "./skill/archer/3a-sniper.js";
import { skills as skills_archer_3b_clown_gypsy } from "./skill/archer/3b-clown-gypsy.js";
import { skills as skills_archer_4a_ranger } from "./skill/archer/4a-ranger.js";
import { skills as skills_archer_4b_minstrel_wanderer } from "./skill/archer/4b-minstrel-wanderer.js";
import { skills as skills_archer_5a_windhawk } from "./skill/archer/5a-windhawk.js";
import { skills as skills_archer_5b_troubadour_trouvere } from "./skill/archer/5b-troubadour-trouvere.js";
import { skills as skills_merchant_1_merchant } from "./skill/merchant/1-merchant.js";
import { skills as skills_merchant_2a_blacksmith } from "./skill/merchant/2a-blacksmith.js";
import { skills as skills_merchant_2b_alchemist } from "./skill/merchant/2b-alchemist.js";
import { skills as skills_merchant_3a_whitesmith } from "./skill/merchant/3a-whitesmith.js";
import { skills as skills_merchant_3b_creator } from "./skill/merchant/3b-creator.js";
import { skills as skills_merchant_4a_mechanic } from "./skill/merchant/4a-mechanic.js";
import { skills as skills_merchant_4b_genetic } from "./skill/merchant/4b-genetic.js";
import { skills as skills_merchant_5a_meister } from "./skill/merchant/5a-meister.js";
import { skills as skills_merchant_5b_biolo } from "./skill/merchant/5b-biolo.js";
import { skills as skills_thief_1_thief } from "./skill/thief/1-thief.js";
import { skills as skills_thief_2a_assassin } from "./skill/thief/2a-assassin.js";
import { skills as skills_thief_2b_rogue } from "./skill/thief/2b-rogue.js";
import { skills as skills_thief_3a_assassin_cross } from "./skill/thief/3a-assassin-cross.js";
import { skills as skills_thief_3b_chaser } from "./skill/thief/3b-chaser.js";
import { skills as skills_thief_4a_guillotine_cross } from "./skill/thief/4a-guillotine-cross.js";
import { skills as skills_thief_4b_shadow_chaser } from "./skill/thief/4b-shadow-chaser.js";
import { skills as skills_thief_5a_shadow_cross } from "./skill/thief/5a-shadow-cross.js";
import { skills as skills_thief_5b_abyss_chaser } from "./skill/thief/5b-abyss-chaser.js";
import { skills as skills_acolyte_1_acolyte } from "./skill/acolyte/1-acolyte.js";
import { skills as skills_acolyte_2a_priest } from "./skill/acolyte/2a-priest.js";
import { skills as skills_acolyte_2b_monk } from "./skill/acolyte/2b-monk.js";
import { skills as skills_acolyte_3a_high_priest } from "./skill/acolyte/3a-high-priest.js";
import { skills as skills_acolyte_3b_champion } from "./skill/acolyte/3b-champion.js";
import { skills as skills_acolyte_4a_arch_bishop } from "./skill/acolyte/4a-arch-bishop.js";
import { skills as skills_acolyte_4b_sura } from "./skill/acolyte/4b-sura.js";
import { skills as skills_acolyte_5a_cardinal } from "./skill/acolyte/5a-cardinal.js";
import { skills as skills_acolyte_5b_inquisitor } from "./skill/acolyte/5b-inquisitor.js";
import { skills as skills_taekwon_1_taekwon } from "./skill/taekwon/1-taekwon.js";
import { skills as skills_taekwon_2a_star_gladiator } from "./skill/taekwon/2a-star-gladiator.js";
import { skills as skills_taekwon_2b_soul_linker } from "./skill/taekwon/2b-soul-linker.js";
import { skills as skills_taekwon_4a_star_emperor } from "./skill/taekwon/4a-star-emperor.js";
import { skills as skills_taekwon_4b_soul_reaper } from "./skill/taekwon/4b-soul-reaper.js";
import { skills as skills_taekwon_5a_sky_emperor } from "./skill/taekwon/5a-sky-emperor.js";
import { skills as skills_taekwon_5b_soul_ascetic } from "./skill/taekwon/5b-soul-ascetic.js";
import { skills as skills_ninja_1_ninja } from "./skill/ninja/1-ninja.js";
import { skills as skills_ninja_4_kagerou_oboro } from "./skill/ninja/4-kagerou-oboro.js";
import { skills as skills_ninja_5_shinkiro_shiranui } from "./skill/ninja/5-shinkiro-shiranui.js";
import { skills as skills_gunslinger_1_gunslinger } from "./skill/gunslinger/1-gunslinger.js";
import { skills as skills_gunslinger_4_rebellion } from "./skill/gunslinger/4-rebellion.js";
import { skills as skills_gunslinger_5_night_watch } from "./skill/gunslinger/5-night-watch.js";
import { skills as skills_druid_1_druid } from "./skill/druid/1-druid.js";
import { skills as skills_druid_2_karnos } from "./skill/druid/2-karnos.js";
import { skills as skills_druid_5_alitea } from "./skill/druid/5-alitea.js";
import { skills as skills_novice_1_super_novice } from "./skill/novice/1-super-novice.js";
import { skills as skills_novice_5_hyper_novice } from "./skill/novice/5-hyper-novice.js";
import { skills as skills_summoner_1_summoner } from "./skill/summoner/1-summoner.js";
import { skills as skills_summoner_5_spirit_handler } from "./skill/summoner/5-spirit-handler.js";
import { skills as skills_other_spirit } from "./skill/other/spirit.js";
import { skills as skills_other_homunculus } from "./skill/other/homunculus.js";
import { skills as skills_other_common } from "./skill/other/common.js";
