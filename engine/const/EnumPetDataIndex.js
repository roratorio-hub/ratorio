...
// ---- 列挙定数 ----
export const PET_DATA_INDEX_ID      = 0;
export const PET_DATA_INDEX_NAME    = 1;
export const PET_DATA_INDEX_KANA    = 2;
export const PET_DATA_INDEX_DETAIL  = 3;
export const PET_DATA_INDEX_SPBEGIN = 4;
