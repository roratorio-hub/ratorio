...
import {
    CHARA_DATA_INDEX_ASPD, CHARA_DATA_INDEX_CRI, CHARA_DATA_INDEX_DEF_DIV, CHARA_DATA_INDEX_DEF_MINUS, CHARA_DATA_INDEX_DISP_ASPD, CHARA_DATA_INDEX_DISP_ATK_LEFT,
    CHARA_DATA_INDEX_DISP_ATK_RIGHT, CHARA_DATA_INDEX_DISP_CRI, CHARA_DATA_INDEX_DISP_DEF_LEFT, CHARA_DATA_INDEX_DISP_DEF_RIGHT, CHARA_DATA_INDEX_DISP_FLEE, CHARA_DATA_INDEX_DISP_HIT,
    CHARA_DATA_INDEX_DISP_HPR, CHARA_DATA_INDEX_DISP_LUCKY, CHARA_DATA_INDEX_DISP_MATK_LEFT, CHARA_DATA_INDEX_DISP_MATK_RIGHT, CHARA_DATA_INDEX_DISP_MAXHP, CHARA_DATA_INDEX_DISP_MAXSP,
    CHARA_DATA_INDEX_DISP_MDEF_LEFT, CHARA_DATA_INDEX_DISP_MDEF_RIGHT, CHARA_DATA_INDEX_DISP_SPR, CHARA_DATA_INDEX_FLEE, CHARA_DATA_INDEX_HIT, CHARA_DATA_INDEX_HPR,
    CHARA_DATA_INDEX_LEFT_ATK, CHARA_DATA_INDEX_LUCKY, CHARA_DATA_INDEX_MAXHP, CHARA_DATA_INDEX_MAXSP, CHARA_DATA_INDEX_MDEF_DIV, CHARA_DATA_INDEX_MDEF_MINUS,
    CHARA_DATA_INDEX_REFINE_ATK, CHARA_DATA_INDEX_SPR, CHARA_DATA_INDEX_SPR_STOP, CHARA_DATA_INDEX_STATUS_ATK, CHARA_DATA_INDEX_STATUS_MATK, CHARA_DATA_INDEX_WEAPON_ATK,
    CHARA_DATA_INDEX_WEAPON_MATK,
} from "../const/EnumCharaDataIndex.js";
import { ITEM_SP_ATK_PLUS, ITEM_SP_MATK_PLUS_TYPE_NOT_WEAPON } from "../const/EnumItemSpId.js";
