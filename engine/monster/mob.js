...
import {
    ...
    MOB_CONF_BUF_ID_REBIRTH, MOB_CONF_BUF_ID_RUSH_ATTACK, MOB_CONF_BUF_ID_SOKUDO_KYOKA,
    MOB_CONF_BUF_ID_SOKUDO_ZOKA, MOB_CONF_BUF_ID_ZOKUSEI_HENKA
} from "./mobconfbuf.js";
import {
    n_B_IJYOU,
    MOB_CONF_DEBUF_ID_ADORAMUS_DEBUFF, MOB_CONF_DEBUF_ID_ANALYSE, MOB_CONF_DEBUF_ID_BLESSING,
    MOB_CONF_DEBUF_ID_DOKU, MOB_CONF_DEBUF_ID_EARTH_DRIVE_DEBUFF, MOB_CONF_DEBUF_ID_EIENNNO_KONTON,
    MOB_CONF_DEBUF_ID_ELEMENTAL_CHANGE, MOB_CONF_DEBUF_ID_ENERVATION, MOB_CONF_DEBUF_ID_ESKA,
    MOB_CONF_DEBUF_ID_ESKU, MOB_CONF_DEBUF_ID_FLYING, MOB_CONF_DEBUF_ID_GROOMY,
    MOB_CONF_DEBUF_ID_HAKKA, MOB_CONF_DEBUF_ID_HYOKETSU, MOB_CONF_DEBUF_ID_KURAYAMI,
    MOB_CONF_DEBUF_ID_MAHI, MOB_CONF_DEBUF_ID_MARSH_OF_ABYSS, MOB_CONF_DEBUF_ID_MIND_BREAKER,
    MOB_CONF_DEBUF_ID_NOROI, MOB_CONF_DEBUF_ID_NYAN_GRASS, MOB_CONF_DEBUF_ID_PROVOKE,
    MOB_CONF_DEBUF_ID_QUAGMIRE, MOB_CONF_DEBUF_ID_RAKUIN_ZYOTAI, MOB_CONF_DEBUF_ID_SEKIKA,
    MOB_CONF_DEBUF_ID_SIGNUM_CRUCIS, MOB_CONF_DEBUF_ID_SOKUDO_GENSHO, MOB_CONF_DEBUF_ID_SPIDER_WEB,
    MOB_CONF_DEBUF_ID_STRIP_ACCESSORY, MOB_CONF_DEBUF_ID_STRIP_ARMOR, MOB_CONF_DEBUF_ID_STRIP_HELM,
    MOB_CONF_DEBUF_ID_STRIP_SHIELD, MOB_CONF_DEBUF_ID_STRIP_WEAPON, MOB_CONF_DEBUF_ID_STUN,
    MOB_CONF_DEBUF_ID_SUIMIN, MOB_CONF_DEBUF_ID_TOUKETSU, MOB_CONF_DEBUF_ID_WATER_BARRIER
} from "./mobconfdebuf.js";
import {
    n_B_TAISEI,
    MOB_CONF_PLAYER_ID_AGI, MOB_CONF_PLAYER_ID_BASE_LV, MOB_CONF_PLAYER_ID_DEF_DIV,
    MOB_CONF_PLAYER_ID_DEF_MINUS, MOB_CONF_PLAYER_ID_DEX, MOB_CONF_PLAYER_ID_FLEE,
    MOB_CONF_PLAYER_ID_INT, MOB_CONF_PLAYER_ID_LUK, MOB_CONF_PLAYER_ID_MAXHP,
    MOB_CONF_PLAYER_ID_MDEF_DIV, MOB_CONF_PLAYER_ID_MDEF_MINUS, MOB_CONF_PLAYER_ID_MRES,
    MOB_CONF_PLAYER_ID_RES, MOB_CONF_PLAYER_ID_SENTO_AREA, MOB_CONF_PLAYER_ID_SENTO_AREA_NONE,
    MOB_CONF_PLAYER_ID_SENTO_AREA_URDR, MOB_CONF_PLAYER_ID_SENTO_AREA_YE,
    MOB_CONF_PLAYER_ID_SENTO_AREA_YE_COLOSSEUM, MOB_CONF_PLAYER_ID_SENTO_AREA_YE_GVG_TE,
    MOB_CONF_PLAYER_ID_SENTO_AREA_YE_SHINKIRO, MOB_CONF_PLAYER_ID_SHUZOKU,
    MOB_CONF_PLAYER_ID_SHUZOKU_HUMAN, MOB_CONF_PLAYER_ID_STR, MOB_CONF_PLAYER_ID_VIT,
...
import { SKILL_ID_EXPIATIO, SKILL_ID_HAKKEI } from "../skill/skill.dat.js";
...
export function GetMobDataParameters(monsterId, mobData){
	...
	case MONSTER_ID_MONSTER_TENYURYOKU:
		...
		mobData[MONSTER_DATA_INDEX_RES] = GetMobConfInput(MOB_CONF_INPUT_DATA_INDEX_RES);
		mobData[MONSTER_DATA_INDEX_MRES] = GetMobConfInput(MOB_CONF_INPUT_DATA_INDEX_MRES);;
