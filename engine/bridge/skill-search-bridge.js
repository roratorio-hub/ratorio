 ...
 *
 * UsedSkillSearch の実体は engine/skill/skillstate.js、LearnedSkillSearch の実体は
 * engine/skill/learnedskill.js にあるが、どちらも global.js を起点とする循環 import に含まれる。
...
/**
 * 職固有自己支援等、使用中スキルの設定Lvを取得する。実体は engine/skill/skillstate.js。
...
/**
 * 習得スキル欄の設定Lvを取得する。実体は engine/skill/learnedskill.js。
 * @type {(skillId: number) => number}
 */
