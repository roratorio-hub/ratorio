        ...
        const result = await page.evaluate(`
            (async () => {
                ...
                const idLevel = {
                    ...
                    GetCastTimeVary:     (id, lv) => sm.GetCastTimeVary(id, lv, charaData, option),
                    GetCastTimeFixed:    (id, lv) => sm.GetCastTimeFixed(id, lv, charaData),
                    GetCastTimeForce:    (id, lv) => sm.GetCastTimeForce(id, lv, charaData),
                    GetDelayTimeCommon:  (id, lv) => sm.GetDelayTimeCommon(id, lv, charaData, option),
                    GetCoolTime:         (id, lv) => sm.GetCoolTime(id, lv, charaData, option),
