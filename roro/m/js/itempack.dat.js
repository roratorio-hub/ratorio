(function () {
	...
	ITEM_PACK_ID_GRAY_WOLF_PHYSICAL = 18;
	ITEM_PACK_ID_GRAY_WOLF_MAGICAL = 19;
	ITEM_PACK_ID_SEKKA_PHYSICAL = 20;
	ITEM_PACK_ID_SEKKA_MAGICAL = 21;
	// 配列の並び順とIDが連動しているため順番を変えたときはIDの変更も必要になります
	ITEM_PACK_ID_CLEAR_EQUIP_ALL = 23;
	ITEM_PACK_ID_CLEAR_REFINE_ALL = 24;
	ITEM_PACK_ID_CLEAR_CARD_ALL = 25;
	ITEM_PACK_ID_CLEAR_SHADOW_ALL = 26;
