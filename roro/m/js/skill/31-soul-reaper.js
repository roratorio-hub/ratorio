/**
 * スキル定義 31-soul-reaper（SKILL_ID 967–1001 / 35 件）
 *
...
import {
    ...
    SKILL_ID_GOLEMNO_TAMASHI, SKILL_ID_KAGENO_TAMASHI, SKILL_ID_KAUTO, SKILL_ID_MIWAKUNO_WINK,
    SKILL_ID_ODINNO_CHIKARA, SKILL_ID_PEONY_MAMY, SKILL_ID_PISHARI_HERB, SKILL_ID_RYUSE_RAKKA_MODE,
    SKILL_ID_SEKAIZYUNO_HOKORI, SKILL_ID_SERIES_ANIMAL, SKILL_ID_SERIES_PLANT, SKILL_ID_SERIES_SEA_FOOD,
    SKILL_ID_SHIRYO_BAKUHATSU, SKILL_ID_SHIRYO_HYOI, SKILL_ID_SHOZIGENKAIRYO_ZOKA, SKILL_ID_SHOZIGENKAIRYO_ZOKA_R,
    ...
    SKILL_ID_TAMASHINO_SHUKAKU, SKILL_ID_TAMASHINO_ZYUNKAN, SKILL_ID_TUZYO_KOGEKI_CALC_KATAR_APPEND,
    SKILL_ID_TUZYO_KOGEKI_CALC_LEFT, SKILL_ID_TUZYO_KOGEKI_CALC_RIGHT, SKILL_ID_VAMPIRE_GIFT,
...
export const skills = [
		...
		defineSkill(SKILL_ID_SERIES_SEA_FOOD, function() {
		...
		defineSkill(SKILL_ID_SERIES_PLANT, function() {
		...
		defineSkill(SKILL_ID_SERIES_ANIMAL, function() {
