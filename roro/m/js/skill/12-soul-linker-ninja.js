/**
 * スキル定義 12-soul-linker-ninja（SKILL_ID 385–416 / 32 件）
 *
...
import {
    SKILL_ID_BEAST_STRAIFING, SKILL_ID_COUNT_OF_COIN, SKILL_ID_ENCHANT_DEADLY_POISON, SKILL_ID_FULL_ADRENALINE_RUSH,
    SKILL_ID_FUMASHURIKEN_NAGE, SKILL_ID_FUZIN, SKILL_ID_FU_COUNT_OF_FU, SKILL_ID_FU_ELEMENT_OF_FU,
    SKILL_ID_HOLY_LIGHT, SKILL_ID_HOLY_LIGHT_TAMASHI, SKILL_ID_HUNTERNO_TAMASHI_KOKA, SKILL_ID_HYOSENSO,
    SKILL_ID_ISSEN, SKILL_ID_KAENZIN, SKILL_ID_KAGEBUNSHIN, SKILL_ID_KAGEKIRI, SKILL_ID_KAGETOBI,
    SKILL_ID_KASUMIGIRI, SKILL_ID_KOUENKA, SKILL_ID_KUNAI_NAGE, SKILL_ID_NEN, SKILL_ID_NINPO_SHUREN,
    SKILL_ID_ONEHAND_QUICKEN, SKILL_ID_RAIGEKISAI, SKILL_ID_RYUENZIN, SKILL_ID_SAKUFU, SKILL_ID_SHURIKEN_NAGE,
    SKILL_ID_SONIC_BLOW, SKILL_ID_SONIC_BLOW_TAMASHI, SKILL_ID_SUITON, SKILL_ID_SUPER_NOVICENO_TAMASHI,
    SKILL_ID_TATAMI_GAESHI, SKILL_ID_TENSE_ICHIZISHOKUNO_TAMASHI, SKILL_ID_TOTEKI_SHUREN, SKILL_ID_TSURARAOTOSHI,
    SKILL_ID_UTSUSEMI, SKILL_ID_ZENI_NAGE
} from '../skill.dat.js';
