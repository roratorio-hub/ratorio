/**
 * スキル定義 16-ranger（SKILL_ID 495–516 / 22 件）
 *
...
import {
    SKILL_ID_AIMED_BOLT, SKILL_ID_ARROW_STORM, SKILL_ID_CAMOUFLAGE, SKILL_ID_CLUSTER_BOMB, SKILL_ID_COBALT_TRAP,
    SKILL_ID_DETONATOR, SKILL_ID_EIBINNA_KYUKAKU, SKILL_ID_ELECTRIC_SHOCKER, SKILL_ID_FEAR_BLEATH,
    SKILL_ID_FIRING_TRAP, SKILL_ID_ICEBOUND_TRAP, SKILL_ID_MAGENTA_TRAP, SKILL_ID_MAZE_TRAP, SKILL_ID_RANGER_MAIN,
    SKILL_ID_TOOTH_OF_WUG, SKILL_ID_TRAP_KENKYU, SKILL_ID_VERDURE_TRAP, SKILL_ID_WUG_BITE, SKILL_ID_WUG_DASH,
    SKILL_ID_WUG_MASTERY, SKILL_ID_WUG_RIDER, SKILL_ID_WUG_STRIKE
} from '../skill.dat.js';
