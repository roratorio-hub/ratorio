(function () {
	...
	window.ARROW_ID_NONE = 0;
	window.ARROW_ID_YA = 1;
	window.ARROW_ID_TETSUNO_YA = 2;
	window.ARROW_ID_KOTETSUNO_YA = 3;
	window.ARROW_ID_ORIDEOKONNO_YA = 4;
	window.ARROW_ID_KARYUDONO_YA = 5;
	window.ARROW_ID_ELFNO_YA = 6;
	window.ARROW_ID_SUISHONO_YA = 7;
	window.ARROW_ID_GANSEKINO_YA = 8;
	window.ARROW_ID_HONOONO_YA = 9;
	window.ARROW_ID_KAZENO_YA = 10;
	window.ARROW_ID_SABITA_YA = 11;
	window.ARROW_ID_GINNO_YA = 12;
	window.ARROW_ID_HAMAYA = 13;
	window.ARROW_ID_SEINARU_YA = 14;
	window.ARROW_ID_KAGEYA = 15;
	window.ARROW_ID_MUKEINO_YA = 16;
	window.ARROW_ID_ZOKUSE_ZIDO_YA_ATK30 = 17;
	window.ARROW_ID_SURUDOI_YA = 18;
	window.ARROW_ID_CURSE_ARROW = 19;
	window.ARROW_ID_SILENCE_ARROW = 20;
	window.ARROW_ID_SLEEP_ARROW = 21;
	window.ARROW_ID_FLASH_ARROW = 22;
	window.ARROW_ID_KORINO_YA = 23;
	window.ARROW_ID_DOKUYA = 24;
	window.ARROW_ID_ATK1NO_YA = 25;
	window.ARROW_ID_BULLET = 26;
	window.ARROW_ID_BLOOD_BULLET_C = 27;
	window.ARROW_ID_AP_BULLET = 28;
	window.ARROW_ID_ICE_BULLET = 29;
	window.ARROW_ID_FREEZING_BULLET = 30;
	window.ARROW_ID_MAGICAL_STONE_BULLET = 31;
	window.ARROW_ID_FLARE_BULLET = 32;
	window.ARROW_ID_BLAZE_BULLET = 33;
	window.ARROW_ID_LIGHTNING_BULLET = 34;
	window.ARROW_ID_ELECTRIC_BULLET = 35;
	window.ARROW_ID_POISON_BULLET = 36;
	window.ARROW_ID_SILVER_BULLET_C = 37;
	window.ARROW_ID_SUNCTFIED_BULLET = 38;
	window.ARROW_ID_BLIND_BULLET = 39;
