...
// ---- 列挙定数 ----
export const SKILL_DATA_INDEX_ID    = 0;
export const SKILL_DATA_INDEX_MAXLV = 1;
export const SKILL_DATA_INDEX_NAME  = 2;
export const SKILL_DATA_INDEX_REFID = 3;
