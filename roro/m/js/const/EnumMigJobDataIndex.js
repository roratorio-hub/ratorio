...
export const EnumMigJobDataIndex = createEnum('EnumMigJobDataIndex', [
    ['MIG_JOB_DATA_INDEX_ID', 0],
    ['MIG_JOB_DATA_INDEX_NAME_KANA_ARRAY', 1],
    ['MIG_JOB_DATA_INDEX_BASE_EXP_TABLE_ID', 2],
    ['MIG_JOB_DATA_INDEX_JOB_EXP_TABLE_ID', 3],
    ['MIG_JOB_DATA_INDEX_WEIGHT_BONUS', 4],
    ['MIG_JOB_DATA_INDEX_WEAPON_ASPD_ARRAY', 5],
    ['MIG_JOB_DATA_INDEX_JOB_BONUS_ARRAY', 6],
    ['MIG_JOB_DATA_INDEX_HP_ARRAY', 7],
    ['MIG_JOB_DATA_INDEX_SP_ARRAY', 8],
    ['MIG_JOB_DATA_INDEX_LEARN_SKILL_ID_ARRAY', 9],
    ['MIG_JOB_DATA_INDEX_PASSIVE_SKILL_ID_ARRAY', 10],
    ['MIG_JOB_DATA_INDEX_ATTACK_SKILL_ID_ARRAY', 11],
    ['MIG_JOB_DATA_INDEX_EQUIPABLE_EQUIP_FLAG_ARRAY', 12],
], [
]);
