...
// ---- 列挙定数 ----
export const FLOATING_INFO_ID_NONE       = 0;
export const FLOATING_INFO_ID_STATUS     = 1;
export const FLOATING_INFO_ID_EXTRA_INFO = 2;
export const FLOATING_INFO_ID_NOTICE     = 3;
