...
// ---- 列挙定数 ----
export const MONSTER_MAP_KIND_MAP              = 0;
export const MONSTER_MAP_KIND_MEMORIAL_DUNGEON = 1;
export const MONSTER_MAP_KIND_CATEGORY         = 2;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MONSTER_MAP_KIND_COUNT            = 3;
