...
// ---- 列挙定数 ----
export const MIG_PLAYER_ID_HUMAN = 0;
export const MIG_PLAYER_ID_DORAM = 1;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MIG_PLAYER_ID_COUNT = 2;
export const MIG_PLAYER_ID_ANY   = 3;
export const MIG_PLAYER_ID_ALL   = 4;
