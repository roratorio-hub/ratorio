...
// ---- 列挙定数 ----
export const MIG_TIME_UNIT_ID_SECOND = 0;
export const MIG_TIME_UNIT_ID_MINUTE = 1;
export const MIG_TIME_UNIT_ID_HOUR   = 2;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MIG_TIME_UNIT_ID_COUNT  = 3;
export const MIG_TIME_UNIT_ID_ANY    = 4;
