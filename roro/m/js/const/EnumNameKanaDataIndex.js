...
// ---- 列挙定数 ----
export const NAME_KANA_DATA_INDEX_NAME  = 0;
export const NAME_KANA_DATA_INDEX_KANA  = 1;
export const NAME_KANA_DATA_INDEX_SORT  = 2;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const NAME_KANA_DATA_INDEX_COUNT = 3;
