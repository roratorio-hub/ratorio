...
// ---- 列挙定数 ----
export const MIG_SIZE_ID_SMALL  = 0;
export const MIG_SIZE_ID_MEDIUM = 1;
export const MIG_SIZE_ID_LARGE  = 2;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MIG_SIZE_ID_COUNT  = 3;
export const MIG_SIZE_ID_ANY    = 4;
export const MIG_SIZE_ID_ALL    = 5;
