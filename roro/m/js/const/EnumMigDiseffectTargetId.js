/**
 * EnumMigDiseffectTargetId の定数定義.
 *
...
// ---- 列挙定数 ----
export const MIG_DISEFFECT_TARGET_ID_NONE   = 0;
export const MIG_DISEFFECT_TARGET_ID_PLAYER = 1;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MIG_DISEFFECT_TARGET_ID_COUNT  = 2;
export const MIG_DISEFFECT_TARGET_ID_ANY    = 3;
