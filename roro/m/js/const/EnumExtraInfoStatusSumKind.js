/**
 * EnumExtraInfoStatusSumKind の定数定義.
 *
 * !!! 自動生成ファイル。手で編集しない !!!
...
// ---- 列挙定数 ----
export const EXTRA_INFO_STATUS_SUM_KIND_NONE               = 0;
export const EXTRA_INFO_STATUS_SUM_KIND_MAZYONO_SKILL_CARD = 1;
export const EXTRA_INFO_STATUS_SUM_KIND_ALL_ITEM_AND_CARD  = 2;
