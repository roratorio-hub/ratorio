...
// ---- 列挙定数 ----
export const MIG_RANGE_ID_SHORT = 0;
export const MIG_RANGE_ID_LONG  = 1;

// ---- 疑似定数（旧 DefinePseudoEnum） ----
export const MIG_RANGE_ID_COUNT = 2;
export const MIG_RANGE_ID_ANY   = 3;
export const MIG_RANGE_ID_ALL   = 4;
