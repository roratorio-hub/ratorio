(function () {
	...
	CardObjNew[3762] = [3762,4,"幽霊船の艦長","ユウレイセンノカンチョウ","物理攻撃命中時、一定確率で敵に与えたダメージの3%をHPとして吸収",194,1,0];
	...
	CardObjNew[3766] = [3766,7,"ヨスタコレクター","ヨスタコレクター","物理攻撃命中時、一定確率で敵にオートスペル[スティール]Lv5発動",194,1,0];
	CardObjNew[3767] = [3767,7,"ヨスタネゴシエーター","ヨスタネゴシエーター","[オーバーチャージ]Lv5使用可能",194,1,0];
	CardObjNew[3768] = [3768,7,"ヨルカ商人","ヨルカショウニン","[アイテム鑑定]Lv1使用可能",194,1,0];
