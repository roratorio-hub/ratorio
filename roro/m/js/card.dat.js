(function () {
	...
	// --- 2025-12-16 ---
	/* 1404 魔女ジラントとのセット */
	CardObjNew[4030] = [4031,100,0,"","魔法攻撃命中時、一定確率で敵を3秒間[獄炎呪]状態にする",63,50,0];
	CardObjNew[4031] = [4032,100,0,"","",344,100,0];
	/* 1405 古龍ジラントとのセット */
	CardObjNew[4032] = [4034,100,0,"","",6241,50,6009,50,0];
	CardObjNew[4033] = [4035,100,0,"","物理・魔法攻撃命中時、一定確率で10秒間、Vit + 100",0];
	/* 2475 深海の魔女とのセット */
	CardObjNew[4034] = [4037,100,0,"","",61,50,11519,100,0];
	CardObjNew[4035] = [4038,100,0,"","物理・魔法攻撃命中時、一定確率で10秒間、1秒毎にSP + 10%",152,100,361,100,0];
