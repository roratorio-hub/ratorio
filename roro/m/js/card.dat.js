(function () {
	...
	CardObjNew[2937] = [2937,100,0,"","物理攻撃命中時、一定確率で20秒間、<br>[アックスストンプ]、[ラッシュストライク]の消費SP - 299<br>[ラッシュクエイク]の消費SP - 439<br>[マイティスマッシュ]、[パワフルスイング]の消費SP - 249<br>[ラッシュクエイク]の消費SP - 439",0];
	...
	CardObjNew[2953] = [2953,100,"","","魔法攻撃命中時、一定確率で20秒間、[アルビトリウム]の消費SP - 439[ニューマティックプロセラ]の消費SP - 659[フレーメン]の消費SP - 439",0];
	// --- 2024バレンタイン ---
