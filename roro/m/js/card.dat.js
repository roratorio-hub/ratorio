(function () {
	...
	CARD_ID_VOLIMPET = 4152;
	CARD_ID_POLLUTED_SILK_FROG = 4155;
	CARD_ID_ENCROACHED_DIMIK = 4159;
	CARD_ID_NYAISE = 4160
	CARD_ID_SHADOW_JAILER = 4161;
	CARD_ID_BLOODY_SLASHER = 4174;
	CARD_ID_SHADIEST = 4175;
	CARD_ID_THE_CHIEF_KNIGHT_OF_ABYSS = 4178;
	...
	CardObjNew[4150] = [4150,6,"ファイアループ","ファイアループ","精錬値と同じLvの[ファイアーウォール]使用可能",273,10,224,63,0];
	...
	CardObjNew[4154] = [4154,1,"ピーピング","ピーピング","後日、効果を「命中物理攻撃で与えるダメージ + ○%」に置き換えます",80,10,0];
	...
	CardObjNew[4158] = [4158,6,"浸食された修理型Vギア","シンショクサレタシュウリガタVギア","後日、効果を「命中物理攻撃で与えるダメージ + ○%」に置き換えます",80,5,7000080,3,9000080,2,0];
