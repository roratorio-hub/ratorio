(function () {
	...
	CardObjNew[2942] = [2942,99,"潜在解放(シャドウクロスIII)","センサイカイホウシヤトウクロスサン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[インパクトクレーター]、[サベージインパクト]の消費SP - 209[フェイタルシャドウクロー]の消費SP - 309",0];
	CardObjNew[2943] = [2943,100,0,"","",24022,209,24014,209,24020,309,0];
	...
	CardObjNew[3285] = [3285,100,0,"","追加で魔法攻撃命中時、一定確率で20秒間、[メタリックフューリー]の消費SP - 129",0];
	...
	CardObjNew[3289] = [3289,100,0,"","追加で物理攻撃命中時、一定確率で20秒間、[ビジラントアットナイト]の消費SP - 179[マガジンフォーワン]の消費SP - 99",0];
	...
	CardObjNew[3301] = [3301,100,0,"","追加で物理攻撃命中時、一定確率で20秒間、[スパークブラスター]の消費SP - 249[トリプルレーザー]の消費SP - 139",0];
	...
	CardObjNew[3309] = [3309,100,0,"","追加で物理攻撃命中時、一定確率で20秒間、[天地一陽]の消費SP - 149[天地一月]の消費SP - 269[太天一陽]、[天陽]、[太天一月]、[天月]、[天羅万象]の消費SP - 229",0];
	...
	CardObjNew[3481] = [3481,100,0,"","追加で魔法攻撃命中時、一定確率で20秒間、<br>[クリムゾンアロー]、[ストームキャノン]の消費SP - 359<br>[フローズンスラッシュ]、[ロックダウン]の消費SP - 329",0];
	...
	CardObjNew[3501] = [3501,100,0,"","[メタリックフューリー]使用時、一定確率でAP回復量 + 10",0];
	...
	// --- 2025-05-27 ---
	CardObjNew[3520] = [3520,99,"スキルオーブ(アークメイジI)","スキルオーブアークメイジ1","",100000000006069,1,100000000006070,1,100000000006068,1,100000000006067,1,0];
	...
	CardObjNew[3522] = [3522,99,"スキルオーブ(アビスチェイサーI)","スキルオーブアビスチェイサー1","",100000000006102,1,100000000006109,1,0];
	CardObjNew[3523] = [3523,99,"スキルオーブ(アビスチェイサーII)","スキルオーブアビスチェイサー2","",100000000006103,1,100000000006107,1,100000000006105,1,0];
	CardObjNew[3524] = [3524,99,"スキルオーブ(アビスチェイサーIII)","スキルオーブアビスチェイサー3","",100000000006100,1,100000000006101,1,100000000006106,1,0];
	CardObjNew[3525] = [3525,99,"スキルオーブ(インクイジターI)","スキルオーブインクイジター1","",100000000006113,1,100000000006123,1,100000000006124,1,0];
	...
	CardObjNew[3527] = [3527,99,"スキルオーブ(インペリアルガードI)","スキルオーブインペリアルガード1","",100000000006095,1,100000000006092,1,100000000006094,1,0];
	CardObjNew[3528] = [3528,99,"スキルオーブ(インペリアルガードII)","スキルオーブインペリアルガード2","",100000000006096,1,100000000006093,1,0];
	CardObjNew[3529] = [3529,99,"スキルオーブ(ウィンドホークI)","スキルオーブウィンドホーク1","",100000000006051,1,100000000006047,1,0];
	CardObjNew[3530] = [3530,99,"スキルオーブ(ウィンドホークII)","スキルオーブウィンドホーク2","",100000000006046,1,100000000006043,1,0];
	...
	CardObjNew[3532] = [3532,99,"スキルオーブ(エレメンタルマスターI)","スキルオーブエレメンタルマスター1","",100000000006149,1,100000000006146,1,100000000006147,1,100000000006150,1,100000000006148,1,100000000006157,1,0];
	CardObjNew[3533] = [3533,99,"スキルオーブ(カーディナルI)","スキルオーブカーディナル1","",100000000006028,1,100000000006033,1,100000000006039,1,0];
	...
	CardObjNew[3536] = [3536,99,"スキルオーブ(シャドウクロスII)","スキルオーブシャドウクロス2","",100000000006013,1,100000000006021,1,100000000006016,1,100000000006020,1,0];
	CardObjNew[3537] = [3537,99,"スキルオーブ(スピリットハンドラーI)","スキルオーブスピリットハンドラー1","",100000000006221,1,100000000006222,1,100000000006223,1,0];
	CardObjNew[3538] = [3538,99,"スキルオーブ(スピリットハンドラーII)","スキルオーブスピリットハンドラー2","",100000000006247,1,100000000006248,1,0];
	...
	CardObjNew[3541] = [3541,99,"スキルオーブ(ドラゴンナイトI)","スキルオーブドラゴンナイト1","",100000000006008,1,100000000006010,1,100000000006009,1,0];
	...
	CardObjNew[3545] = [3545,99,"スキルオーブ(トルバドゥール&トルヴェールII)","スキルオーブトルバドゥールアンドトルヴェール2","",100000000006134,1,100000000006133,1,0];
	CardObjNew[3546] = [3546,99,"スキルオーブ(ナイトウォッチI)","スキルオーブナイトウォッチ1","",100000000006216,1,100000000006217,1,100000000006218,1,100000000006219,1,100000000006220,1,0];
	...
	CardObjNew[3549] = [3549,99,"スキルオーブ(バイオロII)","スキルオーブバイオロ2","",100000000006239,1,0];
	...
	CardObjNew[3554] = [3554,99,"スキルオーブ(マイスターI)","スキルオーブマイスター1","",100000000006072,1,100000000006242,1,100000000006073,1,0];
	CardObjNew[3555] = [3555,99,"スキルオーブ(マイスターII)","スキルオーブマイスター2","",100000000006237,1,100000000006238,1,0];
	CardObjNew[3556] = [3556,99,"スキルオーブ(天帝I)","スキルオーブテンテイ1","",100000000006181,1,100000000006182,1,100000000006183,1,0];
	CardObjNew[3557] = [3557,99,"スキルオーブ(天帝II)","スキルオーブテンテイ2","",100000000006175,1,100000000006176,1,100000000006177,1,100000000006178,1,100000000006179,1,100000000006180,1,0];
	...
	CardObjNew[3589] = [3589,100,0,"","[爆火神弾]使用時、一定確率でAP回復量 + 10",0];
	...
	CardObjNew[3593] = [3593,100,0,"","[オンリーワンバレット]、<br>[スパイラルシューティング]<br>[マガジンフォーワン]、<br>[ビジラントアットナイト]<br>[ワイルドファイア]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[3594] = [3594,100,"潜在解放(スピリットハンドラーXIII)","センザイカイホウスピリットハンドラー13","",0];	// ゲーム内未実装のため一時的に種別コードを変更 99 → 100
	CardObjNew[3595] = [3595,100,0,"","[タイガースラッシュ]、<br>[タイガーハウリング]、<br>[タイガーストライク]使用時、一定確率でAP回復量 + 10",0];
	...
	CardObjNew[3599] = [3599,100,0,"","[天命落星]、<br>[天星]使用時、一定確率でAP回復量 + 10",0];
	...
	CardObjNew[3614] = [3614,100,0,"","",74,20,220,105,100000000006096,1,100000000006093,1,0];	// 暴食のクラウン(インペリアルガード)
	CardObjNew[3615] = [3615,100,0,"","",74,20,220,105,100000000006072,1,100000000006242,1,100000000006073,1,0];	// 暴食のクラウン(マイスター)
	...
	CardObjNew[3618] = [3618,100,0,"","",74,20,220,105,100000000006103,1,100000000006107,1,100000000006105,1,0];	// 暴食のクラウン(アビスチェイサー)
	...
	CardObjNew[3622] = [3622,100,0,"","",74,20,220,105,100000000006149,1,100000000006146,1,100000000006147,1,100000000006150,1,100000000006148,1,100000000006157,1,0];	// 暴食のクラウン(エレメンタルマスター)
	...
	CardObjNew[3624] = [3624,100,0,"","",74,20,220,105,100000000006134,1,100000000006133,1,0];	// 暴食のクラウン(トルバドゥール&トルヴェール)
	CardObjNew[3625] = [3625,100,0,"","",74,20,220,105,100000000006175,1,100000000006176,1,100000000006177,1,100000000006178,1,100000000006179,1,100000000006180,1,100000000006184,1,0];	// 暴食のクラウン(天帝)
	CardObjNew[3626] = [3626,100,0,"","",74,20,220,105,100000000006195,1,100000000006196,1,100000000006202,1,0];	// 暴食のクラウン(ソウルアセティック)
	CardObjNew[3627] = [3627,100,0,"","",74,20,220,105,100000000006218,1,100000000006219,1,100000000006220,1,0];	// 暴食のクラウン(ナイトウォッチ)
	...
	CardObjNew[3630] = [3630,100,0,"","",74,20,220,105,100000000006221,1,100000000006222,1,100000000006223,1,0];	// 暴食のクラウン(スピリットハンドラー)
