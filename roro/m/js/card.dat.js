...
CardObjNew[4464] = [4464,100,0,"","",20292,100,20293,100,0];
	...
	CardObjNew[4525] = [4525,1,"黒炎龍の夏休みカード","コクエンリュウノナツヤスミカード","",80,10,100000000000080,1,0];
	CardObjNew[4526] = [4526,100,0,"","",70,50,228,1,0];
	CardObjNew[4527] = [4527,1,"廣命龍の夏休みカード","コウメイリュウノナツヤスミカード","",80,10,100000000000080,1,0];
	CardObjNew[4528] = [4528,100,0,"","物理攻撃命中時、一定確率で敵に与えたダメージの10%をHP・SPとして吸収",85,10,0];
	CardObjNew[4529] = [4529,2,"マラムの夏休みカード","マラムノナツヤスミカード","[Mコメット]で受けるダメージ - 50%",0];
