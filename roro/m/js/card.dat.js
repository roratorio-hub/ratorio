(function () {
	...
	CardObjNew = [
		...
		[420,4,"RSX-0806","アールエスエックス0806","着用者はノックバックしない、鎧が損傷されない",3,3,0],
		...
		[900,6,"[LoVA] ルールー","ルール―","10秒毎にHPが回復<BR>BaseLvが1上がる度に10秒毎に回復するHPが上昇<BR>精錬値が7以上の時、純粋なStrが60上がる度に追加でAtk+6、MaxHP+1%",0],
		[901,6,"[LoVA] 真化ルールー","シンカルール―","10秒毎にHPが回復<BR>BaseLvが1上がる度に10秒毎に回復するHPが上昇<BR>精錬値が7以上の時、純粋なStrが20上がる度に追加でAtk+6、MaxHP+1%",0],
		...
		[2345,100,"",,"",68,15,0],
		[2346,100,0,,"",74,-5,0],
		[2347,2,"封印された黒蛇王","フウインサレタコクダオウ","",5,1,154,30,153,30,0],
		...
		[2475,5,"深海の魔女","シンカイノマジョ","絶対に冷凍状態にならない",341,100,61,50,0],
		...
		[2497,99,"氷結耐性",,"絶対に氷結状態にならない",361,100,0],
		[2498,99,"冷凍耐性",,"絶対に冷凍状態にならない",360,100,0],
		...
		[2664,100,0,,"",15,15,77,50,243,5,220,156,0],	// 祈りの晩鐘 + ウィワートゥス(両手)
		...
		[2691,1,"ハートハンターAT","ハートハンターエーティー","カタールの場合、Hit - 10 , Cri + 10、クリティカル攻撃で与えるダメージ + 10%<BR>カタールの場合で、かつ精錬値が1上がる度に追加で、Hit - 1 , Cri + 1、クリティカル攻撃で与えるダメージ + 1%",80,10,0],
		...
		[2740,100,0,,"物理攻撃命中時、一定確率で10秒間、<br>[炎火滅魔神弾]の消費SP - 299、<br>[爆火神弾]の消費SP - 169、<br>[聖油洗礼]の消費SP - 199",0],
	...
	CardObjNew[2918] = [2918,100,0,"","物理攻撃命中時、一定確率で20秒間、<br>[チェーンリアクションショット]の消費SP - 169<br>[フレンジショット]の消費SP - 109",0];
	...
	CardObjNew[2928] = [2928,99,"潜在解放(バイオロIV)","センサイカイホウハイオロヨン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[アシディファイドゾーン(火)]、[アシディファイドゾーン(風)]の消費SP - 539[アシディファイドゾーン(水)]、[アシディファイドゾーン(地)]の消費SP - 479",0];
	CardObjNew[2929] = [2929,100,0,"","",24165,539,24166,539,24163,479,24164,479,0];
	CardObjNew[2930] = [2930,99,"潜在解放(ドラゴンナイトIV)","センサイカイホウトラコンナイトヨン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[ハックアンドスラッシャー][マッドネスクラッシャー]の消費SP - 189",0];
	CardObjNew[2931] = [2931,100,0,"","",24008,189,24010,189,0];
	CardObjNew[2932] = [2932,99,"潜在解放(ハイパーノービスIII)","センサイカイホウハイハアノオヒスサン","",0];
	CardObjNew[2933] = [2933,100,0,"","魔法攻撃命中時、一定確率で20秒間、<br>[ユピテルサンダーストーム]の消費SP - 79<br>[ヘルズドライブ]の消費SP - 69<br>[ナパームバルカンストライク]の消費SP - 109",0];
	CardObjNew[2934] = [2934,99,"潜在解放(インペリアルガードIV)","センサイカイホウインヘリアルカアトヨン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[オーバースラッシュ]の消費SP - 239[グランドジャッジメント]の消費SP - 429[シールドシューティング]の消費SP - 159",0];
	CardObjNew[2935] = [2935,100,0,"","",24095,239,24092,429,24094,159,0];
	CardObjNew[2936] = [2936,99,"潜在解放(マイスターIII)","センサイカイホウマイスタアサン","",0];
	CardObjNew[2937] = [2937,100,0,"","物理攻撃命中時、一定確率で20秒間、<br>[アックスストンプ]の消費SP - 299<br>[ラッシュクエイク]の消費SP - 439<br>[マイティスマッシュ]の消費SP - 249",0];
	CardObjNew[2938] = [2938,99,"潜在解放(ナイトウォッチII)","センサイカイホウナイトウオツチサン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[オンリーワンバレット]の消費SP - 99[スパイラルシューティング]の消費SP - 179",0];
	CardObjNew[2939] = [2939,100,0,"","",24216,99,24217,179,0];
	CardObjNew[2940] = [2940,99,"潜在解放(スピリットハンドラーIII)","センサイカイホウスヒリツトハントラアサン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[タイガースラッシュ]の消費SP - 99[タイガーハウリング]の消費SP - 199[タイガーストライク]の消費SP - 169",0];
	CardObjNew[2941] = [2941,100,0,"","",24221,99,24222,199,24223,169,0];
	CardObjNew[2942] = [2942,99,"潜在解放(シャドウクロスIII)","センサイカイホウシヤトウクロスサン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[インパクトクレーター]、[サベージインパクト]の消費SP - 209",0];
	CardObjNew[2943] = [2943,100,0,"","",24022,209,24014,209,0];
	CardObjNew[2944] = [2944,99,"潜在解放(天帝II)","センサイカイホウテンテイニ","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[天地万星]、[天命落星]、[天星]の消費SP - 269",0];
	CardObjNew[2945] = [2945,100,0,"","",24181,269,24182,269,24183,269,0];
	CardObjNew[2946] = [2946,99,"潜在解放(蜃気楼&不知火II)","センサイカイホウシンキロウシラヌイニ","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[影狩り]の消費SP - 229[影の舞]、[影一閃]の消費SP - 189[幻術 -影縫い-]の消費SP - 279",0];
	CardObjNew[2947] = [2947,100,0,"","",24227,229,24225,189,24226,189,24228,279,0];
	CardObjNew[2948] = [2948,99,"潜在解放(トルバドゥール&トルヴェールII)","センサイカイホウトルハトウウルトルウエエルニ","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[リズムシューティング]の消費SP - 109[ロゼブロッサム]の消費SP - 229",0];
	CardObjNew[2949] = [2949,100,0,"","",24132,109,24131,229,0];
	CardObjNew[2950] = [2950,99,"潜在解放(ウィンドホークV)","センサイカイホウウイントホオクコ","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[クレッシブボルト]の消費SP - 119[ゲイルストーム]の消費SP - 169",0];
	CardObjNew[2951] = [2951,100,0,"","",24051,119,24047,169,0];
	CardObjNew[2952] = [2952,99,"潜在解放(カーディナルVI)","センサイカイホウカアテイナルロク","[真理の解放]と共に装備時、追加で魔法攻撃命中時、一定確率で20秒間、[アルビトリウム]の消費SP - 439[ニューマティックプロセラ]の消費SP - 659[フレーメン]の消費SP - 439",0];
	CardObjNew[2953] = [2953,100,0,"","",24028,439,24039,439,24033,659,0];
	// --- 2024バレンタイン ---
	...
	CardObjNew[3087] = [3087,100,0,"","",74,20,220,105,100000000006069,1,100000000006070,1,100000000006068,1,100000000006067,1,0];
	CardObjNew[3088] = [3088,100,0,"","",74,20,220,105,100000000006102,1,100000000006109,1,0];
	CardObjNew[3089] = [3089,100,0,"","",74,20,220,105,100000000006113,1,100000000006123,1,100000000006124,1,0];
	CardObjNew[3090] = [3090,100,0,"","",74,20,220,105,100000000006095,1,100000000006092,1,100000000006094,1,0];
	CardObjNew[3091] = [3091,100,0,"","",74,20,220,105,100000000006051,1,100000000006047,1,0];
	CardObjNew[3092] = [3092,100,0,"","",74,20,220,105,100000000006149,1,100000000006146,1,100000000006147,1,100000000006150,1,100000000006148,1,100000000006157,1,0];
	CardObjNew[3093] = [3093,100,0,"","",74,20,220,105,100000000006028,1,100000000006033,1,100000000006039,1,0];
	CardObjNew[3094] = [3094,100,0,"","",74,20,220,105,100000000006013,1,100000000006021,1,100000000006016,1,100000000006020,1,0];	// 時間の注視者 + 時間のサークレット(シャドウクロス)
	CardObjNew[3095] = [3095,100,0,"","",74,20,220,105,100000000006247,1,100000000006248,1,0];
	...
	CardObjNew[3097] = [3097,100,0,"","",74,20,220,105,100000000006008,1,100000000006010,1,100000000006009,1,0];
	CardObjNew[3098] = [3098,100,0,"","",74,20,220,105,100000000006132,1,100000000006131,1,0];
	CardObjNew[3099] = [3099,100,0,"","",74,20,220,105,100000000006216,1,100000000006217,1,100000000006220,1,0];
	...
	CardObjNew[3102] = [3102,100,0,"","",74,20,220,105,100000000006237,1,100000000006238,1,0];
	CardObjNew[3103] = [3103,100,0,"","",74,20,220,105,100000000006227,1,100000000006225,1,100000000006226,1,100000000006228,1,0];
	CardObjNew[3104] = [3104,100,0,"","",74,20,220,105,100000000006181,1,100000000006182,1,100000000006183,1,0];
	...
	// --- 2024/09/24 死なない者 ---
	CardObjNew[3143] = [3143,99,"氷華の魔力(アークメイジI)","ヒヨウカノマリヨクアアクメイシイチ","",6069,25,6070,25,6068,25,6067,25,0];
	CardObjNew[3144] = [3144,99,"氷華の魔力(アークメイジII)","ヒヨウカノマリヨクアアクメイシニ","",6059,25,6057,25,6053,25,6066,25,0];
	CardObjNew[3145] = [3145,99,"氷華の魔力(アビスチェイサーI)","ヒヨウカノマリヨクアヒスチエイサアイチ","",6102,25,6109,25,0];
	CardObjNew[3146] = [3146,99,"氷華の魔力(アビスチェイサーII)","ヒヨウカノマリヨクアヒスチエイサアニ","<br>※ゲーム内では [フロムジアビス] ではなく [アビス球体攻撃] と表記されます",6103,25,6107,25,6105,25,0];
	CardObjNew[3147] = [3147,99,"氷華の魔力(アビスチェイサーIII)","ヒヨウカノマリヨクアヒスチエイサアサン","",6100,25,6101,25,6106,25,0];
	CardObjNew[3148] = [3148,99,"氷華の魔力(インクイジターI)","ヒヨウカノマリヨクインクイシタアイチ","",6113,25,6123,25,6124,25,0];
	CardObjNew[3149] = [3149,99,"氷華の魔力(インクイジターII)","ヒヨウカノマリヨクインクイシタアニ","",6121,25,6117,25,6122,25,6119,25,6120,25,6118,25,0];
	CardObjNew[3150] = [3150,99,"氷華の魔力(インペリアルガードI)","ヒヨウカノマリヨクインヘリアルカアトイチ","",6095,25,6092,25,6094,25,0];
	CardObjNew[3151] = [3151,99,"氷華の魔力(インペリアルガードII)","ヒヨウカノマリヨクインヘリアルカアトニ","",6096,25,6093,25,0];
	CardObjNew[3152] = [3152,99,"氷華の魔力(ウィンドホークI)","ヒヨウカノマリヨクウイントホオクイチ","",6051,25,6047,25,0];
	CardObjNew[3153] = [3153,99,"氷華の魔力(ウィンドホークII)","ヒヨウカノマリヨクウイントホオクニ","",6046,25,6043,25,0];
	CardObjNew[3154] = [3154,99,"氷華の魔力(ウィンドホークIII)","ヒヨウカノマリヨクウイントホオクサン","",6052,25,6050,25,6049,25,6048,25,0];
	CardObjNew[3155] = [3155,99,"氷華の魔力(エレメンタルマスターI)","ヒヨウカノマリヨクエレメンタルマスタアイチ","",6149,25,6146,25,6147,25,6150,25,6148,25,6157,25,0];
	CardObjNew[3156] = [3156,99,"氷華の魔力(カーディナルI)","ヒヨウカノマリヨクカアテイナルイチ","",6028,25,6033,25,6039,25,0];
	...
	CardObjNew[3159] = [3159,99,"氷華の魔力(シャドウクロスII)","ヒヨウカノマリヨクシヤトウクロスニ","",6013,25,6021,25,6016,25,6020,25,0];
	CardObjNew[3160] = [3160,99,"氷華の魔力(ドラゴンナイトI)","ヒヨウカノマリヨクトラコンナイトイチ","",6008,25,6010,25,6009,25,0];
	...
	CardObjNew[3164] = [3164,99,"氷華の魔力(トルバドゥール&トルヴェールII)","ヒヨウカノマリヨクトルハトウウルトルウエエルニ","",6134,25,6133,25,0];
	CardObjNew[3165] = [3165,99,"氷華の魔力(バイオロI)","ヒヨウカノマリヨクハイオロイチ","",6165,25,6163,25,6166,25,6164,25,0];
	CardObjNew[3166] = [3166,99,"氷華の魔力(バイオロII)","ヒヨウカノマリヨクハイオロニ","",6239,25,0];
	CardObjNew[3167] = [3167,99,"氷華の魔力(バイオロIII)","ヒヨウカノマリヨクハイオロサン","",6240,25,0];
	CardObjNew[3168] = [3168,99,"氷華の魔力(マイスターI)","ヒヨウカノマリヨクマイスタアイチ","",6072,25,6242,25,6073,25,0];
	CardObjNew[3169] = [3169,99,"氷華の魔力(マイスターII)","ヒヨウカノマリヨクマイスタアニ","",6237,25,6238,25,0];
	CardObjNew[3170] = [3170,99,"氷華の魔力(スピリットハンドラーI)","ヒヨウカノマリヨクスヒリツトハントラアイチ","",6221,25,6222,25,6223,25,0];
	CardObjNew[3171] = [3171,99,"氷華の魔力(スピリットハンドラーII)","ヒヨウカノマリヨクスヒリツトハントラアニ","",6247,25,6248,25,0];
	...
	CardObjNew[3174] = [3174,99,"氷華の魔力(ナイトウォッチI)","ヒヨウカノマリヨクナイトウオツチイチ","",6216,25,6217,25,6218,25,6219,25,6220,25,0];
	...
	CardObjNew[3182] = [3182,99,"氷華の魔力(天帝I)","ヒヨウカノマリヨクテンテイイチ","",6181,25,6182,25,6183,25,0];
	CardObjNew[3183] = [3183,99,"氷華の魔力(天帝II)","ヒヨウカノマリヨクテンテイニ","",6175,25,6176,25,6177,25,6178,25,6179,25,6180,25,0];
	CardObjNew[3184] = [3184,99,"氷華の魔力(ルーンナイトII)","ヒヨウカノマリヨクルウンナイトニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5445,15,5440,15,8005445,20,8005440,20,9005445,40,9005440,40,10005445,75,10005440,75,0];
	CardObjNew[3185] = [3185,99,"氷華の魔力(ウォーロックII)","ヒヨウカノマリヨクウオオロツクニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5527,5,5518,5,5531,10,5520,15,5519,15,5528,15,8005527,10,8005518,10,8005531,15,8005520,20,8005519,20,8005528,20,9005527,15,9005518,15,9005531,25,9005520,40,9005519,40,9005528,40,10005527,30,10005518,30,10005531,50,10005520,75,10005519,75,10005528,75,0];
	CardObjNew[3186] = [3186,99,"氷華の魔力(レンジャーII)","ヒヨウカノマリヨクレンシヤアニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5498,5,5497,5,8005498,5,8005497,5,9005498,5,9005497,5,10005498,15,10005497,15,0];
	CardObjNew[3187] = [3187,99,"氷華の魔力(アークビショップII)","ヒヨウカノマリヨクアアクヒシヨツフニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5478,15,5476,15,8005478,20,8005476,20,9005478,40,9005476,40,10005478,75,10005476,75,0];
	CardObjNew[3188] = [3188,99,"氷華の魔力(メカニックIII)","ヒヨウカノマリヨクメカニツクサン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5541,15,5542,15,5543,15,5554,5,8005541,20,8005542,20,8005543,20,8005554,10,9005541,40,9005542,40,9005543,40,9005554,15,10005541,75,10005542,75,10005543,75,10005554,30,0];
	CardObjNew[3189] = [3189,99,"氷華の魔力(ギロチンクロスII)","ヒヨウカノマリヨクキロチンクロスニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5460,15,5475,15,5474,15,5469,5,8005460,20,8005475,20,8005474,20,8005469,5,9005460,40,9005475,40,9005474,40,9005469,5,10005460,75,10005475,75,10005474,75,10005469,15,0];
	CardObjNew[3190] = [3190,99,"氷華の魔力(ロイヤルガードIII)","ヒヨウカノマリヨクロイヤルカアトサン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5585,10,5569,10,5572,10,5583,10,5570,25,8005585,15,8005569,15,8005572,15,8005583,15,8005570,50,9005585,25,9005569,25,9005572,25,9005583,25,9005570,75,10005585,50,10005569,50,10005572,50,10005583,50,10005570,150,0];
	CardObjNew[3191] = [3191,99,"氷華の魔力(ソーサラーII)","ヒヨウカノマリヨクソオサラアニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5666,10,5669,10,5662,10,5667,10,8005666,15,8005669,15,8005662,15,8005667,15,9005666,25,9005669,25,9005662,25,9005667,25,10005666,50,10005669,50,10005662,50,10005667,50,0];
	CardObjNew[3192] = [3192,99,"氷華の魔力(ミンストレル&ワンダラーIII)","ヒヨウカノマリヨクミンストレルワンタラアサン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5642,10,5641,10,8005642,15,8005641,15,9005642,25,9005641,25,10005642,50,10005641,50,0];
	CardObjNew[3193] = [3193,99,"氷華の魔力(修羅II)","ヒヨウカノマリヨクシユラニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5622,10,5610,15,5612,15,8005622,15,8005610,20,8005612,20,9005622,25,9005610,40,9005612,40,10005622,50,10005610,75,10005612,75,0];
	CardObjNew[3194] = [3194,99,"氷華の魔力(ジェネティックII)","ヒヨウカノマリヨクシエネテイツクンニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5723,15,5722,15,5736,15,8005723,20,8005722,20,8005736,20,9005723,40,9005722,40,9005736,40,10005723,75,10005722,75,10005736,75,0];
	CardObjNew[3195] = [3195,99,"氷華の魔力(シャドウチェイサーIII)","ヒヨウカノマリヨクシヤトウチエイサアサン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5608,10,5606,10,8005608,15,8005606,15,9005608,25,9005606,25,10005608,50,10005606,50,0];
	CardObjNew[3196] = [3196,99,"氷華の魔力(サモナーIII)","ヒヨウカノマリヨクサモナアサン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5933,5,5938,5,8005933,10,8005938,10,9005933,15,9005938,15,10005933,30,10005938,30,0];
	CardObjNew[3197] = [3197,99,"氷華の魔力(サモナーIV)","ヒヨウカノマリヨクサモナアヨン","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5922,5,5920,5,8005922,10,8005920,10,9005922,15,9005920,15,10005922,30,10005920,30,0];
	CardObjNew[3198] = [3198,99,"氷華の魔力(影狼&朧II)","ヒヨウカノマリヨクカケロウオホロニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5766,5,5768,5,5769,5,5770,5,8005766,10,8005768,10,8005769,10,8005770,10,9005766,15,9005768,15,9005769,15,9005770,15,10005766,30,10005768,30,10005769,30,10005770,30,0];
	CardObjNew[3199] = [3199,99,"氷華の魔力(リベリオンII)","ヒヨウカノマリヨクリヘリオンニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5830,5,5825,10,5839,10,5831,10,5838,10,5834,10,5828,15,5835,15,5827,15,8005830,10,8005825,15,8005839,15,8005831,15,8005838,15,8005834,15,8005828,20,8005835,20,8005827,20,9005830,15,9005825,25,9005839,25,9005831,25,9005838,25,9005834,25,9005828,40,9005835,40,9005827,40,10005830,30,10005825,50,10005839,50,10005831,50,10005838,50,10005834,50,10005828,75,10005835,75,10005827,75,0];
	CardObjNew[3200] = [3200,99,"氷華の魔力(星帝II)","ヒヨウカノマリヨクセイテイニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5951,5,5955,5,5959,5,8005951,5,8005955,5,8005959,5,9005951,5,9005955,5,9005959,5,10005951,15,10005955,15,10005959,15,0];
	CardObjNew[3201] = [3201,99,"氷華の魔力(ソウルリーパーII)","ヒヨウカノマリヨクソウルリイハアニ","<br>※現状では「精錬値がn以上の時」の効果が加算される前提で実装していますが、ゲーム内では「精錬値がnの時」と場合分けで表記されており、実際の効果とは異なる可能性があります。これについて検証された方からの情報提供をお待ちしています。",5968,5,5969,5,5977,5,8005968,10,8005969,10,8005977,10,9005968,15,9005969,15,9005977,15,10005968,30,10005969,30,10005977,30,0];
