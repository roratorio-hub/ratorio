(function () {
	...
	CARD_ID_INFINITE2_ECLIPSE = 4020;
	...
	CardObjNew[4101] = [4101,99,"潜在解放(アビスチェイサーXIX)","センザイカイホウアビスチェイサーナインティーン","",0];
	CardObjNew[4102] = [4102,100,0,"","[フレンジショット][ヒットアンドスライディング][チェイシングショット]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4103] = [4103,99,"潜在解放(インペリアルガードXVII)","センザイカイホウインペリアルガードセブンティーン","",0];
	CardObjNew[4104] = [4104,100,0,"","[オーバースラッシュ][シールドシューティング][レイディアントスピア][インペリアルクロス]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4105] = [4105,99,"潜在解放(ウィンドホークXIX)","センザイカイホウウィンドホークナインティーン","",0];
	CardObjNew[4106] = [4106,100,0,"","[クレッシブボルト]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4107] = [4107,99,"潜在解放(シャドウクロスXVII)","センザイカイホウシャドウクロスセブンティーン","",0];
	CardObjNew[4108] = [4108,100,0,"","[クロススラッシュ]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4109] = [4109,99,"潜在解放(ソウルアセティックXVI)","センザイカイホウソウルアセティックシックスティーン","",0];
	CardObjNew[4110] = [4110,100,0,"","[死霊浄化]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4111] = [4111,99,"潜在解放(ドラゴンナイトXIX)","センザイカイホウドドラゴンナイトナインティーン","",0];
	CardObjNew[4112] = [4112,100,0,"","[ドラゴニックピアース]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4113] = [4113,99,"潜在解放(トルバドゥール&トルヴェールXIV)","センザイカイホウトルバドゥールアンドトルヴェールフォーティーン","",0];
	CardObjNew[4114] = [4114,100,0,"","[ミスティックシンフォニー]のAP消費量 + 50<br>[ミスティックシンフォニー]使用時、60秒間、[S.Matk増加]状態になる<br>装備解除時、[S.Matk増加]状態を解除する",0];
	CardObjNew[4115] = [4115,99,"潜在解放(ナイトウォッチXVI)","センザイカイホウナイトウォッチシックスティーン","",0];
	CardObjNew[4116] = [4116,100,0,"","[ヒドゥンカード]のAP消費量 + 50<br>[ヒドゥンカード]使用時、60秒間、[P.Atk増加]状態になる<br>装備解除時、[P.Atk増加]状態を解除する",0];
	CardObjNew[4117] = [4117,99,"潜在解放(バイオロXVIII)","センザイカイホウバイオロエイティーン","",0];
	CardObjNew[4118] = [4118,100,0,"","[メイヘミックソーンズ]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4119] = [4119,99,"潜在解放(蜃気楼&不知火XIX)","センザイカイホウシンキロウアンドシラヌイナインティーン","",0];
	CardObjNew[4120] = [4120,100,0,"","[暗転砲]使用時、一定確率でAP回復量 + 10",0];
	CardObjNew[4121] = [4121,99,"潜在解放(スピリットハンドラーXXII)","センザイカイホウスピリットハンドラートゥエンティツー","",0];
