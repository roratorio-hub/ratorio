(function () {
	...
	CardObjNew = [
		...
		[270,7,"クッキー（緑）","クッキーミドリ","0",6,2,5037,10,5387,10,0],
		[271,5,"九尾狐","キュウビキツネ","精錬値が9以上の時、FLEE+20。",2,2,0],
		...
		[1239,7,"T_W_O","ティーダブリューオー","固定詠唱時間-50%。",293,50,298,50,0],
		...
		[1307,3,"大長老アイリン","ダイチョウリョウアイリン","精錬値が7以上の時、追加で小・中・大型モンスターから受けるダメージ-10%。",190,20,191,20,192,20,0],
		...
		[1318,7,"fff・ジターバグ","エフエフエフジターバグ","",152,50,5641,50,0],
		...
		[1356,5,"怒りの九尾狐","イカリノキュウビキツネ","",62,20,65,20,7000078,10,0],
		...
		[1446,5,"古のメガリス","イニシエのメガリス","純粋なVitが10上がる度に追加でAtk + 3、Hit + 5<BR>純粋なLukが10上がる度に追加でAtk + 3、攻撃速度 + 1%",21000000017,50,21000000008,25,24000000017,50,24000000012,5,0],
		...
		[1483,2,"EL_A17T","イーエルエー17ティー","",62,10,66,10,220,89,105554,10,0],
		...
		[1495,7,"R48-85-ベスティアカード","アール48-85-ベスティアカード","",74,30,0],
		[1496,100,0,,"",74,-30,0],
		...
		[2336,4,"封印されたRSX-0806","フウインサレタアールエエスエックス-0806","鎧が絶対に壊れない",3,1,0],
		...
		[2621,2,"変異キメラガレンシス","ヘンイキメラガレシンス","精錬値と同じLvの[三段掌]が素手と全ての武器で使用可能",0],
		...
		[2685,1,"最下級ルガン","サイジョウキュウルガン","物理・魔法攻撃時、[蛇神の温もり 01]、[蛇神の温もり 02]に出現するモンスターに与えるダメージ + 30%",0],
		...
		[2690,1,"洞窟不凍花","ドウクツフトウバナ","物理攻撃命中時、一定確率で10秒間、水属性物理攻撃力 + 20%",80,10,0],
