(function () {
	...
	CardObjNew = [
		...
		[1217,5,"修羅チェン(MVP)","シュラチェンMVP","修羅が装備時、MaxHP+10%、物理攻撃で与えるダメージ+10%。<BR>BaseLvが165の時、追加ですべてのステータス+10。<BR>精錬値が10の時、追加ですべてのステータス+10。",0],
		[1218,100,"",,"物理攻撃命中時、一定確率で5秒間、Str+100、モンスター「チェン=リウ」(修羅)に変身。",0],
		[1219,7,"シャドウチェイサーガーティー",,"",5608,70,0],
		[1220,5,"シャドウチェイサーガーティー(MVP)",,"シャドウチェイサーが装備時、物理攻撃で与えるダメージ+5%、魔法攻撃で与えるダメージ+15%。<BR>BaseLvが165の時、追加ですべてのステータス+10。<BR>精錬値が10の時、追加ですべてのステータス+10。",0],
		...
		[1335,2,"ビッグエッグリン",,"精錬値が1上がる度に追加ですべてのステータス+1。",0],
		...
		[1610,6,"硬化ムスペルスコール","コウカムスペルスコール","発火に対する耐性 + 50%",15,10,16,10,43,30,353,30,0],
		...
		[1968,6,"封印された硬化ムスペルスコール","フウインサレタコウカムスペルスコール","発火に対する耐性 + 15%",15,5,16,5,43,10,353,10,0],
	...
	CardObjNew[2918] = [2918,100,0,"","",20102,300,20109,300,0];
	...
	CardObjNew[2932] = [2932,99,"潜在解放(ハイパーノービスIII)","センサイカイホウハイハアノオヒスサン","[真理の解放]と共に装備時、追加で魔法攻撃命中時、一定確率で20秒間、[ユピテルサンダーストーム]の消費SP - 79[ヘルズドライブ]の消費SP - 69",0];
	CardObjNew[2933] = [2933,100,0,"","",24231,79,24232,69,0];
	...
	CardObjNew[2936] = [2936,99,"潜在解放(マイスターIII)","センサイカイホウマイスタアサン","[豪傑]と共に装備時、追加で物理攻撃命中時、一定確率で20秒間、[アックスストンプ]の消費SP - 299[ラッシュクエイク]の消費SP - 439",0];
	CardObjNew[2937] = [2937,100,0,"","",24072,299,24073,439,0];
	...
	CardObjNew[3094] = [3094,100,0,"","",74,20,220,105,100000000006013,1,100000000006021,1,100000000006016,1,0];
