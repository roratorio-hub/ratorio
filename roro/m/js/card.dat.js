(function () {
	...
	window.CARD_ID_NONE = 0;
	window.CARD_ID_PHYSICAL_RACE_ALL_20UP = 1;
	window.CARD_ID_PHYSICAL_MONSTER_ELM_ALL_20UP = 2;
	window.CARD_ID_PHYSICAL_SIZE_ALL_15UP = 3;
	window.CARD_ID_FABL = 4;
	window.CARD_ID_DROPPS = 5;
	window.CARD_ID_HORNET = 6;
	window.CARD_ID_LUNATIC = 7;
	window.CARD_ID_MESU_TOCHU = 8;
	window.CARD_ID_SKELETON = 9;
	window.CARD_ID_WOLF = 10;
	window.CARD_ID_ANDRE = 11;
	window.CARD_ID_PEKOPEKONO_TAMAGO = 12;
	window.CARD_ID_13 = 13;
	window.CARD_ID_14 = 14;
	window.CARD_ID_15 = 15;
	window.CARD_ID_16 = 16;
	window.CARD_ID_17 = 17;
	window.CARD_ID_18 = 18;
	window.CARD_ID_19 = 19;
	window.CARD_ID_20 = 20;
	window.CARD_ID_21 = 21;
	window.CARD_ID_22 = 22;
	window.CARD_ID_23 = 23;
	window.CARD_ID_24 = 24;
	window.CARD_ID_25 = 25;
	window.CARD_ID_26 = 26;
	window.CARD_ID_27 = 27;
	window.CARD_ID_28 = 28;
	window.CARD_ID_29 = 29;
	window.CARD_ID_30 = 30;
	window.CARD_ID_SHINENNO_KISHI = 31;
	window.CARD_ID_DRAKE = 32;
	window.CARD_ID_33 = 33;
	window.CARD_ID_34 = 34;
	window.CARD_ID_35 = 35;
	window.CARD_ID_36 = 36;
	window.CARD_ID_37 = 37;
	window.CARD_ID_38 = 38;
	window.CARD_ID_39 = 39;
	window.CARD_ID_40 = 40;
	window.CARD_ID_41 = 41;
	window.CARD_ID_DOPPELGANGER = 42;
	window.CARD_ID_SIDEWINDER = 43;
	window.CARD_ID_FURIONI = 44;
	window.CARD_ID_BAPHOMET = 45;
	window.CARD_ID_HUNTERFLY = 46;
	window.CARD_ID_DRACULA = 47;
	window.CARD_ID_48 = 48;
	window.CARD_ID_49 = 49;
	window.CARD_ID_50 = 50;
	window.CARD_ID_51 = 51;
	window.CARD_ID_ORC_HERO = 52;
	window.CARD_ID_53 = 53;
	window.CARD_ID_54 = 54;
	window.CARD_ID_55 = 55;
	window.CARD_ID_THARA_FROG = 56;
	window.CARD_ID_ORC_WORRIOR = 57;
	window.CARD_ID_BIGFOOT = 58;
	window.CARD_ID_RAFFLESIA = 59;
	window.CARD_ID_SKY_PTITE = 60;
	window.CARD_ID_KHALITZBURG = 61;
	window.CARD_ID_HORN = 62;
	window.CARD_ID_63 = 63;
	window.CARD_ID_64 = 64;
	window.CARD_ID_65 = 65;
	window.CARD_ID_66 = 66;
	window.CARD_ID_67 = 67;
	window.CARD_ID_68 = 68;
	window.CARD_ID_69 = 69;
	window.CARD_ID_70 = 70;
	window.CARD_ID_71 = 71;
	window.CARD_ID_72 = 72;
	window.CARD_ID_73 = 73;
	window.CARD_ID_74 = 74;
	window.CARD_ID_EVIL_DRUID = 75;
	window.CARD_ID_76 = 76;
	window.CARD_ID_77 = 77;
	window.CARD_ID_78 = 78;
	window.CARD_ID_79 = 79;
	window.CARD_ID_DUSTYNESS = 80;
	window.CARD_ID_MARTH = 81;
	window.CARD_ID_JACK = 82;
	window.CARD_ID_HORD = 83;
	window.CARD_ID_MARIONETTE = 84;
	window.CARD_ID_ORC_ZOMBIE = 85;
	window.CARD_ID_86 = 86;
	window.CARD_ID_MIST = 87;
	window.CARD_ID_88 = 88;
	window.CARD_ID_89 = 89;
	window.CARD_ID_90 = 90;
	window.CARD_ID_91 = 91;
	window.CARD_ID_92 = 92;
	window.CARD_ID_93 = 93;
	window.CARD_ID_94 = 94;
	window.CARD_ID_EDDGA = 95;
	window.CARD_ID_96 = 96;
	window.CARD_ID_97 = 97;
	window.CARD_ID_98 = 98;
	window.CARD_ID_99 = 99;
	window.CARD_ID_100 = 100;
	window.CARD_ID_101 = 101;
	window.CARD_ID_102 = 102;
	window.CARD_ID_103 = 103;
	window.CARD_ID_104 = 104;
	window.CARD_ID_105 = 105;
	window.CARD_ID_106 = 106;
	window.CARD_ID_ARCHER_SKELETON = 107;
	window.CARD_ID_108 = 108;
	window.CARD_ID_109 = 109;
	window.CARD_ID_110 = 110;
	window.CARD_ID_111 = 111;
	window.CARD_ID_112 = 112;
	window.CARD_ID_113 = 113;
	window.CARD_ID_114 = 114;
	window.CARD_ID_115 = 115;
	window.CARD_ID_116 = 116;
	window.CARD_ID_117 = 117;
	window.CARD_ID_118 = 118;
	window.CARD_ID_MISTRESS = 119;
	window.CARD_ID_PHARAOH = 120;
	window.CARD_ID_121 = 121;
	window.CARD_ID_ANUBIS = 122;
	window.CARD_ID_123 = 123;
	window.CARD_ID_124 = 124;
	window.CARD_ID_125 = 125;
	window.CARD_ID_OGONCHU = 126;
	window.CARD_ID_MAYA = 127;
	window.CARD_ID_128 = 128;
	window.CARD_ID_129 = 129;
	window.CARD_ID_130 = 130;
	window.CARD_ID_131 = 131;
	window.CARD_ID_132 = 132;
	window.CARD_ID_ARGIOPE = 133;
	window.CARD_ID_ANGELRING = 134;
	window.CARD_ID_BARSLY = 135;
	window.CARD_ID_136 = 136;
	window.CARD_ID_137 = 137;
	window.CARD_ID_ORCLORD = 138;
	window.CARD_ID_139 = 139;
	window.CARD_ID_WORUYAFA = 140;
	window.CARD_ID_VERSEVV = 141;
	window.CARD_ID_142 = 142;
	window.CARD_ID_143 = 143;
	window.CARD_ID_144 = 144;
	window.CARD_ID_145 = 145;
	window.CARD_ID_146 = 146;
	window.CARD_ID_147 = 147;
	window.CARD_ID_148 = 148;
	window.CARD_ID_149 = 149;
	window.CARD_ID_150 = 150;
	window.CARD_ID_151 = 151;
	window.CARD_ID_OSIRIS = 152;
	window.CARD_ID_153 = 153;
	window.CARD_ID_154 = 154;
	window.CARD_ID_155 = 155;
	window.CARD_ID_156 = 156;
	window.CARD_ID_157 = 157;
	window.CARD_ID_158 = 158;
	window.CARD_ID_159 = 159;
	window.CARD_ID_160 = 160;
	window.CARD_ID_HAWARD_ALTIZEN_MVP = 161;
	window.CARD_ID_CECIL_DIMON_MVP = 162;
	window.CARD_ID_163 = 163;
	window.CARD_ID_NAGUSAMERUMONO = 164;
	window.CARD_ID_165 = 165;
	window.CARD_ID_MAKENSHI_THANATOSNO_SHINENTAI = 166;
	window.CARD_ID_HILLWIND = 167;
	window.CARD_ID_RAUREL_VINDER = 168;
	window.CARD_ID_169 = 169;
	window.CARD_ID_RED_PHEROS = 170;
	window.CARD_ID_PITMAN = 171;
	window.CARD_ID_BEAR_DOLL = 172;
	window.CARD_ID_173 = 173;
	window.CARD_ID_174 = 174;
	window.CARD_ID_175 = 175;
	window.CARD_ID_176 = 176;
	window.CARD_ID_KATRINN = 177;
	window.CARD_ID_SEIREN_VIENSER_MVP = 178;
	window.CARD_ID_BLUE_OSIDOS = 179;
	window.CARD_ID_180 = 180;
	window.CARD_ID_181 = 181;
	window.CARD_ID_182 = 182;
	window.CARD_ID_183 = 183;
	window.CARD_ID_184 = 184;
	window.CARD_ID_185 = 185;
	window.CARD_ID_REMOVER = 186;
	window.CARD_ID_187 = 187;
	window.CARD_ID_ARMAIA_DUNZE = 188;
	window.CARD_ID_189 = 189;
	window.CARD_ID_190 = 190;
	window.CARD_ID_191 = 191;
	window.CARD_ID_192 = 192;
	window.CARD_ID_193 = 193;
	window.CARD_ID_194 = 194;
	window.CARD_ID_195 = 195;
	window.CARD_ID_196 = 196;
	window.CARD_ID_197 = 197;
	window.CARD_ID_198 = 198;
	window.CARD_ID_FRUS = 199;
	window.CARD_ID_200 = 200;
	window.CARD_ID_201 = 201;
	window.CARD_ID_202 = 202;
	window.CARD_ID_203 = 203;
	window.CARD_ID_204 = 204;
	window.CARD_ID_205 = 205;
	window.CARD_ID_206 = 206;
	window.CARD_ID_207 = 207;
	window.CARD_ID_208 = 208;
	window.CARD_ID_209 = 209;
	window.CARD_ID_210 = 210;
	window.CARD_ID_211 = 211;
	window.CARD_ID_212 = 212;
	window.CARD_ID_GIBBET = 213;
	window.CARD_ID_214 = 214;
	window.CARD_ID_215 = 215;
	window.CARD_ID_216 = 216;
	window.CARD_ID_217 = 217;
	window.CARD_ID_LUDE = 218;
	window.CARD_ID_LORD_OF_DEATH = 219;
	window.CARD_ID_220 = 220;
	window.CARD_ID_221 = 221;
	window.CARD_ID_ARCLOUSE = 222;
	window.CARD_ID_223 = 223;
	window.CARD_ID_224 = 224;
	window.CARD_ID_APOCALYPSE = 225;
	window.CARD_ID_226 = 226;
	window.CARD_ID_227 = 227;
	window.CARD_ID_AMON_RA = 228;
	window.CARD_ID_229 = 229;
	window.CARD_ID_230 = 230;
	window.CARD_ID_ALICE = 231;
	window.CARD_ID_ANSONI = 232;
	window.CARD_ID_233 = 233;
	window.CARD_ID_234 = 234;
	window.CARD_ID_235 = 235;
	window.CARD_ID_236 = 236;
	window.CARD_ID_237 = 237;
	window.CARD_ID_238 = 238;
	window.CARD_ID_239 = 239;
	window.CARD_ID_240 = 240;
	window.CARD_ID_EXCUTIONER = 241;
	window.CARD_ID_242 = 242;
	window.CARD_ID_ECLIPSE = 243;
	window.CARD_ID_244 = 244;
	window.CARD_ID_245 = 245;
	window.CARD_ID_246 = 246;
	window.CARD_ID_247 = 247;
	window.CARD_ID_248 = 248;
	window.CARD_ID_ORGE_TOOTH = 249;
	window.CARD_ID_ORC_ARCHER = 250;
	window.CARD_ID_251 = 251;
	window.CARD_ID_252 = 252;
	window.CARD_ID_FUR_SEAL = 253;
	window.CARD_ID_254 = 254;
	window.CARD_ID_ONRYOBUSHI = 255;
	window.CARD_ID_256 = 256;
	window.CARD_ID_257 = 257;
	window.CARD_ID_KAPPA = 258;
	window.CARD_ID_259 = 259;
	window.CARD_ID_260 = 260;
	window.CARD_ID_261 = 261;
	window.CARD_ID_262 = 262;
	window.CARD_ID_263 = 263;
	window.CARD_ID_264 = 264;
	window.CARD_ID_265 = 265;
	window.CARD_ID_266 = 266;
	window.CARD_ID_KYODAI_WHISPER = 267;
	window.CARD_ID_268 = 268;
	window.CARD_ID_269 = 269;
	window.CARD_ID_270 = 270;
	window.CARD_ID_KUMIHO = 271;
	window.CARD_ID_272 = 272;
	window.CARD_ID_273 = 273;
	window.CARD_ID_274 = 274;
	window.CARD_ID_275 = 275;
	window.CARD_ID_276 = 276;
	window.CARD_ID_GRIFFIN = 277;
	window.CARD_ID_278 = 278;
	window.CARD_ID_279 = 279;
	window.CARD_ID_280 = 280;
	window.CARD_ID_281 = 281;
	window.CARD_ID_282 = 282;
	window.CARD_ID_GOAT = 283;
	window.CARD_ID_KOKUDAO = 284;
	window.CARD_ID_285 = 285;
	window.CARD_ID_286 = 286;
	window.CARD_ID_287 = 287;
	window.CARD_ID_288 = 288;
	window.CARD_ID_289 = 289;
	window.CARD_ID_290 = 290;
	window.CARD_ID_291 = 291;
	window.CARD_ID_292 = 292;
	window.CARD_ID_293 = 293;
	window.CARD_ID_294 = 294;
	window.CARD_ID_SAMAYOU_MONO = 295;
	window.CARD_ID_296 = 296;
	window.CARD_ID_297 = 297;
	window.CARD_ID_JESTER = 298;
	window.CARD_ID_299 = 299;
	window.CARD_ID_300 = 300;
	window.CARD_ID_301 = 301;
	window.CARD_ID_302 = 302;
	window.CARD_ID_303 = 303;
	window.CARD_ID_ZYUKIHE = 304;
	window.CARD_ID_HATI_BEBE = 305;
	window.CARD_ID_306 = 306;
	window.CARD_ID_307 = 307;
	window.CARD_ID_308 = 308;
	window.CARD_ID_309 = 309;
	window.CARD_ID_STING = 310;
	window.CARD_ID_311 = 311;
	window.CARD_ID_STEM_WORM = 312;
	window.CARD_ID_STORM_KNIGHT = 313;
	window.CARD_ID_314 = 314;
	window.CARD_ID_315 = 315;
	window.CARD_ID_316 = 316;
	window.CARD_ID_317 = 317;
	window.CARD_ID_318 = 318;
	window.CARD_ID_319 = 319;
	window.CARD_ID_DARK_ILLUSION = 320;
	window.CARD_ID_321 = 321;
	window.CARD_ID_DARK_LORD = 322;
	window.CARD_ID_TURTLE_GENERAL = 323;
	window.CARD_ID_324 = 324;
	window.CARD_ID_325 = 325;
	window.CARD_ID_326 = 326;
	window.CARD_ID_CHOCO = 327;
	window.CARD_ID_MOBSTER = 328;
	window.CARD_ID_329 = 329;
	window.CARD_ID_330 = 330;
	window.CARD_ID_331 = 331;
	window.CARD_ID_PEKUSOZIN = 332;
	window.CARD_ID_333 = 333;
	window.CARD_ID_334 = 334;
	window.CARD_ID_335 = 335;
	window.CARD_ID_TENZYA_SENNIN = 336;
	window.CARD_ID_337 = 337;
	window.CARD_ID_TODO = 338;
	window.CARD_ID_339 = 339;
	window.CARD_ID_340 = 340;
	window.CARD_ID_341 = 341;
	window.CARD_ID_342 = 342;
	window.CARD_ID_343 = 343;
	window.CARD_ID_344 = 344;
	window.CARD_ID_345 = 345;
	window.CARD_ID_346 = 346;
	window.CARD_ID_347 = 347;
	window.CARD_ID_348 = 348;
	window.CARD_ID_HATI = 349;
	window.CARD_ID_350 = 350;
	window.CARD_ID_351 = 351;
	window.CARD_ID_352 = 352;
	window.CARD_ID_353 = 353;
	window.CARD_ID_HEATER = 354;
	window.CARD_ID_355 = 355;
	window.CARD_ID_356 = 356;
	window.CARD_ID_KIEL_D01 = 357;
	window.CARD_ID_358 = 358;
	window.CARD_ID_359 = 359;
	window.CARD_ID_360 = 360;
	window.CARD_ID_BLOODY_KNIGHT = 361;
	window.CARD_ID_362 = 362;
	window.CARD_ID_RANDGRIS = 363;
	window.CARD_ID_364 = 364;
	window.CARD_ID_365 = 365;
	window.CARD_ID_366 = 366;
	window.CARD_ID_367 = 367;
	window.CARD_ID_PHENOMENA = 368;
	window.CARD_ID_BOCAL = 369;
	window.CARD_ID_370 = 370;
	window.CARD_ID_371 = 371;
	window.CARD_ID_MASTERING = 372;
	window.CARD_ID_373 = 373;
	window.CARD_ID_374 = 374;
	window.CARD_ID_MISTILTINE = 375;
	window.CARD_ID_376 = 376;
	window.CARD_ID_377 = 377;
	window.CARD_ID_378 = 378;
	window.CARD_ID_379 = 379;
	window.CARD_ID_MUTANT_DRAGON = 380;
	window.CARD_ID_MEGALITH = 381;
	window.CARD_ID_382 = 382;
	window.CARD_ID_RIDEWORD = 383;
	window.CARD_ID_384 = 384;
	window.CARD_ID_WRAITH = 385;
	window.CARD_ID_RAYDRIC_ARCHER = 386;
	window.CARD_ID_387 = 387;
	window.CARD_ID_388 = 388;
	window.CARD_ID_389 = 389;
	window.CARD_ID_390 = 390;
	window.CARD_ID_WILD_ROSE = 391;
	window.CARD_ID_TAOGUNKA = 392;
	window.CARD_ID_393 = 393;
	window.CARD_ID_DEVILRING = 394;
	window.CARD_ID_395 = 395;
	window.CARD_ID_396 = 396;
	window.CARD_ID_397 = 397;
	window.CARD_ID_398 = 398;
	window.CARD_ID_399 = 399;
	window.CARD_ID_400 = 400;
	window.CARD_ID_KAVAC_ICARUS = 401;
	window.CARD_ID_CHUNGE = 402;
	window.CARD_ID_ORC_BABY = 403;
	window.CARD_ID_ELEMES_GAIL_MVP = 404;
	window.CARD_ID_ERIOT = 405;
	window.CARD_ID_406 = 406;
	window.CARD_ID_GOLD_OSIDOS = 407;
	window.CARD_ID_408 = 408;
	window.CARD_ID_LADYTANIE = 409;
	window.CARD_ID_410 = 410;
	window.CARD_ID_411 = 411;
	window.CARD_ID_VIRUS = 412;
	window.CARD_ID_413 = 413;
	window.CARD_ID_414 = 414;
	window.CARD_ID_415 = 415;
	window.CARD_ID_SIKKOSURUMONO = 416;
	window.CARD_ID_DRAGONNO_TAMAGO = 417;
	window.CARD_ID_GREEN_IGUANA = 418;
	window.CARD_ID_419 = 419;
	window.CARD_ID_RSX_0806 = 420;
	window.CARD_ID_MARGARETTE_SORIN_MVP = 421;
	window.CARD_ID_DATAL_ZAURUS = 422;
	window.CARD_ID_IGNISEM_CENIA_MVP = 423;
	window.CARD_ID_CATHERINE_KARON_MVP = 424;
	window.CARD_ID_VESPER = 425;
	window.CARD_ID_426 = 426;
	window.CARD_ID_427 = 427;
	window.CARD_ID_428 = 428;
	window.CARD_ID_429 = 429;
	window.CARD_ID_430 = 430;
	window.CARD_ID_431 = 431;
	window.CARD_ID_432 = 432;
	window.CARD_ID_433 = 433;
	window.CARD_ID_434 = 434;
	window.CARD_ID_435 = 435;
	window.CARD_ID_436 = 436;
	window.CARD_ID_437 = 437;
	window.CARD_ID_438 = 438;
	window.CARD_ID_439 = 439;
	window.CARD_ID_440 = 440;
	window.CARD_ID_441 = 441;
	window.CARD_ID_442 = 442;
	window.CARD_ID_443 = 443;
	window.CARD_ID_444 = 444;
	window.CARD_ID_445 = 445;
	window.CARD_ID_446 = 446;
	window.CARD_ID_447 = 447;
	window.CARD_ID_448 = 448;
	window.CARD_ID_449 = 449;
	window.CARD_ID_450 = 450;
	window.CARD_ID_451 = 451;
	window.CARD_SET_ID_JOBSET_ACOLYTE = 452;
	window.CARD_SET_ID_JOBSET_ARCHER = 453;
	window.CARD_SET_ID_JOBSET_MAGICIAN = 454;
	window.CARD_ID_455 = 455;
	window.CARD_SET_ID_JOBSET_CRUSADER = 456;
	window.CARD_ID_457 = 457;
	window.CARD_ID_458 = 458;
	window.CARD_ID_459 = 459;
	window.CARD_SET_ID_JOBSET_SAGE = 460;
	window.CARD_ID_461 = 461;
	window.CARD_ID_462 = 462;
	window.CARD_ID_ATLOS = 463;
	window.CARD_ID_SWORD_GUARDIAN = 464;
	window.CARD_ID_BOW_GUARDIAN = 465;
	window.CARD_ID_466 = 466;
	window.CARD_ID_467 = 467;
	window.CARD_ID_468 = 468;
	window.CARD_ID_469 = 469;
	window.CARD_ID_470 = 470;
	window.CARD_ID_471 = 471;
	window.CARD_ID_472 = 472;
	window.CARD_ID_473 = 473;
	window.CARD_ID_BANSHEE = 474;
	window.CARD_ID_GROOM_UNDERNIGHT = 475;
	window.CARD_ID_AGAVE = 476;
	window.CARD_ID_EKIO = 477;
	window.CARD_ID_KTULLANUX = 478;
	window.CARD_ID_479 = 479;
	window.CARD_ID_480 = 480;
	window.CARD_ID_481 = 481;
	window.CARD_ID_482 = 482;
	window.CARD_ID_483 = 483;
	window.CARD_ID_484 = 484;
	window.CARD_ID_485 = 485;
	window.CARD_ID_OCHITA_DAISHINKAN_HIBAMU = 486;
	window.CARD_ID_487 = 487;
	window.CARD_ID_SIROMA = 488;
	window.CARD_ID_489 = 489;
	window.CARD_ID_490 = 490;
	window.CARD_ID_491 = 491;
	window.CARD_ID_EFREET = 492;
	window.CARD_ID_IMP = 493;
	window.CARD_ID_494 = 494;
	window.CARD_ID_495 = 495;
	window.CARD_ID_496 = 496;
	window.CARD_ID_497 = 497;
	window.CARD_ID_498 = 498;
	window.CARD_ID_499 = 499;
	window.CARD_ID_ENTVAIEN = 500;
	window.CARD_ID_501 = 501;
	window.CARD_ID_502 = 502;
	window.CARD_ID_503 = 503;
	window.CARD_ID_504 = 504;
	window.CARD_ID_505 = 505;
	window.CARD_ID_506 = 506;
	window.CARD_ID_507 = 507;
	window.CARD_ID_ENCHANT_ATK_2 = 508;
	window.CARD_ID_ENCHANT_ATK_3 = 509;
	window.CARD_ID_ENCHANT_CRI_5 = 510;
	window.CARD_ID_ENCHANT_CRI_7 = 511;
	window.CARD_ID_ENCHANT_FLEE_6 = 512;
	window.CARD_ID_ENCHANT_FLEE_12 = 513;
	window.CARD_ID_ENCHANT_MATK_1_CAST_FIXED_1 = 514;
	window.CARD_ID_ENCHANT_MATK_2_CAST_FIXED_1 = 515;
	window.CARD_ID_ENCHANT_AGI_1 = 516;
	window.CARD_ID_ENCHANT_AGI_2 = 517;
	window.CARD_ID_ENCHANT_AGI_3 = 518;
	window.CARD_ID_ENCHANT_INT_1 = 519;
	window.CARD_ID_ENCHANT_INT_2 = 520;
	window.CARD_ID_ENCHANT_INT_3 = 521;
	window.CARD_ID_ENCHANT_DEX_1 = 522;
	window.CARD_ID_ENCHANT_DEX_2 = 523;
	window.CARD_ID_ENCHANT_DEX_3 = 524;
	window.CARD_ID_525 = 525;
	window.CARD_ID_526 = 526;
	window.CARD_ID_MAGICAL_RACE_ALL_10UP = 527;
	window.CARD_ID_TENDORIRURION = 528;
	window.CARD_ID_529 = 529;
	window.CARD_ID_530 = 530;
	window.CARD_ID_531 = 531;
	window.CARD_ID_532 = 532;
	window.CARD_ID_533 = 533;
	window.CARD_ID_534 = 534;
	window.CARD_ID_535 = 535;
	window.CARD_ID_536 = 536;
	window.CARD_ID_537 = 537;
	window.CARD_ID_538 = 538;
	window.CARD_ID_539 = 539;
	window.CARD_ID_540 = 540;
	window.CARD_ID_NYDHOGNO_KAGE = 541;
	window.CARD_ID_NAHT_ZEEGAR = 542;
	window.CARD_ID_543 = 543;
	window.CARD_ID_544 = 544;
	window.CARD_ID_545 = 545;
	window.CARD_ID_546 = 546;
	window.CARD_ID_547 = 547;
	window.CARD_ID_548 = 548;
	window.CARD_ID_549 = 549;
	window.CARD_ID_550 = 550;
	window.CARD_ID_551 = 551;
	window.CARD_ID_552 = 552;
	window.CARD_ID_553 = 553;
	window.CARD_ID_ENCHANT_STR_1 = 554;
	window.CARD_ID_ENCHANT_STR_2 = 555;
	window.CARD_ID_ENCHANT_STR_3 = 556;
	window.CARD_ID_ENCHANT_STR_4 = 557;
	window.CARD_ID_ENCHANT_STR_5 = 558;
	window.CARD_ID_ENCHANT_AGI_4 = 559;
	window.CARD_ID_ENCHANT_AGI_5 = 560;
	window.CARD_ID_ENCHANT_VIT_1 = 561;
	window.CARD_ID_ENCHANT_VIT_2 = 562;
	window.CARD_ID_ENCHANT_VIT_3 = 563;
	window.CARD_ID_ENCHANT_VIT_4 = 564;
	window.CARD_ID_ENCHANT_VIT_5 = 565;
	window.CARD_ID_ENCHANT_INT_4 = 566;
	window.CARD_ID_ENCHANT_INT_5 = 567;
	window.CARD_ID_ENCHANT_DEX_4 = 568;
	window.CARD_ID_ENCHANT_DEX_5 = 569;
	window.CARD_ID_ENCHANT_LUK_1 = 570;
	window.CARD_ID_ENCHANT_LUK_2 = 571;
	window.CARD_ID_ENCHANT_LUK_3 = 572;
	window.CARD_ID_ENCHANT_LUK_4 = 573;
	window.CARD_ID_ENCHANT_LUK_5 = 574;
	window.CARD_ID_ENCHANT_MAXHP_100 = 575;
	window.CARD_ID_ENCHANT_MAXHP_200 = 576;
	window.CARD_ID_ENCHANT_MAXHP_300 = 577;
	window.CARD_ID_ENCHANT_MAXHP_400 = 578;
	window.CARD_ID_ENCHANT_MAXSP_50 = 579;
	window.CARD_ID_ENCHANT_MAXSP_100 = 580;
	window.CARD_ID_ENCHANT_DEF_3 = 581;
	window.CARD_ID_ENCHANT_DEF_6 = 582;
	window.CARD_ID_ENCHANT_DEF_9 = 583;
	window.CARD_ID_ENCHANT_MDEF_2 = 584;
	window.CARD_ID_ENCHANT_MDEF_4 = 585;
	window.CARD_ID_ENCHANT_MDEF_6 = 586;
	window.CARD_ID_ENCHANT_MDEF_8 = 587;
	window.CARD_ID_ENCHANT_MATK_3_CAST_FIXED_1 = 588;
	window.CARD_ID_ENCHANT_MATK_2_CAST_FIXED_1_BUG = 589;
	window.CARD_ID_ENCHANT_DEF_12 = 590;
	window.CARD_ID_ENCHANT_TOSHI_1 = 591;
	window.CARD_ID_ENCHANT_TOSHI_2 = 592;
	window.CARD_ID_ENCHANT_TOSHI_3 = 593;
	window.CARD_ID_ENCHANT_TOSHI_4 = 594;
	window.CARD_ID_ENCHANT_MAXHP_1P = 595;
	window.CARD_ID_ENCHANT_MAXHP_2P = 596;
	window.CARD_ID_ENCHANT_FLEE_1 = 597;
	window.CARD_ID_ENCHANT_FLEE_3 = 598;
	window.CARD_ID_ENCHANT_SPECIAL_AGI = 599;
	window.CARD_ID_ENCHANT_ASPD_1 = 600;
	window.CARD_ID_ENCHANT_MARYOKU_1 = 601;
	window.CARD_ID_ENCHANT_MARYOKU_2 = 602;
	window.CARD_ID_ENCHANT_MARYOKU_3 = 603;
	window.CARD_ID_ENCHANT_MARYOKU_4 = 604;
	window.CARD_ID_ENCHANT_MEIKYU_1 = 605;
	window.CARD_ID_ENCHANT_MEIKYU_2 = 606;
	window.CARD_ID_ENCHANT_SENEI_1 = 607;
	window.CARD_ID_ENCHANT_SENEI_2 = 608;
	window.CARD_ID_ENCHANT_DAISHIKYO_1 = 609;
	window.CARD_ID_ENCHANT_DAISHIKYO_2 = 610;
	window.CARD_ID_ENCHANT_CHIYU_1 = 611;
	window.CARD_ID_ENCHANT_DAISEIDO_1 = 612;
	window.CARD_ID_613 = 613;
	window.CARD_ID_ZYOO_SUCARAB = 614;
	window.CARD_ID_615 = 615;
	window.CARD_ID_616 = 616;
	window.CARD_ID_617 = 617;
	window.CARD_ID_618 = 618;
	window.CARD_ID_619 = 619;
	window.CARD_ID_620 = 620;
	window.CARD_ID_621 = 621;
	window.CARD_ID_622 = 622;
	window.CARD_ID_623 = 623;
	window.CARD_ID_624 = 624;
	window.CARD_ID_625 = 625;
	window.CARD_ID_ZYOTE_SUCARAB = 626;
	window.CARD_ID_ARNORDY = 627;
	window.CARD_ID_628 = 628;
	window.CARD_ID_629 = 629;
	window.CARD_ID_REYAC = 630;
	window.CARD_ID_KRAKEN = 631;
	window.CARD_ID_632 = 632;
	window.CARD_ID_633 = 633;
	window.CARD_ID_634 = 634;
	window.CARD_ID_635 = 635;
	window.CARD_ID_TORYO_TAKO = 636;
	window.CARD_ID_637 = 637;
	window.CARD_ID_638 = 638;
	window.CARD_ID_ENCHANT_MDEF_10 = 639;
	window.CARD_ID_ENCHANT_SENEI_3 = 640;
	window.CARD_ID_ENCHANT_MEIKYU_3 = 641;
	window.CARD_ID_ENCHANT_MAXSP_25 = 642;
	window.CARD_ID_ENCHANT_MAXSP_75 = 643;
	window.CARD_ID_ENCHANT_MAXHP_3P = 644;
	window.CARD_ID_ENCHANT_ATK_1 = 645;
	window.CARD_ID_ENCHANT_TOSHI_6 = 646;
	window.CARD_ID_ENCHANT_TOSHI_7 = 647;
	window.CARD_ID_ENCHANT_KOGEKISOKUDO_3 = 648;
	window.CARD_ID_ENCHANT_KOGEKISOKUDO_4 = 649;
	window.CARD_ID_ENCHANT_MEIKYU_4 = 650;
	window.CARD_ID_ENCHANT_LUK_6 = 651;
	window.CARD_ID_ENCHANT_KUMANO_CHIKARA_OLD = 652;
	window.CARD_ID_ENCHANT_KOSOKU_OLD = 653;
	window.CARD_ID_ENCHANT_KOGAI_OLD = 654;
	window.CARD_ID_ENCHANT_BOSOSHITA_MARYOKU_OLD = 655;
	window.CARD_ID_ENCHANT_OWASHINO_GANKO_OLD = 656;
	window.CARD_ID_ENCHANT_KOUUNNA_HI_OLD = 657;
	window.CARD_ID_658 = 658;
	window.CARD_ID_ENCHANT_SPECIAL_STR = 659;
	window.CARD_ID_ENCHANT_SPECIAL_VIT = 660;
	window.CARD_ID_ENCHANT_SPECIAL_INT = 661;
	window.CARD_ID_ENCHANT_SPECIAL_DEX = 662;
	window.CARD_ID_ENCHANT_SPECIAL_LUK = 663;
	window.CARD_ID_ENCHANT_STR_6 = 664;
	window.CARD_ID_ENCHANT_STR_7 = 665;
	window.CARD_ID_ENCHANT_STR_8 = 666;
	window.CARD_ID_ENCHANT_STR_9 = 667;
	window.CARD_ID_ENCHANT_STR_10 = 668;
	window.CARD_ID_ENCHANT_AGI_6 = 669;
	window.CARD_ID_ENCHANT_AGI_7 = 670;
	window.CARD_ID_ENCHANT_AGI_8 = 671;
	window.CARD_ID_ENCHANT_AGI_9 = 672;
	window.CARD_ID_ENCHANT_AGI_10 = 673;
	window.CARD_ID_ENCHANT_VIT_6 = 674;
	window.CARD_ID_ENCHANT_VIT_7 = 675;
	window.CARD_ID_ENCHANT_VIT_8 = 676;
	window.CARD_ID_ENCHANT_VIT_9 = 677;
	window.CARD_ID_ENCHANT_VIT_10 = 678;
	window.CARD_ID_ENCHANT_INT_6 = 679;
	window.CARD_ID_ENCHANT_INT_7 = 680;
	window.CARD_ID_ENCHANT_INT_8 = 681;
	window.CARD_ID_ENCHANT_INT_9 = 682;
	window.CARD_ID_ENCHANT_INT_10 = 683;
	window.CARD_ID_ENCHANT_DEX_6 = 684;
	window.CARD_ID_ENCHANT_DEX_7 = 685;
	window.CARD_ID_ENCHANT_DEX_8 = 686;
	window.CARD_ID_ENCHANT_DEX_9 = 687;
	window.CARD_ID_ENCHANT_DEX_10 = 688;
	window.CARD_ID_ENCHANT_LUK_7 = 689;
	window.CARD_ID_ENCHANT_LUK_8 = 690;
	window.CARD_ID_ENCHANT_LUK_9 = 691;
	window.CARD_ID_ENCHANT_LUK_10 = 692;
	window.CARD_ID_ENCHANT_TOSHI_5 = 693;
	window.CARD_ID_ENCHANT_TOSHI_8 = 694;
	window.CARD_ID_ENCHANT_TOSHI_9 = 695;
	window.CARD_ID_ENCHANT_TOSHI_10 = 696;
	window.CARD_ID_ENCHANT_SENEI_4 = 697;
	window.CARD_ID_ENCHANT_SENEI_5 = 698;
	window.CARD_ID_ENCHANT_KOGEKISOKUDO_1 = 699;
	window.CARD_ID_ENCHANT_KOGEKISOKUDO_2 = 700;
	window.CARD_ID_ENCHANT_MARYOKU_5 = 701;
	window.CARD_ID_ENCHANT_MARYOKU_6 = 702;
	window.CARD_ID_ENCHANT_MARYOKU_7 = 703;
	window.CARD_ID_ENCHANT_MARYOKU_8 = 704;
	window.CARD_ID_ENCHANT_MARYOKU_9 = 705;
	window.CARD_ID_ARFOSIO_BASIL_MVP = 706;
	window.CARD_ID_EMUR_PURAMEL_MVP = 707;
	window.CARD_ID_GERTIE_UH_MVP = 708;
	window.CARD_ID_CERIA_ARDE_MVP = 709;
	window.CARD_ID_CHENG_RIU_MVP = 710;
	window.CARD_ID_TRENTINI_MVP = 711;
	window.CARD_ID_RANDEL_RORENCE_MVP = 712;
	window.CARD_ID_ALFOSIO_BASIL = 713;
	window.CARD_ID_714 = 714;
	window.CARD_ID_715 = 715;
	window.CARD_ID_716 = 716;
	window.CARD_ID_717 = 717;
	window.CARD_ID_TRENTINI = 718;
	window.CARD_ID_719 = 719;
	window.CARD_ID_720 = 720;
	window.CARD_ID_BAKONAWA = 721;
	window.CARD_ID_BYONGUNGO = 722;
	window.CARD_ID_BUWAYA = 723;
	window.CARD_ID_724 = 724;
	window.CARD_ID_JEJERIN = 725;
	window.CARD_ID_WAKUWAKU = 726;
	window.CARD_ID_727 = 727;
	window.CARD_ID_BUGISGIS = 728;
	window.CARD_ID_729 = 729;
	window.CARD_ID_SASOINO_MAGAN = 730;
	window.CARD_ID_AMDARAIS = 731;
	window.CARD_ID_732 = 732;
	window.CARD_ID_733 = 733;
	window.CARD_ID_734 = 734;
	window.CARD_ID_LICHT_HERRSCHER = 735;
	window.CARD_ID_KISONSARETA_KOSHO = 736;
	window.CARD_ID_737 = 737;
	window.CARD_ID_738 = 738;
	window.CARD_ID_MENBRITZ = 739;
	window.CARD_ID_740 = 740;
	window.CARD_ID_VASER_RIHITERN = 741;
	window.CARD_ID_FELUS_RIHITERN = 742;
	window.CARD_ID_FUNKE_RIHITERN = 743;
	window.CARD_ID_GERVE_RIHITERN = 748;
	window.CARD_ID_744 = 744;
	window.CARD_ID_745 = 745;
	window.CARD_ID_746 = 746;
	window.CARD_ID_747 = 747;
	window.CARD_ID_749 = 749;
	window.CARD_ID_FENRIR = 750;
	window.CARD_ID_751 = 751;
	window.CARD_ID_ENCHANT_MAXSP_150 = 752;
	window.CARD_ID_ENCHANT_MAXHP_4P = 753;
	window.CARD_ID_ENCHANT_MIZU_DROP_1 = 754;
	window.CARD_ID_ENCHANT_MIZU_DROP_2 = 755;
	window.CARD_ID_ENCHANT_MIZU_DROP_3 = 756;
	window.CARD_ID_ENCHANT_MIZU_DROP_4 = 757;
	window.CARD_ID_ENCHANT_KI_DROP_1 = 758;
	window.CARD_ID_ENCHANT_KI_DROP_2 = 759;
	window.CARD_ID_ENCHANT_KI_DROP_3 = 760;
	window.CARD_ID_ENCHANT_KI_DROP_4 = 761;
	window.CARD_ID_ENCHANT_HI_DROP_1 = 762;
	window.CARD_ID_ENCHANT_HI_DROP_2 = 763;
	window.CARD_ID_ENCHANT_HI_DROP_3 = 764;
	window.CARD_ID_ENCHANT_HI_DROP_4 = 765;
	window.CARD_ID_ENCHANT_HIKARI_DROP_1 = 766;
	window.CARD_ID_ENCHANT_HIKARI_DROP_2 = 767;
	window.CARD_ID_ENCHANT_HIKARI_DROP_3 = 768;
	window.CARD_ID_ENCHANT_HIKARI_DROP_4 = 769;
	window.CARD_ID_ENCHANT_YAMI_DROP_1 = 770;
	window.CARD_ID_ENCHANT_YAMI_DROP_2 = 771;
	window.CARD_ID_ENCHANT_YAMI_DROP_3 = 772;
	window.CARD_ID_ENCHANT_YAMI_DROP_4 = 773;
	window.CARD_ID_ENCHANT_KAIFUKU_DROP_1 = 774;
	window.CARD_ID_ENCHANT_KAIFUKU_DROP_2 = 775;
	window.CARD_ID_ENCHANT_KAIFUKU_DROP_3 = 776;
	window.CARD_ID_ENCHANT_KAIFUKU_DROP_4 = 777;
	window.CARD_ID_TIME_HOLDER = 778;
	window.CARD_ID_779 = 779;
	window.CARD_ID_780 = 780;
	window.CARD_ID_781 = 781;
	window.CARD_ID_782 = 782;
	window.CARD_ID_783 = 783;
	window.CARD_ID_784 = 784;
	window.CARD_ID_785 = 785;
	window.CARD_ID_786 = 786;
	window.CARD_ID_787 = 787;
	window.CARD_ID_788 = 788;
	window.CARD_ID_789 = 789;
	window.CARD_ID_ENCHANT_ATK_4 = 790;
	window.CARD_ID_ENCHANT_ATK_5 = 791;
	window.CARD_ID_ENCHANT_MATK_4 = 792;
	window.CARD_ID_ENCHANT_MATK_5 = 793;
	window.CARD_ID_ENCHANT_MAXHP_5P = 794;
	window.CARD_ID_ENCHANT_DEF_15 = 795;
	window.CARD_ID_ENCHANT_MDEF_1 = 796;
	window.CARD_ID_ENCHANT_MDEF_3 = 797;
	window.CARD_ID_ENCHANT_MDEF_5 = 798;
	window.CARD_ID_799 = 799;
	window.CARD_ID_MAZINNO_WANRYOKU_1 = 800;
	window.CARD_ID_MAZINNO_WANRYOKU_2 = 801;
	window.CARD_ID_MAZINNO_WANRYOKU_3 = 802;
	window.CARD_ID_MAZINNO_ZINSOKU_1 = 803;
	window.CARD_ID_MAZINNO_ZINSOKU_2 = 804;
	window.CARD_ID_MAZINNO_ZINSOKU_3 = 805;
	window.CARD_ID_MAZINNO_TAIRYOKU_1 = 806;
	window.CARD_ID_MAZINNO_TAIRYOKU_2 = 807;
	window.CARD_ID_MAZINNO_TAIRYOKU_3 = 808;
	window.CARD_ID_MAZINNO_CHIRYOKU_1 = 809;
	window.CARD_ID_MAZINNO_CHIRYOKU_2 = 810;
	window.CARD_ID_MAZINNO_CHIRYOKU_3 = 811;
	window.CARD_ID_MAZINNO_SHUCHU_1 = 812;
	window.CARD_ID_MAZINNO_SHUCHU_2 = 813;
	window.CARD_ID_MAZINNO_SHUCHU_3 = 814;
	window.CARD_ID_MAZINNO_KOUN_1 = 815;
	window.CARD_ID_MAZINNO_KOUN_2 = 816;
	window.CARD_ID_MAZINNO_KOUN_3 = 817;
	window.CARD_ID_ENCHANT_MATK_1 = 818;
	window.CARD_ID_ENCHANT_MATK_2 = 819;
	window.CARD_ID_ENCHANT_MATK_3 = 820;
	window.CARD_ID_ENCHANT_HAKUYOKYU = 821;
	window.CARD_ID_ENCHANT_KINGYUKYU = 822;
	window.CARD_ID_ENCHANT_SOUZIKYU = 823;
	window.CARD_ID_ENCHANT_KYOKAIKYU = 824;
	window.CARD_ID_ENCHANT_SHISHIKYU = 825;
	window.CARD_ID_ENCHANT_SHOZYOKYU = 826;
	window.CARD_ID_ENCHANT_TENBINKYU = 827;
	window.CARD_ID_ENCHANT_TENKAIKYU = 828;
	window.CARD_ID_ENCHANT_ZINBAKYU = 829;
	window.CARD_ID_ENCHANT_MAKATSUKYU = 830;
	window.CARD_ID_ENCHANT_HOUHEIKYU = 831;
	window.CARD_ID_ENCHANT_SOUGYOKYU = 832;
	window.CARD_ID_ENCHANT_FAMITSUNO_CHIKARA = 833;
	window.CARD_ID_834 = 834;
	window.CARD_ID_835 = 835;
	window.CARD_ID_836 = 836;
	window.CARD_ID_837 = 837;
	window.CARD_ID_838 = 838;
	window.CARD_ID_839 = 839;
	window.CARD_ID_840 = 840;
	window.CARD_ID_841 = 841;
	window.CARD_ID_842 = 842;
	window.CARD_ID_843 = 843;
	window.CARD_ID_844 = 844;
	window.CARD_ID_845 = 845;
	window.CARD_ID_846 = 846;
	window.CARD_ID_847 = 847;
	window.CARD_ID_848 = 848;
	window.CARD_ID_849 = 849;
	window.CARD_ID_850 = 850;
	window.CARD_ID_851 = 851;
	window.CARD_ID_852 = 852;
	window.CARD_ID_853 = 853;
	window.CARD_ID_854 = 854;
	window.CARD_ID_ENCHANT_HILEVEL = 855;
	window.CARD_ID_ENCHANT_E_FIRE = 856;
	window.CARD_ID_ENCHANT_E_WATER = 857;
	window.CARD_ID_ENCHANT_E_GROUND = 858;
	window.CARD_ID_ENCHANT_E_WIND = 859;
	window.CARD_ID_ENCHANT_R_FIRE = 860;
	window.CARD_ID_ENCHANT_R_WATER = 861;
	window.CARD_ID_ENCHANT_R_GROUND = 862;
	window.CARD_ID_ENCHANT_R_WIND = 863;
	window.CARD_ID_ENCHANT_C_LIFE = 864;
	window.CARD_ID_ENCHANT_C_SOUL = 865;
	window.CARD_ID_ENCHANT_C_HPR = 866;
	window.CARD_ID_ENCHANT_C_SPR = 867;
	window.CARD_ID_ENCHANT_A_STR = 868;
	window.CARD_ID_ENCHANT_A_INT = 869;
	window.CARD_ID_ENCHANT_A_DEF = 870;
	window.CARD_ID_ENCHANT_A_AVOID = 871;
	window.CARD_ID_ENCHANT_A_ATK = 872;
	window.CARD_ID_ENCHANT_A_MATK = 873;
	window.CARD_ID_ENCHANT_A_MAXHP = 874;
	window.CARD_ID_ENCHANT_A_MAXSP = 875;
	window.CARD_ID_ENCHANT_A_FROZEN = 876;
	window.CARD_ID_ENCHANT_A_ASPD = 877;
	window.CARD_ID_878 = 878;
	window.CARD_ID_879 = 879;
	window.CARD_ID_880 = 880;
	window.CARD_ID_881 = 881;
	window.CARD_ID_882 = 882;
	window.CARD_ID_883 = 883;
	window.CARD_ID_884 = 884;
	window.CARD_ID_885 = 885;
	window.CARD_ID_886 = 886;
	window.CARD_ID_AMENHOTEP = 887;
	window.CARD_ID_ENCHANT_BOSOSHITA_MARYOKU = 888;
	window.CARD_ID_889 = 889;
	window.CARD_ID_890 = 890;
	window.CARD_ID_IKEINO_COELACANTH = 891;
	window.CARD_ID_ANKOKUNO_COELACANTH = 892;
	window.CARD_ID_HENINO_COELACANTH = 893;
	window.CARD_ID_BOGYAKUNO_COELACANTH = 894;
	window.CARD_SET_ID_OCHITA_DAISHINKAN_HIBAM_ENCHANT_BOSOSHITA_MARYOKU = 895;
	window.CARD_ID_LOVA_BAHAMUT = 896;
	window.CARD_ID_LOVA_SHINKA_BAHAMUT = 897;
	window.CARD_ID_LOVA_RAGNAROK = 898;
	window.CARD_ID_LOVA_SHINKA_RAGNAROK = 899;
	window.CARD_ID_LOVA_RURU = 900;
	window.CARD_ID_LOVA_SHINKA_RURU = 901;
	window.CARD_ID_LOVA_KIMA = 902;
	window.CARD_ID_LOVA_SHINKA_KIMA = 903;
	window.CARD_ID_LOVA_HADES = 904;
	window.CARD_ID_LOVA_SHINKA_HADES = 905;
	window.CARD_ID_ENCHANT_GUREN = 906;
	window.CARD_ID_ENCHANT_SHINCHU = 907;
	window.CARD_ID_ENCHANT_HAKUGIN = 908;
	window.CARD_ID_ENCHANT_TASOGARE = 909;
	window.CARD_ID_ENCHANT_KONTON = 910;
	window.CARD_ID_ENCHANT_SHOKO = 911;
	window.CARD_ID_ENCHANT_KAIFUKU = 912;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV10 = 913;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV8_9 = 914;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV6_7 = 915;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV4_5 = 916;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV2_3 = 917;
	window.CARD_ID_LEARNING_SLIM_POTION_PITCHER_LV0_1 = 918;
	window.CARD_ID_LEARNING_CROSS_IMPACT_LV5 = 919;
	window.CARD_ID_LEARNING_CROSS_IMPACT_LV0_4 = 920;
	window.CARD_ID_LEARNING_GRIM_TOOTH_LV5 = 921;
	window.CARD_ID_LEARNING_GRIM_TOOTH_LV0_4 = 922;
	window.CARD_ID_LEARNING_SOUL_BREAKER_LV10 = 923;
	window.CARD_ID_LEARNING_SOUL_BREAKER_LV0_9 = 924;
	window.CARD_ID_KAIKINA_SOSHOKU_TREE = 925;
	window.CARD_SET_ID_KAIKINA_SOSHOKU_TREE_BEAR_DOLL = 926;
	window.CARD_ID_KOZYOKEIBIINNO_TAMASHI = 927;
	window.CARD_SET_ID_KOZYOKEIBIINNO_TAMASHI_AKAI_LANTHANUM = 928;
	window.CARD_SET_ID_KOZYOKEIBIINNO_TAMASHI_PRESENTGA_NAI_YUREI = 929;
	window.CARD_ID_SUTERARETA_KUMANINGYO = 930;
	window.CARD_SET_ID_SUTERARETA_KUMANINGYO_BEAR_DOLL = 931;
	window.CARD_ID_PRESENTGA_NAI_YUREI = 932;
	window.CARD_ID_HOSOSARENAKATTA_NINGYO = 933;
	window.CARD_ID_HOSOSARETA_BOX = 934;
	window.CARD_ID_PRESENT_HOSOTANTOSHA = 935;
	window.CARD_ID_CELINE_KIMI = 936;
	window.CARD_SET_ID_CELINE_KIMI_AKURYONO_ITONO_TEBUKURO = 937;
	window.CARD_SET_ID_CELINE_KIMI_CELINENO_RIBBON = 938;
	window.CARD_SET_ID_CELINE_KIMI_NOBLE_CROSS = 939;
	window.CARD_ID_ENCHANT_A_TOLERANCE = 940;
	window.CARD_ID_ENCHANT_A_HIT = 941;
	window.CARD_ID_ENCHANT_A_FLEE = 942;
	window.CARD_ID_ENCHANT_A_MDEF = 943;
	window.CARD_ID_ENCHANT_S_ATK = 944;
	window.CARD_ID_ENCHANT_S_MATK = 945;
	window.CARD_ID_ENCHANT_S_AVOID = 946;
	window.CARD_ID_ENCHANT_S_MAXHP = 947;
	window.CARD_ID_ENCHANT_S_QUICK = 948;
	window.CARD_ID_ENCHANT_S_CRI = 949;
	window.CARD_ID_LEARNING_WATER_BALL_LV5 = 950;
	window.CARD_ID_LEARNING_WATER_BALL_LV4 = 951;
	window.CARD_ID_LEARNING_WATER_BALL_LV3 = 952;
	window.CARD_ID_LEARNING_WATER_BALL_LV2 = 953;
	window.CARD_ID_LEARNING_WATER_BALL_LV1 = 954;
	window.CARD_ID_LEARNING_WATER_BALL_LV0 = 955;
	window.CARD_ID_LEARNING_FROST_NOVA_LV10 = 956;
	window.CARD_ID_LEARNING_FROST_NOVA_LV9 = 957;
	window.CARD_ID_LEARNING_FROST_NOVA_LV8 = 958;
	window.CARD_ID_LEARNING_FROST_NOVA_LV7 = 959;
	window.CARD_ID_LEARNING_FROST_NOVA_LV6 = 960;
	window.CARD_ID_LEARNING_FROST_NOVA_LV5 = 961;
	window.CARD_ID_LEARNING_FROST_NOVA_LV4 = 962;
	window.CARD_ID_LEARNING_FROST_NOVA_LV3 = 963;
	window.CARD_ID_LEARNING_FROST_NOVA_LV2 = 964;
	window.CARD_ID_LEARNING_FROST_NOVA_LV1 = 965;
	window.CARD_ID_LEARNING_FROST_NOVA_LV0 = 966;
	window.CARD_ID_LEARNING_AIMED_BOLT_LV10 = 967;
	window.CARD_ID_LEARNING_AIMED_BOLT_LV0_9 = 968;
	window.CARD_ID_LEARNING_SHARP_SHOOTING_LV5 = 969;
	window.CARD_ID_LEARNING_SHARP_SHOOTING_LV0_4 = 970;
	window.CARD_ID_LEARNING_BLITZ_BEAT_LV5 = 971;
	window.CARD_ID_LEARNING_BLITZ_BEAT_LV0_4 = 972;
	window.CARD_ID_ENCHANT_EIRI_1 = 973;
	window.CARD_ID_ENCHANT_EIRI_2 = 974;
	window.CARD_ID_ENCHANT_EIRI_3 = 975;
	window.CARD_ID_ENCHANT_EIRI_4 = 976;
	window.CARD_ID_ENCHANT_MAXHP_500 = 977;
	window.CARD_ID_ENCHANT_COST_DOWN_2 = 978;
	window.CARD_ID_ENCHANT_COST_DOWN_4 = 979;
	window.CARD_ID_ENCHANT_COST_DOWN_6 = 980;
	window.CARD_ID_ENCHANT_COST_DOWN_8 = 981;
	window.CARD_ID_ENCHANT_COST_DOWN_10 = 982;
	window.CARD_ID_ENCHANT_DELAY_DOWN_2 = 983;
	window.CARD_ID_ENCHANT_DELAY_DOWN_4 = 984;
	window.CARD_ID_ENCHANT_DELAY_DOWN_6 = 985;
	window.CARD_ID_ENCHANT_DELAY_DOWN_8 = 986;
	window.CARD_ID_ENCHANT_DELAY_DOWN_10 = 987;
	window.CARD_ID_ENCHANT_LUCKY_1 = 988;
	window.CARD_ID_ENCHANT_LUCKY_2 = 989;
	window.CARD_ID_ENCHANT_LUCKY_3 = 990;
	window.CARD_ID_ENCHANT_LUCKY_4 = 991;
	window.CARD_ID_ENCHANT_LUCKY_5 = 992;
	window.CARD_ID_ENCHANT_MUZOKUSEI_TAISEI_1 = 993;
	window.CARD_ID_ENCHANT_MUZOKUSEI_TAISEI_2 = 994;
	window.CARD_ID_ENCHANT_MUZOKUSEI_TAISEI_3 = 995;
	window.CARD_ID_ENCHANT_MUZOKUSEI_TAISEI_4 = 996;
	window.CARD_ID_ENCHANT_MUZOKUSEI_TAISEI_5 = 997;
	window.CARD_ID_ENCHANT_YUSHANO_IKARI = 998;
	window.CARD_ID_ENCHANT_MAHITSUZINO_HOKO = 999;
	window.CARD_ID_ENCHANT_ENERGY_SHUGORYU = 1000;
	window.CARD_ID_ENCHANT_ENERGY_IKUSAOTOME = 1001;
	window.CARD_ID_ENCHANT_ENERGY_REPPU = 1002;
	window.CARD_ID_ENCHANT_RYUBIRYUNO_GENZYU = 1003;
	window.CARD_ID_ENCHANT_MANPASHIKUZYOKUNO_GENZYU = 1004;
	window.CARD_ID_ENCHANT_UCHUKONGEN_GENZYU = 1005;
	window.CARD_ID_ENCHANT_SHIPPU = 1006;
	window.CARD_ID_ENCHANT_TENCHI = 1007;
	window.CARD_ID_SOHION = 1008;
	window.CARD_ID_ELVIRA = 1009;
	window.CARD_ID_LOLA = 1010;
	window.CARD_ID_RUDO = 1011;
	window.CARD_ID_SHOGUN_DAEHYON = 1012;
	window.CARD_ID_MUZIHINA_GIOIA = 1013;
	window.CARD_ID_KYOSHINZYA_PYURIEL = 1014;
	window.CARD_ID_MOZYANO_SHUGOSHA_KADES = 1015;
	window.CARD_ID_HASHANO_SHINEN = 1016;
	window.CARD_ID_LEARNING_ORATIO_LV10 = 1017;
	window.CARD_ID_LEARNING_ORATIO_LV9 = 1018;
	window.CARD_ID_LEARNING_ORATIO_LV8 = 1019;
	window.CARD_ID_LEARNING_ORATIO_LV7 = 1020;
	window.CARD_ID_LEARNING_ORATIO_LV6 = 1021;
	window.CARD_ID_LEARNING_ORATIO_LV5 = 1022;
	window.CARD_ID_LEARNING_ORATIO_LV4 = 1023;
	window.CARD_ID_LEARNING_ORATIO_LV3 = 1024;
	window.CARD_ID_LEARNING_ORATIO_LV2 = 1025;
	window.CARD_ID_LEARNING_ORATIO_LV1 = 1026;
	window.CARD_ID_LEARNING_ORATIO_LV0 = 1027;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV13 = 1028;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV12 = 1029;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV11 = 1030;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV10 = 1031;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV9 = 1032;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV8 = 1033;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV7 = 1034;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV6 = 1035;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV5 = 1036;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV4 = 1037;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV3 = 1038;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV2 = 1039;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV1 = 1040;
	window.CARD_ID_LEARNING_RAUDA_ETC_LV0 = 1041;
	window.CARD_ID_ENCHANT_FLOOD = 1042;
	window.CARD_ID_ENCHANT_CRAY = 1043;
	window.CARD_ID_ENCHANT_BURN = 1044;
	window.CARD_ID_ENCHANT_GAIL = 1045;
	window.CARD_ID_ENCHANT_VENOM = 1046;
	window.CARD_ID_ENCHANT_SACRED = 1047;
	window.CARD_ID_ENCHANT_DEATHPERIA = 1048;
	window.CARD_ID_ENCHANT_GRADGE = 1049;
	window.CARD_ID_ENCHANT_UHA = 1050;
	window.CARD_ID_ENCHANT_HIT_1 = 1051;
	window.CARD_ID_ENCHANT_HIT_2 = 1052;
	window.CARD_ID_ENCHANT_HIT_3 = 1053;
	window.CARD_ID_ENCHANT_HIT_4 = 1054;
	window.CARD_ID_ENCHANT_HIT_5 = 1055;
	window.CARD_ID_ENCHANT_HIT_6 = 1056;
	window.CARD_ID_ENCHANT_HIT_7 = 1057;
	window.CARD_ID_ENCHANT_HIT_8 = 1058;
	window.CARD_ID_ENCHANT_HIT_9 = 1059;
	window.CARD_ID_ENCHANT_HIT_10 = 1060;
	window.CARD_ID_ENCHANT_DEF_21 = 1061;
	window.CARD_ID_ENKONNO_SHIRONO_KISHI = 1062;
	window.CARD_ID_SATSURIKUNO_MAGAN = 1063;
	window.CARD_SET_ID_SATSURIKUNO_MAGAN_MAGANNO_AMDARAIS = 1064;
	window.CARD_ID_MAGANNO_AMDARAIS = 1065;
	window.CARD_ID_ENKONNO_KHALITZBURG = 1066;
	window.CARD_ID_ENCHANT_SUITEN = 1067;
	window.CARD_ID_ECO_TINY_ARMA = 1068;
	window.CARD_ID_ECO_BURIKING_RX1_ARMA = 1069;
	window.CARD_ID_ECO_MINIY_DO_ARMA = 1070;
	window.CARD_ID_ECO_SALAMANDER_ARMA = 1071;
	window.CARD_ID_ECO_MOMO_ARMA = 1072;
	window.CARD_ID_ENCHANT_ENERGY_RYUGARI = 1073;
	window.CARD_ID_ENCHANT_ENERGY_GANKYO = 1074;
	window.CARD_ID_ENCHANT_ENERGY_MADO = 1075;
	window.CARD_ID_ENCHANT_ENERGY_CHIMEINO_ICHIGEKI = 1076;
	window.CARD_ID_POWERFUL_SKELETON = 1077;
	window.CARD_ID_POWERFUL_A_SKELETON = 1078;
	window.CARD_ID_POWERFUL_S_SKELETON = 1079;
	window.CARD_ID_POWERFUL_AMDARAIS = 1080;
	window.CARD_ID_ZOMBIE_GUARD = 1081;
	window.CARD_ID_FUMETSUNO_WINDGHOST = 1082;
	window.CARD_SET_ID_FUMETSUNO_WINDGHOST_FUMETSUNO_NOROWARETA_KISHI = 1083;
	window.CARD_ID_FUSHINO_GUNDAN = 1084;
	window.CARD_ID_FUMETSUNO_NOROWARETA_KISHI = 1085;
	window.CARD_ID_WATCHER = 1086;
	window.CARD_ID_TAPPY = 1087;
	window.CARD_ID_FROZEN_WOLF = 1088;
	window.CARD_ID_S_J_EARNEST_WOLF = 1089;
	window.CARD_ID_BIJOU = 1090;
	window.CARD_ID_ENCHANT_ANSOKUNO_NIEVE_TAIRYOKU = 1091;
	window.CARD_SET_ID_ENCHANT_ANSOKUNO_NIEVE_TAIRYOKU_DARK_HAND = 1092;
	window.CARD_ID_ENCHANT_ANSOKUNO_NIEVE_SEISHIN = 1093;
	window.CARD_SET_ID_ENCHANT_ANSOKUNO_NIEVE_SEISHIN_DARK_HAND = 1094;
	window.CARD_ID_ENCHANT_ANSOKUNO_NIEVE_SEIMEI = 1095;
	window.CARD_SET_ID_ENCHANT_ANSOKUNO_NIEVE_SEIMEI_DARK_HAND = 1096;
	window.CARD_ID_ENCHANT_ANSOKUNO_NIEVE_CHIRYOKU = 1097;
	window.CARD_SET_ID_ENCHANT_ANSOKUNO_NIEVE_CHIRYOKU_DARK_HAND = 1098;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_HI = 1099;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_HI_DARK_HAND = 1100;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_MIZU = 1101;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_MIZU_DARK_HAND = 1102;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_KAZE = 1103;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_KAZE_DARK_HAND = 1104;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_CHI = 1105;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_CHI_DARK_HAND = 1106;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_YAMI = 1107;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_YAMI_DARK_HAND = 1108;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_NEN = 1109;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_NEN_DARK_HAND = 1110;
	window.CARD_ID_ENCHANT_EIGONO_NIEVE_DOKU = 1111;
	window.CARD_SET_ID_ENCHANT_EIGONO_NIEVE_DOKU_DARK_HAND = 1112;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_MUKEI = 1113;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_MUKEI_DARK_HAND = 1114;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_FUSHIKEI = 1115;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_FUSHIKEI_DARK_HAND = 1116;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_DOBUTSUKEI = 1117;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_DOBUTSUKEI_DARK_HAND = 1118;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_SHOKUBUTSUKEI = 1119;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_SHOKUBUTSUKEI_DARK_HAND = 1120;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_KONCHUKEI = 1121;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_KONCHUKEI_DARK_HAND = 1122;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_GYOKAIKEI = 1123;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_GYOKAIKEI_DARK_HAND = 1124;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_AKUMAKEI = 1125;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_AKUMAKEI_DARK_HAND = 1126;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_NINGENKEI = 1127;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_NINGENKEI_DARK_HAND = 1128;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_TENSHIKEI = 1129;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_TENSHIKEI_DARK_HAND = 1130;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_RYUKEI = 1131;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_RYUKEI_DARK_HAND = 1132;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_WANRYOKU = 1133;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_WANRYOKU_DARK_HAND = 1134;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_ZINSOKU = 1135;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_ZINSOKU_DARK_HAND = 1136;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_TAIRYOKU = 1137;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_TAIRYOKU_DARK_HAND = 1138;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_CHIRYOKU = 1139;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_CHIRYOKU_DARK_HAND = 1140;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_SHUCHU = 1141;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_SHUCHU_DARK_HAND = 1142;
	window.CARD_ID_ENCHANT_CHINO_NIEVE_KOUN = 1143;
	window.CARD_SET_ID_ENCHANT_CHINO_NIEVE_KOUN_DARK_HAND = 1144;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_ZINSOKU = 1145;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_ZINSOKU_DARK_HAND = 1146;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_SHUCHU = 1147;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_SHUCHU_DARK_HAND = 1148;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_ZYUKUREN = 1149;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_ZYUKUREN_DARK_HAND = 1150;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_WANRYOKU = 1151;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_WANRYOKU_DARK_HAND = 1152;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_CHIRYOKU = 1153;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_CHIRYOKU_DARK_HAND = 1154;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_TAIRYOKU = 1155;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_TAIRYOKU_DARK_HAND = 1156;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_MABO = 1157;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_MABO_DARK_HAND = 1158;
	window.CARD_ID_SKY_PTITE_PENOMENA = 1159;
	window.CARD_ID_ANUBIS_BEAR_DOLL = 1160;
	window.CARD_ID_ORK_WARRIER_RAFFLESIA = 1161;
	window.CARD_ID_ALNOLDI_BIGFOOT = 1162;
	window.CARD_ID_KHALITZBURG_THARA_FROG = 1163;
	window.CARD_ID_VIRGO = 1164;
	window.CARD_ID_VIRGONO_KAKERA = 1165;
	window.CARD_ID_LEO = 1166;
	window.CARD_ID_LEONO_KAKERA = 1167;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_1 = 1168;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_2 = 1169;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_3 = 1170;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_4 = 1171;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_5 = 1172;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_6 = 1173;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_7 = 1174;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_8 = 1175;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_9 = 1176;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_10 = 1177;
	window.CARD_ID_ENCHANT_UNBREAKABLE = 1178;
	window.CARD_ID_ENCHANT_UNINTERRUPTABLE = 1179;
	window.CARD_ID_ENCHANT_DEF_18 = 1180;
	window.CARD_ID_ENCHANT_MDEF_7 = 1181;
	window.CARD_ID_ENCHANT_CRI_10 = 1182;
	window.CARD_ID_ENCHANT_FLEE_10 = 1183;
	window.CARD_ID_ENCHANT_FLEE_5 = 1184;
	window.CARD_ID_RUNE_KNIGHT_SEIREN = 1185;
	window.CARD_ID_RUNE_KNIGHT_SEIREN_MVP = 1186;
	window.CARD_SET_ID_RUNE_KNIGHT_SEIREN_RUNE_KNIGHT_SEIREN_MVP = 1187;
	window.CARD_ID_WARLOCK_CATHERINE = 1188;
	window.CARD_ID_WARLOCK_CATHERINE_MVP = 1189;
	window.CARD_SET_ID_WARLOCK_CATHERINE_WARLOCK_CATHERINE_MVP = 1190;
	window.CARD_ID_RANGER_CECIL = 1191;
	window.CARD_ID_RANGER_CECIL_MVP = 1192;
	window.CARD_SET_ID_RANGER_CECIL_RANGER_CECIL_MVP = 1193;
	window.CARD_ID_ARCH_BISHOP_MARGARETTE = 1194;
	window.CARD_ID_ARCH_BISHOP_MARGARETTE_MVP = 1195;
	window.CARD_SET_ID_ARCH_BISHOP_MARGARETTE_ARCH_BISHOP_MARGARETTE_MVP = 1196;
	window.CARD_ID_GUILLOTINE_CROSS_ELEMES = 1197;
	window.CARD_ID_GUILLOTINE_CROSS_ELEMES_MVP = 1198;
	window.CARD_SET_ID_GUILLOTINE_CROSS_ELEMES_GUILLOTINE_CROSS_ELEMES_MVP = 1199;
	window.CARD_ID_MECHANIC_HAWARD = 1200;
	window.CARD_ID_MECHANIC_HAWARD_MVP = 1201;
	window.CARD_SET_ID_MECHANIC_HAWARD_MECHANIC_HAWARD_MVP = 1202;
	window.CARD_ID_ROYAL_GUARD_RANDEL = 1203;
	window.CARD_ID_ROYAL_GUARD_RANDEL_MVP = 1204;
	window.CARD_SET_ID_ROYAL_GUARD_RANDEL_ROYAL_GUARD_RANDEL_MVP = 1205;
	window.CARD_ID_SORCERER_CERIA = 1206;
	window.CARD_ID_SORCERER_CERIA_MVP = 1207;
	window.CARD_SET_ID_SORCERER_CERIA_SORCERER_CERIA_MVP = 1208;
	window.CARD_ID_MINSTREL_ARFOSIO = 1209;
	window.CARD_ID_MINSTREL_ARFOSIO_MVP = 1210;
	window.CARD_SET_ID_MINSTREL_ARFOSIO_MINSTREL_ARFOSIO_MVP = 1211;
	window.CARD_ID_WANDERER_TRENTINI = 1212;
	window.CARD_ID_WANDERER_TRENTINI_MVP = 1213;
	window.CARD_SET_ID_WANDERER_TRENTINI_WANDERER_TRENTINI_MVP = 1214;
	window.CARD_SET_ID_MINSTREL_ARFOSIO_WANDERER_TRENTINI = 1215;
	window.CARD_ID_SHURA_CHENG = 1216;
	window.CARD_ID_SHURA_CHENG_MVP = 1217;
	window.CARD_SET_ID_SHURA_CHENG_SHURA_CHENG_MVP = 1218;
	window.CARD_ID_SHADOW_CHASER_GARTY = 1219;
	window.CARD_ID_SHADOW_CHASER_GARTY_MVP = 1220;
	window.CARD_SET_ID_SHADOW_CHASER_GARTY_SHADOW_CHASER_GARTY_MVP = 1221;
	window.CARD_ID_GENETIC_EMUR = 1222;
	window.CARD_ID_GENETIC_EMUR_MVP = 1223;
	window.CARD_SET_ID_GENETIC_EMUR_GENETIC_EMUR_MVP = 1224;
	window.CARD_ID_SHURIKATA_VERUSGEAR = 1225;
	window.CARD_ID_TANSAKATA_VERUSGEAR = 1226;
	window.CARD_ID_ROCKSTEP = 1227;
	window.CARD_ID_SMOG = 1228;
	window.CARD_SET_ID_SMOG_SHURIKATA_VERUSGEAR = 1229;
	window.CARD_SET_ID_SMOG_TANSAKATA_VERUSGEAR = 1230;
	window.CARD_ID_KICK_AND_KICK = 1231;
	window.CARD_ID_KICK_STEP = 1232;
	window.CARD_ID_CRAP = 1233;
	window.CARD_ID_CHARLESTON_3GO = 1234;
	window.CARD_ID_GC109 = 1235;
	window.CARD_ID_STEP = 1236;
	window.CARD_ID_DR815 = 1237;
	window.CARD_SET_ID_DR815_GC109 = 1238;
	window.CARD_ID_T_W_O = 1239;
	window.CARD_ID_MEIKYUNO_BAPHOMET = 1240;
	window.CARD_ID_MEIKYUNO_DRACULA = 1241;
	window.CARD_ID_ENCHANT_EIRI_5 = 1242;
	window.CARD_ID_GOKU = 1243;
	window.CARD_ID_ENCHANT_HYAKKA = 1244;
	window.CARD_ID_ENCHANT_SHINRINO_KAIHO = 1245;
	window.CARD_ID_ENCHANT_KOTEIEISHO_50 = 1246;
	window.CARD_ID_ENCHANT_DELAY_DOWN_15 = 1247;
	window.CARD_ID_ENCHANT_COST_DOWN_15 = 1248;
	window.CARD_ID_ENCHANT_KYOGEKI_1 = 1249;
	window.CARD_ID_ENCHANT_KYOGEKI_2 = 1250;
	window.CARD_ID_ENCHANT_KYOGEKI_3 = 1251;
	window.CARD_ID_ENCHANT_KYOGEKI_4 = 1252;
	window.CARD_ID_ENCHANT_KYOGEKI_5 = 1253;
	window.CARD_ID_KOO_GLOZA = 1254;
	window.CARD_SET_ID_KOO_GLOZA_OWASHINO_GANKO = 1255;
	window.CARD_ID_SHINSONO_KOO_GLOZA = 1256;
	window.CARD_ID_ARCANA_DEVIL = 1257;
	window.CARD_ID_ARCANA_POWER = 1258;
	window.CARD_ID_ARCANA_JUSTICE = 1259;
	window.CARD_ID_ARCANA_STAR = 1260;
	window.CARD_ID_ARCANA_SESSEI = 1261;
	window.CARD_ID_ARCANA_CHARIOT = 1262;
	window.CARD_ID_ARCANA_DEATH = 1263;
	window.CARD_ID_ARCANA_HARMIT = 1264;
	window.CARD_ID_ARCANA_EMPEROR = 1265;
	window.CARD_ID_ARCANA_MOON = 1266;
	window.CARD_ID_ARCANA_LOVERS = 1267;
	window.CARD_ID_ARCANA_HOUO = 1268;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_MEICHU = 1269;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_MEICHU_DARK_HAND = 1270;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_KAIHI = 1271;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_KAIHI_DARK_HAND = 1272;
	window.CARD_ID_ENCHANT_MEIYONO_NIEVE_KOUN = 1273;
	window.CARD_SET_ID_ENCHANT_MEIYONO_NIEVE_KOUN_DARK_HAND = 1274;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_GIKO = 1275;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_GIKO_DARK_HAND = 1276;
	window.CARD_ID_ENCHANT_SHINO_NIEVE_KOUN = 1277;
	window.CARD_SET_ID_ENCHANT_SHINO_NIEVE_KOUN_DARK_HAND = 1278;
	window.CARD_ID_HEART_HUNTER = 1279;
	window.CARD_ID_MATTER_CHEMERA = 1280;
	window.CARD_ID_HUMANOID_CHEMERA = 1281;
	window.CARD_ID_CUTIE = 1282;
	window.CARD_ID_VENOM_CHEMERA = 1283;
	window.CARD_ID_EABLE = 1284;
	window.CARD_ID_TAUROS = 1285;
	window.CARD_ID_CANCER = 1286;
	window.CARD_ID_TOP_ROUND_RIDER = 1287;
	window.CARD_ID_TOP_SIDE_RIDER = 1288;
	window.CARD_ID_BLADE_RIDER = 1289;
	window.CARD_ID_GASTER = 1290;
	window.CARD_ID_COVOTE = 1291;
	window.CARD_ID_TOP_BLADE_RIDER = 1292;
	window.CARD_ID_CARNIVARAUS = 1293;
	window.CARD_ID_PLASMA_RAT = 1294;
	window.CARD_ID_ROUND_RIDER = 1295;
	window.CARD_ID_SIDE_RIDER = 1296;
	window.CARD_ID_ENCHANT_HAO = 1297;
	window.CARD_ID_GEMINI = 1298;
	window.CARD_ID_SAGITTARIUS = 1299;
	window.CARD_ID_ENCHANT_KUMANO_CHIKARA = 1300;
	window.CARD_ID_ENCHANT_KOSOKU = 1301;
	window.CARD_ID_ENCHANT_KOGAI = 1302;
	window.CARD_ID_ENCHANT_OWASHINO_GANKO = 1303;
	window.CARD_ID_ENCHANT_KOUUNNA_HI = 1304;
	window.CARD_ID_ZYOO_FACEWORM = 1305;
	window.CARD_ID_FACEWORMNO_YOCHU = 1306;
	window.CARD_ID_DAICHORO_AIRIN = 1307;
	window.CARD_ID_PAYON_KEIBIHE_PAYON_SHUGOHE = 1308;
	window.CARD_ID_SARANO_GENEI = 1309;
	window.CARD_ID_FACEWORM = 1310;
	window.CARD_ID_JITTER_BUG = 1311;
	window.CARD_ID_DARK_FACEWORM = 1312;
	window.CARD_ID_FACEWORMNO_TAMAGO = 1313;
	window.CARD_SET_ID_FACEWORMNO_YOCHU_FACEWORMNO_TAMAGO = 1314;
	window.CARD_ID_PERE_KISSME_PERE = 1315;
	window.CARD_ID_SINGING_PERE_SWING_PERE = 1316;
	window.CARD_SET_ID_PERE_KISSME_PERE_SINGING_PERE_SWING_PERE = 1317;
	window.CARD_ID_FFF_JITTER_BUG = 1318;
	window.CARD_ID_ENCHANT_OVERCLOCK = 1319;
	window.CARD_ID_ENCHANT_CHOETSUSHA = 1320;
	window.CARD_ID_ENCHANT_ZYURYOKU = 1321;
	window.CARD_ID_ENCHANT_GOWAN = 1322;
	window.CARD_ID_ENCHANT_RYURIN = 1323;
	window.CARD_ID_EGGRING = 1324;
	window.CARD_ID_JUNGLE_MANDRAGORA = 1325;
	window.CARD_ID_FRUITS_POM_SPIDER = 1326;
	window.CARD_ID_TEISATSU_BASILRISK = 1327;
	window.CARD_ID_TOTSUGEKI_BASILRISK = 1328;
	window.CARD_ID_WILD_HORNET = 1329;
	window.CARD_ID_SWEET_FROG = 1330;
	window.CARD_ID_HUNTER_WOLF = 1331;
	window.CARD_ID_TRANS_SPORE = 1332;
	window.CARD_ID_LEAF_RUNATIC = 1333;
	window.CARD_ID_GRASS_FABLE = 1334;
	window.CARD_ID_BIG_EGGRING = 1335;
	window.CARD_ID_ENCHANT_Z_KNOCKBACK = 1336;
	window.CARD_ID_ENCHANT_Z_IMMORTAL = 1337;
	window.CARD_ID_ENCHANT_Z_KILLGAIN = 1338;
	window.CARD_ID_ENCHANT_Z_REINCARNATION = 1339;
	window.CARD_ID_ENCHANT_Z_NODISPELL = 1340;
	window.CARD_ID_ENCHANT_Z_CLAIRVOYANCE = 1341;
	window.CARD_ID_ENCHANT_Z_CASTFIXED = 1342;
	window.CARD_ID_SERPENTARIUS = 1343;
	window.CARD_ID_AQUARIUS = 1344;
	window.CARD_ID_ENCHANT_KIZUNO_NIEVE_PLAYER = 1345;
	window.CARD_SET_ID_ENCHANT_KIZUNO_NIEVE_PLAYER_DARK_HAND = 1346;
	window.CARD_ID_ENCHANT_KYOZIN = 1347;
	window.CARD_ID_ENCHANT_GOKETSU = 1348;
	window.CARD_ID_MEIKYUNO_DOPPELGANGER = 1349;
	window.CARD_ID_ENCHANT_ZOFUKU_1 = 1350;
	window.CARD_ID_ENCHANT_ZOFUKU_2 = 1351;
	window.CARD_ID_ENCHANT_ZOFUKU_3 = 1352;
	window.CARD_ID_ENCHANT_ZOFUKU_4 = 1353;
	window.CARD_ID_ENCHANT_ZOFUKU_5 = 1354;
	window.CARD_ID_IKARINO_UORUYAFA = 1355;
	window.CARD_ID_IKARINO_KUMIHO = 1356;
	window.CARD_ID_ENKONNO_BONGGONG = 1357;
	window.CARD_ID_ENKONNO_SOPHY = 1358;
	window.CARD_ID_ENKONNO_MONAC = 1359;
	window.CARD_ID_ENKONNO_ASKELTON = 1360;
	window.CARD_ID_SHINRINO_MAHOTSUKAI = 1361;
	window.CARD_ID_KYORANSHITA_BOKENSHA = 1362;
	window.CARD_ID_IKARINO_GAZETY = 1363;
	window.CARD_ID_IKARINO_SNOWER = 1364;
	window.CARD_ID_IKARINO_ICE_TITAN = 1365;
	window.CARD_ID_KAKUSEI_KUTORURANUCKS = 1366;
	window.CARD_ID_LIBRA = 1367;
	window.CARD_ID_SCORPIO = 1368;
	window.CARD_ID_MAT_DRAINRIER = 1369;
	window.CARD_ID_BOMI = 1370;
	window.CARD_ID_IKARINO_DRACULA = 1371;
	window.CARD_ID_SWEET_NIGHTMARE = 1372;
	window.CARD_ID_YASURAGIWO_UBAWARESHI_MONOTACHI = 1373;
	window.CARD_ID_FUKITSUNA_SOLID_TURTLE = 1374;
	window.CARD_ID_FUKITSUNA_FREEZE_TURTLE = 1375;
	window.CARD_ID_FUKITSUNA_TURTLE_G = 1376;
	window.CARD_ID_FUKITSUNA_ASSALT_TURTLE = 1377;
	window.CARD_SET_ID_FUKITSUNA_ASSALT_TURTLE_FUKITSUNA_FREEZE_TURTLE = 1378;
	window.CARD_ID_FUKITSUNA_P_TURTLE = 1379;
	window.CARD_ID_FUKITSUNA_HEAT_TURTLE = 1380;
	window.CARD_ID_ENCHANT_ARCANA = 1381;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_EMPEROR = 1382;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HOUO = 1383;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_LOVERS = 1384;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_CHARIOT = 1385;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_POWER = 1386;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HARMIT = 1387;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_JUSTICE = 1388;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_DEATH = 1389;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_SESSEI = 1390;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_DEVIL = 1391;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_STAR = 1392;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_MOON = 1393;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_11 = 1394;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_12 = 1395;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_13 = 1396;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_14 = 1397;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_15 = 1398;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_16 = 1399;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_17 = 1400;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_18 = 1401;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_19 = 1402;
	window.CARD_ID_ENCHANT_RESIST_PLAYER_20 = 1403;
	window.CARD_ID_MAZYO_ZIRANT = 1404;
	window.CARD_ID_KORYU_ZIRANT = 1405;
	window.CARD_ID_ARIES = 1406;
	window.CARD_ID_CAPRICORN = 1407;
	window.CARD_ID_PISCES = 1408;
	window.CARD_ID_ENCHANT_TOKETSU_TAISE = 1409;
	window.CARD_ID_FLAME_GOLEM = 1410;
	window.CARD_ID_SHINIGAMI_ANKOU = 1411;
	window.CARD_ID_MORS_NECROMANCER = 1412;
	window.CARD_ID_FLAME_SANDMAN = 1413;
	window.CARD_ID_FLAME_CONDOR = 1414;
	window.CARD_ID_BRINARANEA = 1415;
	window.CARD_ID_MUSPELLSKOLL = 1416;
	window.CARD_ID_FLAME_BUG = 1417;
	window.CARD_ID_DARAKUSHITA_SEME = 1418;
	window.CARD_ID_FLAME_FRILLDORA = 1419;
	window.CARD_ID_MAZINNO_SHITO_AHAT = 1420;
	window.CARD_ID_MAZINNO_SHITO_SHINAIM = 1421;
	window.CARD_SET_ID_MAZINNO_SHITO_SHINAIM_MAZINNO_SHITO_AHAT = 1422;
	window.CARD_ID_ZETSUBONO_KAMI_MOROCC = 1423;
	window.CARD_ID_ENCHANT_CHODOKYU = 1424;
	window.CARD_ID_ENCHANT_IGNORE_DEF_50 = 1425;
	window.CARD_ID_ENCHANT_HANGYAKUSHA = 1426;
	window.CARD_ID_ENCHANT_HONOIKAZUCHINOOKAMI = 1427;
	window.CARD_ID_ENCHANT_IGNORE_MDEF_50 = 1428;
	window.CARD_ID_RODOGATA_PITMAN = 1429;
	window.CARD_ID_KAGAYAKU_BEARDOLL = 1430;
	window.CARD_ID_TAMASHINO_HAHEN = 1431;
	window.CARD_ID_COLORFULLNA_BEARDOLL = 1432;
	window.CARD_ID_ZYANENNO_OBISIDIEN = 1433;
	window.CARD_ID_ARCANA_FOOL = 1434;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_FOOL = 1435;
	window.CARD_ID_ARCANA_WHEEL_OF_FORTUNE = 1436;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_WHEEL_OF_FORTUNE = 1437;
	window.CARD_ID_ARCANA_HANGED_MAN = 1438;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HANGED_MAN = 1439;
	window.CARD_ID_ARCANA_WORLD = 1440;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_WORLD = 1441;
	window.CARD_ID_INISHIENO_WOOTANG_FIGHTER = 1442;
	window.CARD_ID_INISHIENO_SANYOCHU = 1443;
	window.CARD_ID_INISHIENO_FLAME_SHOOTER = 1444;
	window.CARD_ID_INISHIENO_TAOGUNKA = 1445;
	window.CARD_ID_INISHIENO_MEGLIS = 1446;
	window.CARD_ID_INISHIENO_WOOTANG_SHOOTER = 1447;
	window.CARD_ID_INISHIENO_WOOTANG_GUARD = 1448;
	window.CARD_ID_INISHIENO_S_GOLEM = 1449;
	window.CARD_ID_ENCHANT_SHINO_YOKUDO = 1450;
	window.CARD_ID_ENCHANT_B_ATK = 1451;
	window.CARD_ID_ENCHANT_B_DEF = 1452;
	window.CARD_ID_ENCHANT_B_HPR = 1453;
	window.CARD_ID_ENCHANT_B_MATK = 1454;
	window.CARD_ID_ENCHANT_B_MAXHP = 1455;
	window.CARD_ID_ENCHANT_B_MAXSP = 1456;
	window.CARD_ID_ENCHANT_B_MDEF = 1457;
	window.CARD_ID_ENCHANT_B_SPR = 1458;
	window.CARD_ID_ENCHANT_G_DRAINHP = 1459;
	window.CARD_ID_ENCHANT_G_DRAINSP = 1460;
	window.CARD_SET_ID_ENCHANT_G_DRAINSP_ENERGY_SHUGORYU = 1461;
	window.CARD_ID_ENCHANT_G_LIFE = 1462;
	window.CARD_ID_ENCHANT_G_SOUL = 1463;
	window.CARD_ID_ENCHANT_Q_ATTRIBUTE = 1464;
	window.CARD_ID_ENCHANT_Q_CAST_FIXED = 1465;
	window.CARD_ID_ENCHANT_Q_CAST_STAT = 1466;
	window.CARD_ID_ENCHANT_Q_DELAY = 1467;
	window.CARD_ID_ENCHANT_Q_FATAL = 1468;
	window.CARD_ID_ENCHANT_Q_HEAL = 1469;
	window.CARD_ID_ENCHANT_Q_PLAYER = 1470;
	window.CARD_ID_ENCHANT_Q_SHOOTER = 1471;
	window.CARD_ID_ENCHANT_Q_SPEED = 1472;
	window.CARD_ID_ENCHANT_X_FATAL_FLASH = 1473;
	window.CARD_ID_ENCHANT_X_FIRING_SHOT = 1474;
	window.CARD_ID_ENCHANT_X_LUCKY_STRIKE = 1475;
	window.CARD_ID_ENCHANT_X_OVER_POWER = 1476;
	window.CARD_ID_ENCHANT_X_SPELL_BUSTER = 1477;
	window.CARD_ID_ENCHANT_X_UNLIMIT_VITAL = 1478;
	window.CARD_ID_PLAGA = 1479;
	window.CARD_ID_DOLOR = 1480;
	window.CARD_ID_TWIN_CAPUT = 1481;
	window.CARD_ID_E_EA1L = 1482;
	window.CARD_ID_EL_A17T = 1483;
	window.CARD_ID_HENSHU_VENENUM = 1484;
	window.CARD_ID_MIGUEL = 1485;
	window.CARD_ID_HEART_HUNTER_SANARE = 1486;
	window.CARD_ID_HENSHU_PLAGA = 1487;
	window.CARD_ID_HEART_HUNTER_BELLARE = 1488;
	window.CARD_ID_HEART_HUNTER_M_BELLARE = 1489;
	window.CARD_ID_HENSHU_DOLOR = 1490;
	window.CARD_ID_EA2S = 1491;
	window.CARD_ID_HEART_HUNTER_M_SANARE = 1492;
	window.CARD_ID_VENENUM = 1493;
	window.CARD_ID_HENSHU_TWIN_CAPUT = 1494;
	window.CARD_ID_R48_85_BESTIA = 1495;
	window.CARD_SET_ID_R48_85_BESTIA_KIEL_D01 = 1496;
	window.CARD_ID_ENCHANT_GREED_EISHO_100 = 1497;
	window.CARD_ID_CURUPIRA = 1498;
	window.CARD_ID_BOITATA = 1499;
	window.CARD_ID_TOUCAN = 1500;
	window.CARD_ID_KUBINASHI_LABA = 1501;
	window.CARD_ID_IARA = 1502;
	window.CARD_ID_PIRANHA = 1503;
	window.CARD_ID_JAGUAR = 1504;
	window.CARD_ID_BLACK_KANEIRY = 1505;
	window.CARD_SET_ID_BLACK_KANEIRY_SET = 1506;
	window.CARD_ID_OLDOR = 1507;
	window.CARD_SET_ID_OLDOR_SET = 1508;
	window.CARD_ID_FEMON = 1509;
	window.CARD_ID_KUROMA = 1510;
	window.CARD_SET_ID_KUROMA_SET = 1511;
	window.CARD_ID_FAY_CANAVIAN = 1512;
	window.CARD_SET_ID_FAY_CANAVIAN_SET = 1513;
	window.CARD_ID_DIO_ANEMOS = 1514;
	window.CARD_SET_ID_DIO_ANEMOS_SET = 1515;
	window.CARD_ID_BILLY_COSRLEASE = 1516;
	window.CARD_ID_IFODOS = 1517;
	window.CARD_ID_YUMEHIME = 1518;
	window.CARD_ID_ARUHI = 1519;
	window.CARD_ID_HIPIA_SNIKI = 1520;
	window.CARD_ID_BLUTO_HAZE = 1521;
	window.CARD_ID_LECHENIE = 1522;
	window.CARD_ID_JUE = 1523;
	window.CARD_SET_ID_JUE_SET = 1524;
	window.CARD_ID_DEWAI = 1525;
	window.CARD_ID_GIGANTES = 1526;
	window.CARD_ID_KISHI_SAKRAY = 1527;
	window.CARD_ID_VAVAYAGA = 1528;
	window.CARD_ID_UZHAS = 1529;
	window.CARD_ID_GOPINICH = 1530;
	window.CARD_ID_WOOD_GOBLIN = 1531;
	window.CARD_ID_LES = 1532;
	window.CARD_ID_MAVKA = 1533;
	window.CARD_ID_BOSOSHITA_SENCHO_PERLOCK = 1534;
	window.CARD_ID_HIKOSEN_SHUGEKIDAN = 1535;
	window.CARD_ID_MAZINNO_KYOEI = 1536;
	window.CARD_ID_MAZINNO_SHINZYA = 1537;
	window.CARD_ID_KONTONNO_SIDEWINDER = 1538;
	window.CARD_ID_KONTONNO_STEMWORM = 1539;
	window.CARD_ID_KONTONNO_BAPHOMET_JR = 1540;
	window.CARD_ID_KONTONNO_KILLER_MANTICE = 1541;
	window.CARD_ID_KONTONNO_HUNTERFLY = 1542;
	window.CARD_ID_KONTONNO_GHOSTRING = 1543;
	window.CARD_ID_KONTONNO_BAPHOMET = 1544;
	window.CARD_ID_KONTONNO_ACOLYTE = 1545;
	window.CARD_ID_KONTONNO_MANTICE = 1546;
	window.CARD_SET_ID_KONTONNO_MANTICE_KONTONNO_KILLER_MANTICE = 1547;
	window.CARD_ID_KONTONNO_POPORING = 1548;
	window.CARD_ID_ENCHANT_ENKYORI_BUTSURI_TAISEI_10 = 1549;
	window.CARD_ID_FUINSARETA_WORUYAFA = 1550;
	window.CARD_ID_ENCHANT_EXTREME = 1551;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_ASPD = 1552;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_ATK = 1553;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_AVOID = 1554;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_DEF = 1555;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_FLEE = 1556;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_FROZEN = 1557;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_HIT = 1558;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_INT = 1559;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_MATK = 1560;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_MAXHP = 1561;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_MAXSP = 1562;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_MDEF = 1563;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_STR = 1564;
	window.CARD_SET_ID_ENCHANT_EXTREME_A_TOLERANCE = 1565;
	window.CARD_SET_ID_ENCHANT_EXTREME_C_HPR = 1566;
	window.CARD_SET_ID_ENCHANT_EXTREME_C_LIFE = 1567;
	window.CARD_SET_ID_ENCHANT_EXTREME_C_SOUL = 1568;
	window.CARD_SET_ID_ENCHANT_EXTREME_C_SPR = 1569;
	window.CARD_SET_ID_ENCHANT_EXTREME_E_FIRE = 1570;
	window.CARD_SET_ID_ENCHANT_EXTREME_E_GROUND = 1571;
	window.CARD_SET_ID_ENCHANT_EXTREME_E_WATER = 1572;
	window.CARD_SET_ID_ENCHANT_EXTREME_E_WIND = 1573;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_FIRE = 1574;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_GROUND = 1575;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_WATER = 1576;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_WIND = 1577;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_ATK = 1578;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_AVOID = 1579;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_CRI = 1580;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_MATK = 1581;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_MAXHP = 1582;
	window.CARD_SET_ID_ENCHANT_EXTREME_S_QUICK = 1583;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_CASTFIXED = 1584;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_CLAIRVOYANCE = 1585;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_IMMORTAL = 1586;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_KILLGAIN = 1587;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_KNOCKBACK = 1588;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_NODISPELL = 1589;
	window.CARD_SET_ID_ENCHANT_EXTREME_Z_REINCARNATION = 1590;
	window.CARD_ID_ENCHANT_MAGNIFICAT_LV5 = 1591;
	window.CARD_ID_ENCHANT_DEF_50 = 1592;
	window.CARD_ID_ENCHANT_RESIST_KNOCKBACK = 1593;
	window.CARD_ID_ENCHANT_SEKIKA_TAISE = 1594;
	window.CARD_ID_OSEN_SARETA_SAMAYOU_MONO = 1595;
	window.CARD_ID_KOKA_KAHO = 1596;
	window.CARD_ID_KOKA_RAVA_GOLEM = 1597;
	window.CARD_ID_PRISON_BREAKER = 1598;
	window.CARD_ID_ICE_GARGOYLE = 1599;
	window.CARD_ID_KOKA_NIGHTMARE_TERROR = 1600;
	window.CARD_ID_KOKA_BLAZER = 1601;
	window.CARD_ID_OSEN_SARETA_DARK_LORD = 1602;
	window.CARD_ID_KOKA_EXPLOSION = 1603;
	window.CARD_ID_OSEN_SARETA_RAYDRIC_A = 1604;
	window.CARD_ID_ICE_GHOST = 1605;
	window.CARD_ID_OSEN_SARETA_STING = 1606;
	window.CARD_ID_OSEN_SARETA_BURINARANEA = 1607;
	window.CARD_ID_KOKA_G_DELETER = 1608;
	window.CARD_ID_KOKA_S_DELETER = 1609;
	window.CARD_ID_KOKA_MUSPERKOLE = 1610;
	window.CARD_ID_FLAME_GHOST = 1611;
	window.CARD_ID_OSEN_SARETA_RAYDRIC = 1612;
	window.CARD_ID_ENCHANT_T_POWER_BOOST = 1613;
	window.CARD_ID_ENCHANT_T_MAGIC_BOOST = 1614;
	window.CARD_ID_ENCHANT_T_ASSAULT = 1615;
	window.CARD_ID_ENCHANT_T_ELECTRICITY = 1616;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ARCBISHOP = 1617;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_GENETIC = 1618;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SHADOWCHASER = 1619;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SHURA = 1620;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SORCERER = 1621;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_MECHANIC = 1622;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_RUNE_KNIGHT = 1623;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ROYALGUARD = 1624;
	window.CARD_ID_ENCHANT_PERFECT_ATTACK_UP_25 = 1625;
	window.CARD_ID_ENCHANT_HIT_100 = 1626;
	window.CARD_ID_HANRYU_OZYO_MARE = 1627;
	window.CARD_ID_OZYO_MARE = 1628;
	window.CARD_ID_ARCANA_JUSTICE_REVERSE = 1629;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_JUSTICE_REVERSE = 1630;
	window.CARD_ID_ARCANA_STAR_REVERSE = 1631;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_STAR_REVERSE = 1632;
	window.CARD_ID_ARCANA_SESSEI_REVERSE = 1633;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_SESSEI_REVERSE = 1634;
	window.CARD_ID_ARCANA_CHARIOT_REVERSE = 1635;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_CHARIOT_REVERSE = 1636;
	window.CARD_ID_ARCANA_DEATH_REVERSE = 1637;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_DEATH_REVERSE = 1638;
	window.CARD_ID_ARCANA_LOVERS_REVERSE = 1639;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_LOVERS_REVERSE = 1640;
	window.CARD_ID_ENCHANT_SENKO = 1641;
	window.CARD_SET_ID_ENCHANT_SENKO_KOSOKU = 1642;
	window.CARD_ID_ENCHANT_KYOGO = 1643;
	window.CARD_SET_ID_ENCHANT_KYOGO_KUMANO_CHIKARA = 1644;
	window.CARD_ID_ENCHANT_TENKYU = 1645;
	window.CARD_SET_ID_ENCHANT_TENKYU_OWASHINO_GANKO = 1646;
	window.CARD_ID_ENCHANT_SHINREKI = 1647;
	window.CARD_SET_ID_ENCHANT_SHINREKI_BOSOSHITA_MARYOKU = 1648;
	window.CARD_ID_ENCHANT_GOTAI = 1649;
	window.CARD_SET_ID_ENCHANT_GOTAI_KOGAI = 1650;
	window.CARD_ID_ENCHANT_HAKUUN = 1651;
	window.CARD_SET_ID_ENCHANT_HAKUUN_KOUNNA_HI = 1652;
	window.CARD_ID_NOROIWO_NOMIKONDA_O = 1653;
	window.CARD_ID_FUINSARETA_KTULLANUX = 1654;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_FIRE = 1655;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_WATER = 1656;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_WIND = 1657;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_EARTH = 1658;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_HOLY = 1659;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_DARK = 1660;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_PSYCO = 1661;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_POISON = 1662;
	window.CARD_ID_ENCHANT_BODY_ELEMENT_UNDEAD = 1663;
	window.CARD_ID_MAGICAL_MONSTER_ELM_ALL_10UP = 1664;
	window.CARD_ID_MAGICAL_SIZE_ALL_8UP = 1665;
	window.CARD_ID_ARCANA_EMPEROR_REVERSE = 1666;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_EMPEROR_REVERSE = 1667;
	window.CARD_ID_ARCANA_POWER_REVERSE = 1668;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_POWER_REVERSE = 1669;
	window.CARD_ID_ARCANA_DEVIL_REVERSE = 1670;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_DEVIL_REVERSE = 1671;
	window.CARD_ID_ARCANA_MOON_REVERSE = 1672;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_MOON_REVERSE = 1673;
	window.CARD_ID_ARCANA_WHEEL_OF_FORTUNE_REVERSE = 1674;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_WHEEL_OF_FORTUNE_REVERSE = 1675;
	window.CARD_ID_ARCANA_WORLD_REVERSE = 1676;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_WORLD_REVERSE = 1677;
	window.CARD_ID_ENCHANT_SHINSONO_O = 1678;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_SOHION = 1679;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_LOLA = 1680;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_ELVIRA = 1681;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_RUDO = 1682;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_SHOGUN_DAEHYON = 1683;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_KYOSHINZYA_PYURIEL = 1684;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_MUZIHINA_GIOIA = 1685;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_MOZYANO_SHUGOSHA_KADES = 1686;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_KOO_GLOZA = 1687;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_KOO_GLOZA_OWASHINO_GANKO = 1688;
	window.CARD_SET_ID_ENCHANT_SHINSONO_O_SHINSONO_KOO_GLOZA = 1689;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_WARLOCK = 1690;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_GUILLOTINE_CROSS = 1691;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_MINSTREL = 1692;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_RANGER = 1693;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_WANDERER = 1694;
	window.CARD_ID_ENCHANT_TAIYO = 1695;
	window.CARD_ID_ENCHANT_TSUKI = 1696;
	window.CARD_ID_ENCHANT_HOSHI = 1697;
	window.CARD_ID_ENCHANT_ES = 1698;
	window.CARD_ID_ENCHANT_SHIRYO = 1699;
	window.CARD_ID_ENCHANT_TAMASHI = 1700;
	window.CARD_ID_FUINSARETA_DARK_LORD = 1701;
	window.CARD_SET_ID_FUINSARETA_DARKLORD_DARK_ILLUSION = 1702;
	window.CARD_ID_ENCHANT_A_REFLECT = 1703;
	window.CARD_ID_ENCHANT_A_SP_COST = 1704;
	window.CARD_ID_ENCHANT_B_STR = 1705;
	window.CARD_ID_ENCHANT_B_AGI = 1706;
	window.CARD_ID_ENCHANT_B_VIT = 1707;
	window.CARD_ID_ENCHANT_B_INT = 1708;
	window.CARD_ID_ENCHANT_B_DEX = 1709;
	window.CARD_ID_ENCHANT_B_LUK = 1710;
	window.CARD_ID_ENCHANT_E_DARKNESS = 1711;
	window.CARD_ID_ENCHANT_E_POISON = 1712;
	window.CARD_ID_ENCHANT_E_SAINT = 1713;
	window.CARD_ID_ENCHANT_E_UNDEAD = 1714;
	window.CARD_ID_ENCHANT_G_CRI = 1715;
	window.CARD_ID_ENCHANT_G_GUIDED = 1716;
	window.CARD_ID_ENCHANT_L_ABSORB_SPIRITS_1 = 1717;
	window.CARD_ID_ENCHANT_L_ANGELUS_1 = 1718;
	window.CARD_ID_ENCHANT_L_AUTO_GUARD_3 = 1719;
	window.CARD_ID_ENCHANT_L_BASH_3 = 1720;
	window.CARD_ID_ENCHANT_L_CALL_SPIRITS_2 = 1721;
	window.CARD_ID_ENCHANT_L_CAST_CANCEL_1 = 1722;
	window.CARD_ID_ENCHANT_L_CLOAKING_1 = 1723;
	window.CARD_ID_ENCHANT_L_CLOSE_CONFINE_1 = 1724;
	window.CARD_ID_ENCHANT_L_COLD_BOLT_3 = 1725;
	window.CARD_ID_ENCHANT_L_CURE_1 = 1726;
	window.CARD_ID_ENCHANT_L_DEC_AGI_1 = 1727;
	window.CARD_ID_ENCHANT_L_DETOXIFY_1 = 1728;
	window.CARD_ID_ENCHANT_L_EARTH_SPIKE_3 = 1729;
	window.CARD_ID_ENCHANT_L_ESTIMATION_1 = 1730;
	window.CARD_ID_ENCHANT_L_FIRE_BALL_3 = 1731;
	window.CARD_ID_ENCHANT_L_FIRE_BOLT_3 = 1732;
	window.CARD_ID_ENCHANT_L_FROST_DIVE_3 = 1733;
	window.CARD_ID_ENCHANT_L_FROST_NOVA_2 = 1734;
	window.CARD_ID_ENCHANT_L_GLORIA_1 = 1735;
	window.CARD_ID_ENCHANT_L_HEAL_1 = 1736;
	window.CARD_ID_ENCHANT_L_HIDING_1 = 1737;
	window.CARD_ID_ENCHANT_L_IDENTIFY_1 = 1738;
	window.CARD_ID_ENCHANT_L_LIGHTNING_BOLT_3 = 1739;
	window.CARD_ID_ENCHANT_L_LOUD_1 = 1740;
	window.CARD_ID_ENCHANT_L_MAGIC_POWER_5 = 1741;
	window.CARD_ID_ENCHANT_L_MAGNUM_3 = 1742;
	window.CARD_ID_ENCHANT_L_METEOR_3 = 1743;
	window.CARD_ID_ENCHANT_L_PEONY_MAMY_1 = 1744;
	window.CARD_ID_ENCHANT_L_POISON_3 = 1745;
	window.CARD_ID_ENCHANT_L_POTION_PITCHER_3 = 1746;
	window.CARD_ID_ENCHANT_L_SADAGUI_1 = 1747;
	window.CARD_ID_ENCHANT_L_SEUOIA_DUST_1 = 1748;
	window.CARD_ID_ENCHANT_L_SIGHT_1 = 1749;
	window.CARD_ID_ENCHANT_L_SNOW_FLIP_1 = 1750;
	window.CARD_ID_ENCHANT_L_SOUL_STRIKE_3 = 1751;
	window.CARD_ID_ENCHANT_L_SPELL_BREAKER_1 = 1752;
	window.CARD_ID_ENCHANT_L_STEAL_1 = 1753;
	window.CARD_ID_ENCHANT_L_STONE_CURSE_3 = 1754;
	window.CARD_ID_ENCHANT_L_TELEPORT_1 = 1755;
	window.CARD_ID_ENCHANT_L_THROW_STONE_1 = 1756;
	window.CARD_ID_ENCHANT_P_CONFUSE = 1757;
	window.CARD_ID_ENCHANT_P_CURSE = 1758;
	window.CARD_ID_ENCHANT_P_FEAR = 1759;
	window.CARD_ID_ENCHANT_P_IGNITION = 1760;
	window.CARD_ID_ENCHANT_P_PETRIFACTION = 1761;
	window.CARD_ID_ENCHANT_P_SILENCE = 1762;
	window.CARD_ID_ENCHANT_P_SLEEP = 1763;
	window.CARD_ID_ENCHANT_Q_BOSS = 1764;
	window.CARD_ID_ENCHANT_Q_NORMAL = 1765;
	window.CARD_ID_ENCHANT_R_DARKNESS = 1766;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_DARKNESS = 1767;
	window.CARD_ID_ENCHANT_R_SAINT = 1768;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_SAINT = 1769;
	window.CARD_ID_ENCHANT_R_TELEKINESIS = 1770;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_TELEKINESIS = 1771;
	window.CARD_ID_ENCHANT_R_UNDEAD = 1772;
	window.CARD_SET_ID_ENCHANT_EXTREME_R_UNDEAD = 1773;
	window.CARD_ID_ENCHANT_S_FATAL_FLASH = 1774;
	window.CARD_ID_ENCHANT_S_FIRING_SHOT = 1775;
	window.CARD_ID_ENCHANT_S_LUCKY_STRIKE = 1776;
	window.CARD_ID_ENCHANT_S_OVER_POWER = 1777;
	window.CARD_ID_ENCHANT_S_SPELL_BUSTER = 1778;
	window.CARD_ID_ENCHANT_S_UNLIMIT_VITAL = 1779;
	window.CARD_ID_YELLOW_PITAYA = 1780;
	window.CARD_ID_ELITE_BERARE = 1781;
	window.CARD_ID_KAIHOSARETA_MARYOKU = 1782;
	window.CARD_ID_GREEN_PITAYA = 1783;
	window.CARD_ID_GESUI_VENENUM = 1784;
	window.CARD_ID_GESUI_WATER_FALL = 1785;
	window.CARD_ID_GESUI_CLAMP = 1786;
	window.CARD_ID_KENKYU_ZYOSHU_ZIDO_NINGYO = 1787;
	window.CARD_ID_KOSHOSITA_NIWASHI_BETA = 1788;
	window.CARD_ID_SILVA_PAPIRIA = 1789;
	window.CARD_ID_SWEETY = 1790;
	window.CARD_ID_TOKUSE_ALNOLDI = 1791;
	window.CARD_SET_ID_KENKYU_ZYOSHU_ZIDO_NINGYO_TOKUSE_ALNOLDI = 1792;
	window.CARD_ID_DRY_RAFFLESIA = 1793;
	window.CARD_SET_ID_KENKYU_ZYOSHU_ZIDO_NINGYO_DRY_RAFFLESIA = 1794;
	window.CARD_ID_PURPLE_PITAYA = 1795;
	window.CARD_ID_HAIKAISURU_MADOSHO = 1796;
	window.CARD_ID_PAPIRA = 1797;
	window.CARD_ID_PAPIRA_KAI = 1798;
	window.CARD_ID_PAPIRA_RUBA = 1799;
	window.CARD_ID_BOOK_WORM = 1800;
	window.CARD_ID_BLUE_ARIES = 1801;
	window.CARD_ID_BLUE_PITAYA = 1802;
	window.CARD_ID_BELPOLTA = 1803;
	window.CARD_ID_BELPOLTE = 1804;
	window.CARD_ID_BOSS_PITAYA = 1805;
	window.CARD_ID_MARYOKU_CHUDOKU_DOLOR = 1806;
	window.CARD_ID_RED_ARIES = 1807;
	window.CARD_SET_ID_BLUE_ARIES_RED_ARIES = 1808;
	window.CARD_ID_RED_PITAYA = 1809;
	window.CARD_ID_RED_PEPPER_KAPPA = 1810;
	window.CARD_ID_ENCHANT_SIGHT_LV1 = 1811;
	window.CARD_ID_ENCHANT_TOUSHI = 1812;
	window.CARD_ID_ENCHANT_SATSUINO_ONNEN = 1813;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_IGNISEM_CENIA_MVP = 1814;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_ELEMES_GAIL_MVP = 1815;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_CATHERINE_KARON_MVP = 1816;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_SEIREN_VIENSER_MVP = 1817;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_CECIL_DIMON_MVP = 1818;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_HAWARD_ALTIZEN_MVP = 1819;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_MARGARETTE_SORIN_MVP = 1820;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_ARFOSIO_BASIL_MVP = 1821;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_EMUR_PURAMEL_MVP = 1822;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_GERTIE_UH_MVP = 1823;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_CERIA_ARDE_MVP = 1824;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_CHENG_RIU_MVP = 1825;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_TRENTINI_MVP = 1826;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_RANDEL_RORENCE_MVP = 1827;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_ARCH_BISHOP_MARGARETTE_MVP = 1828;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_WARLOCK_CATHERINE_MVP = 1829;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_GUILLOTINE_CROSS_ELEMES_MVP = 1830;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_MECHANIC_HAWARD_MVP = 1831;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_RUNE_KNIGHT_SEIREN_MVP = 1832;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_RANGER_CECIL_MVP = 1833;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_GENETIC_EMUR_MVP = 1834;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_SHADOW_CHASER_GARTY_MVP = 1835;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_SHURA_CHENG_MVP = 1836;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_SORCERER_CERIA_MVP = 1837;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_MINSTREL_ARFOSIO_MVP = 1838;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_ROYAL_GUARD_RANDEL_MVP = 1839;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_WANDERER_TRENTINI_MVP = 1840;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT = 1841;
	window.CARD_ID_ENCHANT_ENKYORI_BUTSURI_TAISEI_5 = 1842;
	window.CARD_ID_ENCHANT_LUCKY_25 = 1843;
	window.CARD_ID_ENCHANT_KIDATSU_LV1 = 1844;
	window.CARD_ID_ENCHANT_ZINKU = 1845;
	window.CARD_ID_ENCHANT_NICHTS = 1846;
	window.CARD_SET_ID_ENCHANT_NICHTS_DEVILRING = 1847;
	window.CARD_ID_ENCHANT_MAXHP_15P = 1848;
	window.CARD_ID_ENCHANT_IMMUNE_FIRE = 1849;
	window.CARD_ID_ENCHANT_IMMUNE_WATER = 1850;
	window.CARD_ID_ENCHANT_IMMUNE_WIND = 1851;
	window.CARD_ID_ENCHANT_IMMUNE_EARTH = 1852;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_KAGERO = 1853;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_OBORO = 1854;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_REBELLION = 1855;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SUMMONER = 1856;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_STAR_EMPEROR = 1857;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SOUL_REAPER = 1858;
	window.CARD_ID_ENCHANT_EXTRA_STR = 1859;
	window.CARD_ID_ENCHANT_EXTRA_AGI = 1860;
	window.CARD_ID_ENCHANT_EXTRA_VIT = 1861;
	window.CARD_ID_ENCHANT_EXTRA_INT = 1862;
	window.CARD_ID_ENCHANT_EXTRA_DEX = 1863;
	window.CARD_ID_ENCHANT_EXTRA_LUK = 1864;
	window.CARD_ID_NIHIL_MISERIA_HEINE_SIGNED = 1865;
	window.CARD_ID_SPICA_NERIUS_SIGNED = 1866;
	window.CARD_ID_SKIA_NERIUS_SIGNED = 1867;
	window.CARD_ID_NIHIL = 1868;
	window.CARD_ID_AGNES = 1869;
	window.CARD_ID_JURGEN = 1870;
	window.CARD_ID_SPICA = 1871;
	window.CARD_ID_KRONECKER = 1872;
	window.CARD_ID_SKIA = 1873;
	window.CARD_ID_WOLF_L = 1874;
	window.CARD_ID_POE = 1875;
	window.CARD_ID_KATHRYN = 1876;
	window.CARD_ID_ISSAC = 1877;
	window.CARD_ID_ENCHANT_Q_RANGE = 1878;
	window.CARD_SET_ID_ENCHANT_Q_RANGE_HORN = 1879;
	window.CARD_ID_ENCHANT_SHINRA_BANSHO = 1880;
	window.CARD_SET_ID_ENCHANT_SHINRA_BANSHO_SHINO_YOKUDO = 1881;
	window.CARD_SET_ID_ENCHANT_SHINRA_BANSHO_SHINRINO_KAIHO = 1882;
	window.CARD_SET_ID_ENCHANT_SHINRA_BANSHO_GOKETSU = 1883;
	window.CARD_SET_ID_ENCHANT_SHINRA_BANSHO_HAO = 1884;
	window.CARD_ID_DARAKUNO_MAGAN = 1885;
	window.CARD_ID_NOROWARETA_SHITSUZI = 1886;
	window.CARD_ID_HENBONO_SHIROKISHI = 1887;
	window.CARD_ID_HENBONO_KHALITZBURG = 1888;
	window.CARD_ID_ZYUSATSUNO_AMDARAIS = 1889;
	window.CARD_SET_ID_ZYUSATSUNO_AMDARAIS_DARAKUNO_MAGAN = 1890;
	window.CARD_ID_ZYUSATSUNO_HIMERMEZ = 1891;
	window.CARD_ID_NOROWARETA_RAYDRIC_A = 1892;
	window.CARD_ID_NOROWARETA_RAYDRIC = 1893;
	window.CARD_ID_ARCANA_HARMIT_REVERSE = 1894;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HARMIT_REVERSE = 1895;
	window.CARD_ID_ARCANA_FOOL_REVERSE = 1896;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_FOOL_REVERSE = 1897;
	window.CARD_ID_ARCANA_HOUO_REVERSE = 1898;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HOUO_REVERSE = 1899;
	window.CARD_ID_ARCANA_HANGED_MAN_REVERSE = 1900;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HANGED_MAN_REVERSE = 1901;
	window.CARD_ID_ARCANA_HIGH_PRIESTESS = 1902;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HIGH_PRIESTESS = 1903;
	window.CARD_ID_ARCANA_HIGH_PRIESTESS_REVERSE = 1904;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_HIGH_PRIESTESS_REVERSE = 1905;
	window.CARD_ID_ARCANA_TOWER = 1906;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_TOWER = 1907;
	window.CARD_ID_ARCANA_TOWER_REVERSE = 1908;
	window.CARD_SET_ID_ENCHANT_ARCANA_ARCANA_TOWER_REVERSE = 1909;
	window.CARD_ID_ENCHANT_ALLES = 1910;
	window.CARD_ID_ENCHANT_ONO_KAMUI = 1911;
	window.CARD_SET_ID_ENCHANT_ONO_KAMUI_ROYAL_ARMS = 1912;
	window.CARD_SET_ID_ENCHANT_ONO_KAMUI_ROYAL_ARMS_2HAND = 1913;
	window.CARD_SET_ID_ENCHANT_ONO_KAMUI_NOROIWO_NOMIKONDA_O = 1914;
	window.CARD_ID_SHINKAINO_SLOFO = 1915;
	window.CARD_ID_SHINKAINO_CEDORA = 1916;
	window.CARD_ID_SHINKAINO_DEVIAS = 1917;
	window.CARD_ID_SHINKAINO_HANGYOZIN = 1918;
	window.CARD_ID_SHINKAINO_KING_DORAMO = 1919;
	window.CARD_ID_SHINKAINO_MARS = 1920;
	window.CARD_ID_SHINKAINO_KRAKEN = 1921;
	window.CARD_ID_SHINKAINO_STRAUF = 1922;
	window.CARD_ID_SHINKAINO_SWORD_FISH = 1923;
	window.CARD_ID_SHINKAINO_OBEAUNE = 1924;
	window.CARD_ID_SHINKAINO_PHEN = 1925;
	window.CARD_SET_ID_SHINKAINO_PHEN_SHINKAINO_STRAUF = 1926;
	window.CARD_ID_MUGENNO_TOAD = 1927;
	window.CARD_ID_MUGENNO_SASURAI_OKAMI = 1928;
	window.CARD_ID_MUGENNO_VOCAL = 1929;
	window.CARD_ID_MUGENNO_ECLIPSE = 1930;
	window.CARD_ID_MUGENNO_CHIMERA = 1931;
	window.CARD_ID_MUGENNO_OSIRIS = 1932;
	window.CARD_ID_MUGENNO_EDDGA = 1933;
	window.CARD_ID_MUGENNO_PHREEONI = 1934;
	window.CARD_ID_MUGENNO_ORK_HERO = 1935;
	window.CARD_ID_MUGENNO_TAO_GUNKA = 1936;
	window.CARD_ID_PHAROS_DUMMY = 1937;
	window.CARD_ID_ENCHANT_SAITAN = 1938;
	window.CARD_ID_ENCHANT_FUKUTSU = 1939;
	window.CARD_ID_ENCHANT_REFLECT_PHYSICAL_SHORT_5P = 1940;
	window.CARD_ID_FUINSARETA_ATLOS = 1941;
	window.CARD_ID_FUINSARETA_TIME_HOLDER = 1942;
	window.CARD_ID_FUINSARETA_DOPPELGANGER = 1943;
	window.CARD_ID_FUINSARETA_DRAKE = 1944;
	window.CARD_ID_FUINSARETA_BAPHOMET = 1945;
	window.CARD_ID_FUINSARETA_FURIONI = 1946;
	window.CARD_ID_FUINSARETA_ZYOO_SUCARAB = 1947;
	window.CARD_ID_FUINSARETA_MAKENSHI_THANATOSNO_SHINENTAI = 1948;
	window.CARD_ID_FUINSARETA_ORC_HERO = 1949;
	window.CARD_ID_FUINSARETA_ZYOTE_SUCARAB = 1950;
	window.CARD_ID_FUINSARETA_MISTRESS = 1951;
	window.CARD_ID_FUINSARETA_ORCLORD = 1952;
	window.CARD_ID_FUINSARETA_GROOM_UNDERNIGHT = 1953;
	window.CARD_ID_FUINSARETA_OSEN_SARETA_DARK_LORD = 1954;
	window.CARD_ID_FUINSARETA_AMENHOTEP = 1955;
	window.CARD_ID_FUINSARETA_INISHIENO_TAOGUNKA = 1956;
	window.CARD_ID_FUINSARETA_KAKUSEI_KUTORURANUCKS = 1957;
	window.CARD_ID_FUINSARETA_SHINKAINO_KRAKEN = 1958;
	window.CARD_ID_FUINSARETA_MAYA = 1959;
	window.CARD_ID_FUINSARETA_BOMI = 1960;
	window.CARD_ID_FUINSARETA_IGNISEM_CENIA_MVP = 1961;
	window.CARD_ID_FUINSARETA_EDDGA = 1962;
	window.CARD_ID_FUINSARETA_IKARINO_UORUYAFA = 1963;
	window.CARD_ID_FUINSARETA_INISHIENO_WOOTANG_GUARD = 1964;
	window.CARD_ID_FUINSARETA_OSEN_SARETA_BURINARANEA = 1965;
	window.CARD_ID_FUINSARETA_OCHITA_DAISHINKAN_HIBAMU = 1966;
	window.CARD_ID_FUINSARETA_KAGAYAKU_BEARDOLL = 1967;
	window.CARD_ID_FUINSARETA_KOKA_MUSPERKOLE = 1968;
	window.CARD_ID_FUINSARETA_KONTONNO_BAPHOMET = 1969;
	window.CARD_ID_FUINSARETA_FUKITSUNA_TURTLE_G = 1970;
	window.CARD_ID_FUINSARETA_EFREET = 1971;
	window.CARD_ID_FUINSARETA_VERSEVV = 1972;
	window.CARD_ID_FUINSARETA_OSIRIS = 1973;
	window.CARD_ID_FUINSARETA_IKARINO_DRACULA = 1974;
	window.CARD_ID_ENCHANT_EIYUNO_GAIKA = 1975;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FFF_JITTER_BUG = 1976;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_S_J_EARNEST_WOLF = 1977;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_AMDARAIS = 1978;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_OSEN_SARETA_DARK_LORD = 1979;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_OSEN_SARETA_BURINARANEA = 1980;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_KISHI_SAKRAY = 1981;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_KOKA_MUSPERKOLE = 1982;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_SASOINO_MAGAN = 1983;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_SATSURIKUNO_MAGAN = 1984;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_SARANO_GENEI = 1985;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_SHINIGAMI_ANKOU = 1986;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_ZYUSATSUNO_AMDARAIS = 1987;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_ZYUSATSUNO_HIMERMEZ = 1988;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_ZYOO_FACEWORM = 1989;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_ZETSUBONO_KAMI_MOROCC = 1990;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_DARAKUNO_MAGAN = 1991;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_NYDHOGNO_KAGE = 1992;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_NOROIWO_NOMIKONDA_O = 1993;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_BIJOU = 1994;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FENRIR = 1995;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_BOSOSHITA_SENCHO_PERLOCK = 1996;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_MAKENSHI_THANATOSNO_SHINENTAI = 1997;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_MAGANNO_AMDARAIS = 1998;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_MAZINNO_KYOEI = 1999;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_MORS_NECROMANCER = 2000;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FUINSARETA_OSEN_SARETA_DARK_LORD = 2001;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FUINSARETA_OSEN_SARETA_BURINARANEA = 2002;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FUINSARETA_KOKA_MUSPERKOLE = 2003;
	window.CARD_SET_ID_ENCHANT_EIYUNO_GAIKA_FUINSARETA_MAKENSHI_THANATOSNO_SHINENTAI = 2004;
	window.CARD_ID_ENCHANT_KIGENNO_O = 2005;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_WORUYAFA = 2006;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_EDDGA = 2007;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_ORC_HERO = 2008;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_ORCLORD = 2009;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_OSIRIS = 2010;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_DOPPELGANGER = 2011;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_DRAKE = 2012;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_BAPHOMET = 2013;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FURIONI = 2014;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_MAYA = 2015;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_MISTRESS = 2016;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_WORUYAFA = 2017;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_EDDGA = 2018;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_ORC_HERO = 2019;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_ORCLORD = 2020;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_OSIRIS = 2021;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_DOPPELGANGER = 2022;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_DRAKE = 2023;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_BAPHOMET = 2024;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_FURIONI = 2025;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_MAYA = 2026;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_FUINSARETA_MISTRESS = 2027;
	window.CARD_ID_ENCHANT_HOZYONO_MEGAMI = 2028;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_ATLOS = 2029;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_EFREET = 2030;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_VERSEVV = 2031;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_OCHITA_DAISHINKAN_HIBAMU = 2032;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_OCHITA_DAISHINKAN_HIBAM_ENCHANT_BOSOSHITA_MARYOKU = 2033;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_KTULLANUX = 2034;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_GROOM_UNDERNIGHT = 2035;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_ATLOS = 2036;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_EFREET = 2037;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_VERSEVV = 2038;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_OCHITA_DAISHINKAN_HIBAMU = 2039;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_OCHITA_DAISHINKAN_HIBAM_ENCHANT_BOSOSHITA_MARYOKU = 2040;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_KTULLANUX = 2041;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_FUINSARETA_GROOM_UNDERNIGHT = 2042;
	window.CARD_ID_ENCHANT_YAKUSAINO_MASHO = 2043;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_AMENHOTEP = 2044;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_IKARINO_UORUYAFA = 2045;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_IKARINO_DRACULA = 2046;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_INISHIENO_WOOTANG_GUARD = 2047;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_INISHIENO_TAOGUNKA = 2048;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_KAGAYAKU_BEARDOLL = 2049;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_KAKUSEI_KUTORURANUCKS = 2050;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_KYORANSHITA_BOKENSHA = 2051;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_KONTONNO_ACOLYTE = 2052;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_KONTONNO_BAPHOMET = 2053;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_ZYOO_SUCARAB = 2054;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_ZYOTE_SUCARAB = 2055;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_SHINKAINO_KRAKEN = 2056;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_SHINKAINO_DEVIAS = 2057;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_SHINRINO_MAHOTSUKAI = 2058;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_TIME_HOLDER = 2059;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_TAMASHINO_HAHEN = 2060;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUKITSUNA_SOLID_TURTLE = 2061;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUKITSUNA_TURTLE_G = 2062;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_BOMI = 2063;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_AMENHOTEP = 2064;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_IKARINO_UORUYAFA = 2065;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_IKARINO_DRACULA = 2066;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_INISHIENO_WOOTANG_GUARD = 2067;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_INISHIENO_TAOGUNKA = 2068;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_KAKUSEI_KUTORURANUCKS = 2069;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_KAGAYAKU_BEARDOLL = 2070;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_KONTONNO_BAPHOMET = 2071;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_SHINKAINO_KRAKEN = 2072;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_ZYOO_SUCARAB = 2073;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_ZYOTE_SUCARAB = 2074;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_TIME_HOLDER = 2075;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_FUKITSUNA_TURTLE_G = 2076;
	window.CARD_SET_ID_ENCHANT_YAKUSAINO_MASHO_FUINSARETA_BOMI = 2077;
	window.CARD_SET_ID_ENCHANT_SATSUINO_ONNEN_FUINSARETA_IGNISEM_CENIA_MVP = 2078;
	window.CARD_ID_ENCHANT_RESIST_WATER = 2079;
	window.CARD_ID_ENCHANT_RESIST_EARTH = 2080;
	window.CARD_ID_ENCHANT_RESIST_FIRE = 2081;
	window.CARD_ID_ENCHANT_RESIST_WIND = 2082;
	window.CARD_ID_ENCHANT_RESIST_POISON = 2083;
	window.CARD_ID_ENCHANT_RESIST_SAINT = 2084;
	window.CARD_ID_ENCHANT_RESIST_DARKNESS = 2085;
	window.CARD_ID_ENCHANT_RESIST_TELEKINESIS = 2086;
	window.CARD_ID_ENCHANT_RESIST_UNDEAD = 2087;
	window.CARD_ID_ENCHANT_RISETO_KIOKUNO_ZANSHI = 2088;
	window.CARD_SET_ID_ENCHANT_RISETO_KIOKUNO_ZANSHI_SHINEN_ARMS_V1 = 2089;
	window.CARD_SET_ID_ENCHANT_RISETO_KIOKUNO_ZANSHI_SHINEN_ARMS_V2 = 2090;
	window.CARD_SET_ID_ENCHANT_RISETO_KIOKUNO_ZANSHI_SHINEN_ARMS_V3 = 2091;
	window.CARD_SET_ID_ENCHANT_RISETO_KIOKUNO_ZANSHI_SATSUINO_ONNEN = 2092;
	window.CARD_ID_ENCHANT_KYOFU_TAISE = 2093;
	window.CARD_ID_ENCHANT_KONRAN_TAISE = 2094;
	window.CARD_ID_ENCHANT_SUIMIN_TAISE = 2095;
	window.CARD_ID_ENCHANT_KIND_DUMMY_ANNIVERSARY_19 = 2096;
	window.CARD_ID_ENCHANT_KIND_DUMMY_BATTLE_COLOSSEUM_TEST_SEASON_2 = 2097;
	window.CARD_ID_ENCHANT_KYOKUGENNO_MARYOKU = 2098;
	window.CARD_SET_ID_ENCHANT_KYOKUGENNO_MARYOKU_KAKUSE_EIKOWO_TATAESHI_OKEN = 2099;
	window.CARD_SET_ID_ENCHANT_KYOKUGENNO_MARYOKU_KAKUSE_HAMETSUWO_MATOISHI_GOKEN = 2100;
	window.CARD_SET_ID_ENCHANT_KYOKUGENNO_MARYOKU_KAKUSE_KONO_SOZIN = 2101;
	window.CARD_SET_ID_FUINSARETA_OCHITA_DAISHINKAN_HIBAM_ENCHANT_BOSOSHITA_MARYOKU = 2102;
	window.CARD_ID_ENCHANT_KIND_DUMMY_SHINKIRO = 2103;
	window.CARD_ID_ENCHANT_KIND_DUMMY_SEKAIZYUNO_HANA = 2104;
	window.CARD_ID_AGNES_LUGENBURG_SIGNED = 2105;
	window.CARD_ID_POE_RICHARD_SIGNED = 2106;
	window.CARD_ID_ISAAC_WIGNER_SIGNED = 2107;
	window.CARD_ID_NIHIL_MISERIA_HEINE = 2108;
	window.CARD_ID_AGNES_LUGENBURG = 2109;
	window.CARD_ID_JURGEN_WIGNER = 2110;
	window.CARD_ID_SPICA_NERIUS = 2111;
	window.CARD_ID_KRONECKER_GRANZ_HEINE = 2112;
	window.CARD_ID_SKIA_NERIUS = 2113;
	window.CARD_ID_WOLF_LUGENBURG = 2114;
	window.CARD_ID_POE_RICHARD = 2115;
	window.CARD_ID_KATHRYN_WIGNER = 2116;
	window.CARD_ID_ISSAC_WIGNER = 2117;
	window.CARD_ID_MEYER = 2118;
	window.CARD_ID_MEYER_LUGENBURG = 2119;
	window.CARD_ID_HELMUT = 2120;
	window.CARD_ID_HELMUT_LUGENBURG = 2121;
	window.CARD_ID_ENCHANT_CHOETSU = 2122;
	window.CARD_ID_ENCHANT_OKENO_EIKO = 2123;
	window.CARD_ID_ENCHANT_KIND_DUMMY_CHOETSU = 2124;
	window.CARD_ID_ENCHANT_KIND_DUMMY_SEASON_KYUTE_MZYUTSUSHI = 2125;
	window.CARD_ID_ENCHANT_IDOSOKUDO_ZOKA = 2126;
	window.CARD_ID_ENCHANT_KIKO_LV2 = 2127;
	window.CARD_ID_ENCHANT_HASAI = 2128;
	window.CARD_SET_ID_ENCHANT_HASAI_STR_10 = 2129;
	window.CARD_ID_ENCHANT_MAZIN = 2130;
	window.CARD_SET_ID_ENCHANT_MAZIN_INT_10 = 2131;
	window.CARD_ID_MAZIMENA_ANDRE = 2132;
	window.CARD_ID_MAZIMENA_DENIRO = 2133;
	window.CARD_ID_MAZIMENA_HETAI_ANDRE = 2134;
	window.CARD_ID_DOKYONOARU_GAIAS = 2135;
	window.CARD_ID_MAZIMENA_PIERE = 2136;
	window.CARD_ID_GUNYAGUNYASHITA_ARINO_TAMAGO = 2137;
	window.CARD_ID_DOKYONOARU_FAMILIER = 2138;
	window.CARD_ID_MAZIMENA_BITATA = 2139;
	window.CARD_SET_ID_MAZIMENA_BITATA_ENCHANT_YAKUSAINO_MASHO = 2140;
	window.CARD_ID_MAZIMENA_ANDRENO_YOCHU = 2141;
	window.CARD_SET_ID_MAZIMENA_ANDRENO_YOCHU_GUNYAGUNYASHITA_ARINO_TAMAGO = 2142;
	window.CARD_ID_MUKUCHINA_MAYA = 2143;
	window.CARD_SET_ID_MUKUCHINA_MAYA_ENCHANT_YAKUSAINO_MASHO = 2144;
	window.CARD_ID_ENCHANT_KOTEIEISHO_70 = 2145;
	window.CARD_ID_ENCHANT_MAGNUM_BREAK_LV5 = 2146;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_CRAZY_WEED = 2147;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_ARROW_STORM = 2148;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_JUDEX = 2149;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_SEVERE_RAINSTORM = 2150;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_MANGETSU_KYAKU = 2151;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_OTORO = 2152;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_ESHA = 2153;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_SAVAGENO_TAMASHI = 2154;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_SISIKO = 2155;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_SUMMON_VENTOS = 2156;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_ARMS_CANNON = 2157;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_JACK_FROST = 2158;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_IGNITION_BREAK = 2159;
	window.CARD_ID_ENCHANT_U_POWER_ARMOR = 2160;
	window.CARD_SET_ID_ENCHANT_U_POWER_ARMOR_ENCHANT_Q_BOSS_NORMAL_PLAYER = 2161;
	window.CARD_ID_ENCHANT_U_POWER_LEG = 2162;
	window.CARD_SET_ID_ENCHANT_U_POWER_LEG_ENCHANT_Q_BOSS_NORMAL_PLAYER = 2163;
	window.CARD_ID_ENCHANT_U_POWER_SHIELD = 2164;
	window.CARD_SET_ID_ENCHANT_U_POWER_SHIELD_ENCHANT_Q_BOSS_NORMAL_PLAYER = 2165;
	window.CARD_ID_ENCHANT_U_POWER_WING = 2166;
	window.CARD_SET_ID_ENCHANT_U_POWER_WING_ENCHANT_Q_BOSS_NORMAL_PLAYER = 2167;
	window.CARD_ID_ENCHANT_UNBREAKABLE_ARMOR = 2168;
	window.CARD_ID_ENCHANT_CAST_TIME_15 = 2169;
	window.CARD_ID_ENCHANT_ASPD_15 = 2170;
	window.CARD_ID_ENCHANT_EXAM = 2171;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_DARKNESS = 2172;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_FIRE = 2173;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_GROUND = 2174;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_POISON = 2175;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_SAINT = 2176;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_UNDEAD = 2177;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_WATER = 2178;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_E_WIND = 2179;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_G_SERIES = 2180;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_CONFUSE = 2181;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_CURSE = 2182;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_FEAR = 2183;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_IGNITION = 2184;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_PETRIFACTION = 2185;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_SILENCE = 2186;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_P_SLEEP = 2187;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_ATK = 2188;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_AVOID = 2189;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_CRI = 2190;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_FATAL_FLASH = 2191;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_FIRING_SHOT = 2192;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_LUCKY_STRIKE = 2193;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_MATK = 2194;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_MAXHP = 2195;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_OVER_POWER = 2196;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_QUICK = 2197;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_SPELL_BUSTER = 2198;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_S_UNLIMIT_VITAL = 2199;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_FATAL_FLASH = 2200;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_FIRING_SHOT = 2201;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_LUCKY_STRIKE = 2202;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_OVER_POWER = 2203;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_SPELL_BUSTER = 2204;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_X_UNLIMIT_VITAL = 2205;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_Z_CLAIRVOYANCE = 2206;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_Z_IMMORTAL = 2207;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_Z_KNOCKBACK = 2208;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_Z_NODISPELL = 2209;
	window.CARD_SET_ID_ENCHANT_EXAM_ENCHANT_Z_REINCARNATION = 2210;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_FIRE = 2211;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_WATER = 2212;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_WIND = 2213;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_EARTH = 2214;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_HOLY = 2215;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_DARK = 2216;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_PSYCO = 2217;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_POISON = 2218;
	window.CARD_ID_ENCHANT_ARMS_ELEMENT_UNDEAD = 2219;
	window.CARD_ID_ENCHANT_KOKUYOKUNO_SHITO = 2220;
	window.CARD_SET_ID_ENCHANT_KIGENNO_O_OGONCHU = 2221;
	window.CARD_ID_ENCHANT_ZODIAC = 2222;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_AXE = 2223;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_CROWN = 2224;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_MAIL = 2225;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_MANT = 2226;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_SHOES = 2227;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KYOKAIKYUNO_RING = 2228;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_SWORD = 2229;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_DIADEM = 2230;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_MAIL = 2231;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_MANT = 2232;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_SHOES = 2233;
	window.CARD_SET_ID_ENCHANT_ZODIAC_KINGYUKYUNO_RING = 2234;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_MACE = 2235;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_CROWN = 2236;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_MAIL = 2237;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_MANT = 2238;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_SHOES = 2239;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHISHIKYUNO_RING = 2240;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_DEVINE_CROSS = 2241;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_DIADEM = 2242;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_MAIL = 2243;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_MANT = 2244;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_SHOES = 2245;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SHOZYOKYUNO_RING = 2246;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_HUNTER_BOW = 2247;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_CROWN = 2248;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_MAIL = 2249;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_MANT = 2250;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_SHOES = 2251;
	window.CARD_SET_ID_ENCHANT_ZODIAC_ZINBAKYUNO_RING = 2252;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_STUFF_OF_SOUL = 2253;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_DIADEM = 2254;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_MAIL = 2255;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_MANT = 2256;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_SHOES = 2257;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOGYOKYUNO_RING = 2258;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_VIOLIN = 2259;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_ROPE = 2260;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_DIADEM = 2261;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_MAIL = 2262;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_MANT = 2263;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_SHOES = 2264;
	window.CARD_SET_ID_ENCHANT_ZODIAC_SOZIKYUNO_RING = 2265;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_KATAR = 2266;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_CROWN = 2267;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_MAIL = 2268;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_MANT = 2269;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_SHOES = 2270;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENKATSUKYUNO_RING = 2271;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_KRASNAYA = 2272;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_DIADEM = 2273;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_MAIL = 2274;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_MANT = 2275;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_SHOES = 2276;
	window.CARD_SET_ID_ENCHANT_ZODIAC_TENBINKYUNO_RING = 2277;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_SPEAR = 2278;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_CROWN = 2279;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_MAIL = 2280;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_MANT = 2281;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_SHOES = 2282;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_RING = 2283;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HAKUYOKYUNO_SHIELD = 2284;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_DAGGER = 2285;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_CROWN = 2286;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_ROBE = 2287;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_MANT = 2288;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_SHOES = 2289;
	window.CARD_SET_ID_ENCHANT_ZODIAC_PROCYON_RING = 2290;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_STUFF = 2291;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_CROWN = 2292;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_MAIL = 2293;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_MANT = 2294;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_SHOES = 2295;
	window.CARD_SET_ID_ENCHANT_ZODIAC_HOBINKYUNO_RING = 2296;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_BOOK = 2297;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_CROWN = 2298;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_ROBE = 2299;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_MANT = 2300;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_SHOES = 2301;
	window.CARD_SET_ID_ENCHANT_ZODIAC_POLLUX_RING = 2302;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_THIEF_BOW = 2303;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_DIADEM = 2304;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_MAIL = 2305;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_MANT = 2306;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_SHOES = 2307;
	window.CARD_SET_ID_ENCHANT_ZODIAC_MAKATSUKYUNO_RING = 2308;
	window.CARD_ID_ENCHANT_SEIZOKUSEI_TAISEI_5 = 2309;
	window.CARD_ID_ENCHANT_NENZOKUSEI_TAISEI_5 = 2310;
	window.CARD_ID_ENCHANT_IKYONO_TOKATSUSHA = 2311;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_STORM_KNIGHT = 2312;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_TURTLE_GENERAL = 2313;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_DRACULA = 2314;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_LORD_OF_DEATH = 2315;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_VESPER = 2316;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_KIEL_D01 = 2317;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_PHARAOH = 2318;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_RSX_0806 = 2319;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_DATAL_ZAURUS = 2320;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_HATI = 2321;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_AMON_RA = 2322;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_DARK_LORD = 2323;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_DARK_LORD = 2324;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_BOITATA = 2325;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_ONRYOBUSHI = 2326;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_PEKUSOZIN = 2327;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_KOKUDAO = 2328;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_GOPINICH = 2329;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_TAOGUNKA = 2330;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_BAKONAWA = 2331;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_BYONGUNGO = 2332;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_BUWAYA = 2333;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_REYAC = 2334;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_LADYTANIE = 2335;
	window.CARD_ID_FUINSARETA_RSX_0806 = 2336;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_RSX_0806 = 2337;
	window.CARD_ID_FUINSARETA_AMON_RA = 2338;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_AMON_RA = 2339;
	window.CARD_ID_FUINSARETA_VESPER = 2340;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_VESPER = 2341;
	window.CARD_ID_FUINSARETA_ONRYO_BUSHI = 2342;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_ONRYO_BUSHI = 2343;
	window.CARD_ID_FUINSARETA_KIEL_D_01 = 2344;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_KIEL_D_01 = 2345;
	window.CARD_SET_ID_R48_85_BESTIA_FUINSARETA_KIEL_D01 = 2346;
	window.CARD_ID_FUINSARETA_KOKUDAO = 2347;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_KOKUDAO = 2348;
	window.CARD_ID_FUINSARETA_GOPINICH = 2349;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_GOPINICH = 2350;
	window.CARD_ID_FUINSARETA_STORM_KNIGHT = 2351;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_STORM_KNIGHT = 2352;
	window.CARD_ID_FUINSARETA_TURTLE_GENERAL = 2353;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_TURTLE_GENERAL = 2354;
	window.CARD_ID_FUINSARETA_TAOGUNKA = 2355;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_TAOGUNKA = 2356;
	window.CARD_ID_FUINSARETA_DATAL_ZAURUS = 2357;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_DATAL_ZAURUS = 2358;
	window.CARD_ID_FUINSARETA_DRACULA = 2359;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_DRACULA = 2360;
	window.CARD_ID_FUINSARETA_HATI = 2361;
	window.CARD_SET_ID_HATI_BEBE_FUINSARETA_HATI = 2362;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_HATI = 2363;
	window.CARD_ID_FUINSARETA_PHARAOH = 2364;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_PHARAOH = 2365;
	window.CARD_ID_FUINSARETA_PEKUSOZIN = 2366;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_PEKUSOZIN = 2367;
	window.CARD_ID_FUINSARETA_BOITATA = 2368;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_BOITATA = 2369;
	window.CARD_ID_FUINSARETA_LADYTANIE = 2370;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_LADYTANIE = 2371;
	window.CARD_ID_FUINSARETA_REYAC = 2372;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_REYAC = 2373;
	window.CARD_ID_FUINSARETA_LORD_OF_DEATH = 2374;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_FUINSARETA_LORD_OF_DEATH = 2375;
	window.CARD_ID_ENCHANT_MIZU_ZOKUSEI_TAISEI_5 = 2376;
	window.CARD_ID_ENCHANT_CHI_ZOKUSEI_TAISEI_5 = 2377;
	window.CARD_ID_ENCHANT_HI_ZOKUSEI_TAISEI_5 = 2378;
	window.CARD_ID_ENCHANT_KAZE_ZOKUSEI_TAISEI_5 = 2379;
	window.CARD_ID_ENCHANT_DOKU_ZOKUSEI_TAISEI_5 = 2380;
	window.CARD_ID_ENCHANT_YAMI_ZOKUSEI_TAISEI_5 = 2381;
	window.CARD_ID_ENCHANT_FUSHI_ZOKUSEI_TAISEI_5 = 2382;
	window.CARD_ID_ENCHANT_ENERGY_COAT_LV1 = 2383;
	window.CARD_ID_ENCHANT_KANZYUKU = 2384;
	window.CARD_SET_ID_ENCHANT_KANZYUKU_KYOKUGENNO_MARYOKU = 2385;
	window.CARD_ID_MELORING = 2386;
	window.CARD_SET_ID_ENCHANT_KANZYUKU_MELORING = 2387;
	window.CARD_ID_DAMELORING = 2388;
	window.CARD_SET_ID_ENCHANT_KANZYUKU_DAMELORING = 2389;
	window.CARD_ID_ENCHANT_SENZAI_KAKUSE_BUNISHING_BASTER = 2390;
	window.CARD_ID_ENCHANT_ODINO_CHIKARA_LV2 = 2391;
	window.CARD_ID_SILVER_OSIDOS = 2392;
	window.CARD_ID_TOXIOUS = 2393;
	window.CARD_ID_NEO_MINERAL = 2394;
	window.CARD_ID_BLACK_OSIDOS = 2395;
	window.CARD_ID_BONE_PHEROS = 2396;
	window.CARD_ID_ARCH_PLASMA = 2397;
	window.CARD_ID_JEWGOLIANT = 2398;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_JEWGOLIANT = 2399;
	window.CARD_ID_TREASURE_MIMIC = 2400;
	window.CARD_ID_POISONOUS = 2401;
	window.CARD_ID_HOLY_SKOGUL = 2402;
	window.CARD_ID_HOLY_FRUS = 2403;
	window.CARD_ID_BONE_OSIDOS = 2404;
	window.CARD_ID_REGINLEIF = 2405;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_REGINLEIF = 2406;
	window.CARD_ID_ANGELGOLT = 2407;
	window.CARD_ID_JEWELIANT = 2408;
	window.CARD_ID_BONE_DETAL_ZAURUS = 2409;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_BONE_DETAL_ZAURUS = 2410;
	window.CARD_ID_ABYSS_MAN = 2411;
	window.CARD_ID_INGRID = 2412;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_INGRID = 2413;
	window.CARD_ID_SPECTRUM_PLASMA = 2414;
	window.CARD_ID_PURPLE_PHEROS = 2415;
	window.CARD_ID_WHITE_PORCELLIO = 2416;
	window.CARD_ID_ENCHANT_TENCHI_HOKAI = 2417;
	window.CARD_SET_ID_ENCHANT_TENCHI_HOKAI_MAKENSHI_THANATOSNO_SHINENTAI = 2418;
	window.CARD_SET_ID_ENCHANT_TENCHI_HOKAI_FUINSARETA_MAKENSHI_THANATOSNO_SHINENTAI = 2419;
	window.CARD_ID_ELDEST = 2420;
	window.CARD_ID_THANATOSNO_KIOKU_ENBO = 2421;
	window.CARD_ID_VOID_MIMIC = 2422;
	window.CARD_ID_HASONSHITA_THANATOSNO_KIOKU = 2423;
	window.CARD_SET_ID_HASONSHITA_THANATOSNO_KIOKU_ENCHANT_EIYUNO_GAIKA = 2424;
	window.CARD_SET_ID_ENCHANT_TENCHI_HOKAI_HASONSHITA_THANATOSNO_KIOKU = 2425;
	window.CARD_ID_BOOK_OF_DEATH = 2426;
	window.CARD_ID_THANATOSNO_KIOKU_KYOFU = 2427;
	window.CARD_ID_THANATOSNO_KIOKU_KOKAI = 2428;
	window.CARD_ID_THANATOSNO_KIOKU_FUNNU = 2429;
	window.CARD_ID_CROW_BARON = 2430;
	window.CARD_ID_CROW_DUKE = 2431;
	window.CARD_SET_ID_CROW_BARON_CROW_DUKE = 2432;
	window.CARD_ID_INORU_MONO = 2433;
	window.CARD_ID_KYOKANSURU_MONO = 2434;
	window.CARD_ID_KOFUKUWO_ATAERU_MONO = 2435;
	window.CARD_ID_HOHOEMU_MONO = 2436;
	window.CARD_ID_ENCHANT_CHISHIKINO_TANKYUSHA = 2437;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_CUTIE = 2438;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_CELINE_KIMI = 2439;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_EL_A17T = 2440;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_MIGUEL = 2441;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_RED_PEPPER_KAPPA = 2442;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_VENOM_CHEMERA = 2443;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_EABLE = 2444;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_SILVA_PAPIRIA = 2445;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_BOSS_PITAYA = 2446;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_SWEETY = 2447;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_CHARLESTON_3GO = 2448;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_R48_85_BESTIA = 2449;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_T_W_O = 2450;
	window.CARD_ID_ENCHANT_SKILL_ISHI_SOKUDO_ZOKA_LV10 = 2451;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_RANDGRIS = 2452;
	window.CARD_ID_R001_BESTIA = 2453;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_R001_BESTIA = 2454;
	window.CARD_ID_VENEDI = 2455;
	window.CARD_ID_GAN_CEANN = 2456;
	window.CARD_ID_KYORYOKUNA_MARYOKU = 2457;
	window.CARD_ID_GRAN_PAPILIA = 2458;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_GRAN_PAPILIA = 2459;
	window.CARD_ID_GROTE = 2460;
	window.CARD_ID_KOSHOSHITA_KEBIGATA_BETA = 2461;
	window.CARD_ID_KOSHOSHITA_ZIDO_OSOZIKI_OMEGA = 2462;
	window.CARD_ID_KOSHOSHITA_ZYOKYU_NIWASHI_BETA = 2463;
	window.CARD_ID_KOSHOSHITA_SESOGATA_BETA = 2464;
	window.CARD_ID_GHOST_CUBE = 2465;
	window.CARD_ID_SHINO_DAIMAZYO = 2466;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_SHINO_DAIMAZYO = 2467;
	window.CARD_ID_GIANT_CAPUT = 2468;
	window.CARD_ID_ZYOKYU_KENKYU_ZYOSHU_ZIDO_NINGYO = 2469;
	window.CARD_ID_ZYOKYU_TOKUSE_ALNOLDI = 2470;
	window.CARD_ID_ZYOKYU_DRY_RAFFLESIA = 2471;
	window.CARD_ID_ZYOKYU_PAPILA = 2472;
	window.CARD_ID_ZYOKYU_PAPILA_CAE = 2473;
	window.CARD_ID_ZYOKYU_PAPILA_RUBA = 2474;
	window.CARD_ID_SHINKAINO_MAZYO = 2475;
	window.CARD_ID_SURUDOI_MARYOKU = 2476;
	window.CARD_ID_SEIKINNO_HIME = 2477;
	window.CARD_ID_DISGUISER = 2478;
	window.CARD_ID_DEADRE = 2479;
	window.CARD_ID_DOLORIAN = 2480;
	window.CARD_ID_NETTO_SWORD_FISH = 2481;
	window.CARD_ID_NETTO_PIRANHA = 2482;
	window.CARD_ID_NETTO_PHEN = 2483;
	window.CARD_ID_NETTO_MARC = 2484;
	window.CARD_ID_PIERROT_ZOIST = 2485;
	window.CARD_ID_PLAGARION = 2486;
	window.CARD_ID_BRUTAL_MURDER = 2487;
	window.CARD_ID_BLUE_MOON_LOLIRURI = 2488;
	window.CARD_ID_MARYOKU_CHUDOKU_SANARE = 2489;
	window.CARD_ID_MARYOKU_CHUDOKU_PLAGA = 2490;
	window.CARD_ID_MEIKYUNO_VERSEVV = 2491;
	window.CARD_ID_LUDE_GAL = 2492;
	window.CARD_SET_ID_LUDE_GAL_GHOST_CUBE = 2493;
	window.CARD_ID_RED_PEPPER_LAMBDA = 2494;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_RED_PEPPER_LAMBDA = 2495;
	window.CARD_ID_YOKUZYO_KANRISHA_BETA = 2496;
	window.CARD_ID_ENCHANT_HYOKETSU_TAISE = 2497;
	window.CARD_ID_ENCHANT_REITO_TAISE = 2498;
	window.CARD_ID_ENCHANT_FUMETSUNARU_RIEKISHA = 2499;
	window.CARD_ID_ENCHANT_GENKAITOPPA = 2500;
	window.CARD_ID_ENCHANT_POW_3 = 2501;
	window.CARD_ID_ENCHANT_STA_3 = 2502;
	window.CARD_ID_ENCHANT_WIS_3 = 2503;
	window.CARD_ID_ENCHANT_SPL_3 = 2504;
	window.CARD_ID_ENCHANT_CON_3 = 2505;
	window.CARD_ID_ENCHANT_CRT_3 = 2506;
	window.CARD_ID_ENCHANT_ASPD_10P = 2507;
	window.CARD_ID_ENCHANT_DEF_300 = 2508;
	window.CARD_ID_ENCHANT_MDEF_30 = 2509;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ARCH_MAGE_1 = 2510;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ARCH_MAGE_1 = 2511;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ABYSS_CHASER_1 = 2512;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_ABYSS_CHASER_1 = 2513;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_INQUISITOR_1 = 2514;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_INQUISITOR_1 = 2515;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_IMPERIAL_GUARD_1 = 2516;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_IMPERIAL_GUARD_1 = 2517;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_WIND_HAWK_1 = 2518;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_WIND_HAWK_1 = 2519;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ELEMENTAL_MASTER_1 = 2520;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ELEMENTAL_MASTER_1 = 2521;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_CARDINAL_1 = 2522;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_CARDINAL_1 = 2523;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SHADOW_CROSS_1 = 2524;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_SHADOW_CROSS_1 = 2525;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_DRAGON_KNIGHT_1 = 2526;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_DRAGON_KNIGHT_1 = 2527;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_TROUBADOUR_1 = 2528;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_TROUBADOUR_1 = 2529;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_TROUVERE_1 = 2530;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_TROUVERE_1 = 2531;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_BIOLO_1 = 2532;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_BIOLO_1 = 2533;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_MEISTER_1 = 2534;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_MEISTER_1 = 2535;
	window.CARD_ID_ASHRING = 2536;
	window.CARD_ID_VALTY = 2537;
	window.CARD_ID_GRAY_WOLF = 2538;
	window.CARD_ID_VOLCARING = 2539;
	window.CARD_ID_PHANTOM_WOLF = 2540;
	window.CARD_ID_ASH_TODO = 2541;
	window.CARD_ID_FIRE_WIND_KITE = 2542;
	window.CARD_ID_SHIGERING = 2543;
	window.CARD_ID_SHURAN = 2544;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_SHURAN = 2545;
	window.CARD_ID_BURNING_FANG = 2546;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_BURNING_FANG = 2547;
	window.CARD_ID_RAKESON = 2548;
	window.CARD_ID_ASH_HOPPER = 2549;
	window.CARD_ID_DEMI_FREYA = 2550;
	window.CARD_SET_ID_ENCHANT_HOZYONO_MEGAMI_DEMI_FREYA = 2551;
	window.CARD_ID_HOT_MOL = 2552;
	window.CARD_ID_LAVA_TODO = 2553;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_CARDINAL_2 = 2554;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_CARDINAL_2 = 2555;
	window.CARD_ID_ENCHANT_DANGEKI = 2556;
	window.CARD_SET_ID_ENCHANT_DANGEKI_STR_7 = 2557;
	window.CARD_ID_ENCHANT_ZANMA = 2558;
	window.CARD_SET_ID_ENCHANT_DANGEKI_INT_7 = 2559;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_KAKUSE_SHIHAISHANO_ROBE = 2560;
	window.CARD_ID_CATHERINE_GAEBOLG_SIGNED = 2561;
	window.CARD_ID_FRIEDRICH_STOLZ_HEINE_SIGNED = 2562;
	window.CARD_ID_KRONECKER_GRANZ_HEINE_SIGNED = 2563;
	window.CARD_ID_CATHRINE = 2564;
	window.CARD_ID_CATHERINE_GAEBOLG = 2565;
	window.CARD_ID_FRIEDRICH = 2566;
	window.CARD_ID_FRIEDRICH_STOLZ_HEINE = 2567;
	window.CARD_ID_CRUX = 2568;
	window.CARD_ID_CRUX_FINDEL = 2569;
	window.CARD_ID_ENCHANT_WOLF_ORB_STR_7 = 2570;
	window.CARD_ID_ENCHANT_WOLF_ORB_AGI_7 = 2571;
	window.CARD_ID_ENCHANT_WOLF_ORB_VIT_7 = 2572;
	window.CARD_ID_ENCHANT_WOLF_ORB_INT_7 = 2573;
	window.CARD_ID_ENCHANT_WOLF_ORB_DEX_7 = 2574;
	window.CARD_ID_ENCHANT_WOLF_ORB_LUK_7 = 2575;
	window.CARD_ID_ENCHANT_WOLF_ORB_POW_3 = 2576;
	window.CARD_ID_ENCHANT_WOLF_ORB_STA_3 = 2577;
	window.CARD_ID_ENCHANT_WOLF_ORB_WIS_3 = 2578;
	window.CARD_ID_ENCHANT_WOLF_ORB_SPL_3 = 2579;
	window.CARD_ID_ENCHANT_WOLF_ORB_CON_3 = 2580;
	window.CARD_ID_ENCHANT_WOLF_ORB_CRT_3 = 2581;
	window.CARD_ID_ENCHANT_WOLF_ORB_DEF_300 = 2582;
	window.CARD_ID_ENCHANT_WOLF_ORB_MDEF_30 = 2583;
	window.CARD_ID_ENCHANT_WOLF_ORB_LUCKY_25 = 2584;
	window.CARD_ID_ENCHANT_WOLF_ORB_ASPD_10P = 2585;
	window.CARD_ID_ENCHANT_WOLF_ORB_CAST_TIME_15 = 2586;
	window.CARD_ID_ENCHANT_WOLF_ORB_SKILL_DELAY_15 = 2587;
	window.CARD_ID_ENCHANT_WOLF_ORB_PHYSICAL_DAMAGE_20 = 2588;
	window.CARD_ID_ENCHANT_WOLF_ORB_MAGICAL_DAMAGE_20 = 2589;
	window.CARD_ID_ENCHANT_WOLF_ORB_IGNORE_DEF_50 = 2590;
	window.CARD_ID_ENCHANT_WOLF_ORB_IGNORE_MDEF_50 = 2591;
	window.CARD_ID_ENCHANT_WOLF_ORB_UNINTERRUPTABLE = 2592;
	window.CARD_ID_ENCHANT_WOLF_ORB_CAST_FIXED_50 = 2593;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ARCH_MAGE_2 = 2594;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ARCH_MAGE_2 = 2595;
	window.CARD_ID_ENCHANT_CRI_25 = 2596;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_DRAGON_KNIGHT_2 = 2597;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_DRAGON_KNIGHT_2 = 2598;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_BIOLO_2 = 2599;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_BIOLO_2 = 2600;
	window.CARD_ID_ENCHANT_ANKOKU_TAISE = 2601;
	window.CARD_ID_ENCHANT_SHUKKETSU_TAISE = 2602;
	window.CARD_ID_ENCHANT_CHINMOKU_TAISE = 2603;
	window.CARD_ID_ENCHANT_DOKU_TAISE = 2604;
	window.CARD_ID_ENCHANT_HAKKA_TAISE = 2605;
	window.CARD_ID_ENCHANT_NOROI_TAISE = 2606;
	window.CARD_ID_KUSATTA_KI = 2607;
	window.CARD_ID_GRAVE_WORM = 2608;
	window.CARD_ID_BRAIN_SUCKER = 2609;
	window.CARD_ID_MOSQUIRO = 2610;
	window.CARD_ID_YOKAISHITA_PORING = 2611;
	window.CARD_ID_ETAINO_SHIRENAI_SEMETAI = 2612;
	window.CARD_SET_ID_ETAINO_SHIRENAI_SEMETAI_ENCHANT_EIYUNO_GAIKA = 2613;
	window.CARD_ID_HENI_CHIMERA_AMITERA = 2614;
	window.CARD_ID_HENI_CHIMERA_LITUS = 2615;
	window.CARD_ID_HENI_CHIMERA_FILLIA = 2616;
	window.CARD_ID_HENI_CHIMERA_VANILAQUS = 2617;
	window.CARD_ID_HENI_CHIMERA_LAVA = 2618;
	window.CARD_ID_HENI_CHIMERA_FULGOR = 2619;
	window.CARD_ID_HENI_CHIMERA_NAPEO = 2620;
	window.CARD_ID_HENI_CHIMERA_GALENSIS = 2621;
	window.CARD_ID_HENI_CHIMERA_THE_ONE = 2622;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_HENI_CHIMERA_THE_ONE = 2623;
	window.CARD_ID_MAYONAKANO_ARCHI = 2624;
	window.CARD_ID_MAYONAKANO_ANEMOS = 2625;
	window.CARD_ID_MAYONAKANO_KANEIRY = 2626;
	window.CARD_ID_MAYONAKANO_COSRLEASE = 2627;
	window.CARD_ID_MAYONAKANO_SNIKI = 2628;
	window.CARD_ID_MAYONAKANO_FEMON = 2629;
	window.CARD_ID_MAYONAKANO_OLDOR = 2630;
	window.CARD_ID_MAYONAKANO_HAZE = 2631;
	window.CARD_ID_MAYONAKANO_KUROMA = 2632;
	window.CARD_ID_MAYONAKANO_IFODOS = 2633;
	window.CARD_ID_MAYONAKANO_YUMEHIME = 2634;
	window.CARD_ID_MAYONAKANO_RECHENIER = 2635;
	window.CARD_ID_MAYONAKANO_JEW = 2636;
	window.CARD_ID_MAYONAKANO_KANABIAN = 2637;
	window.CARD_ID_MAYONAKANO_D_Y = 2638;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ELEMENTAL_MASTER_2 = 2639;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ELEMENTAL_MASTER_2 = 2640;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_CARDINAL_3 = 2641;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_CARDINAL_3 = 2642;
	window.CARD_ID_ENCHANT_YUENNARU_TENZYONO_MIYAKO = 2643;
	window.CARD_SET_ID_ENCHANT_YUENNARU_TENZYONO_MIYAKO_KOO_GLOZA = 2644;
	window.CARD_SET_ID_ENCHANT_YUENNARU_TENZYONO_MIYAKO_SHINSONO_KOO_GLOZA = 2645;
	window.CARD_ID_ENCHANT_URUNO_KAGO = 2646;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_SHADOW_CROSS_2 = 2647;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_SHADOW_CROSS_2 = 2648;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ABYSS_CHASER_2 = 2649;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_ABYSS_CHASER_2 = 2650;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_WIND_HAWK_2 = 2651;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_WIND_HAWK_2 = 2652;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_IMPERIAL_GUARD_2 = 2653;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_IMPERIAL_GUARD_2 = 2654;
	window.CARD_ID_ENCHANT_AUTO_SPELL_CHAIN_LIGHTNING = 2655;
	window.CARD_ID_ENCHANT_MAKO = 2656;
	window.CARD_ID_ENCHANT_MAXSP_15P = 2657;
	window.CARD_ID_ENCHANT_ZOFUKUSARETA_ENBO = 2658;
	window.CARD_SET_ID_ENCHANT_ZOFUKUSARETA_ENBO_SHINEN_ARMS_V1 = 2659;
	window.CARD_SET_ID_ENCHANT_ZOFUKUSARETA_ENBO_SHINEN_ARMS_V2 = 2660;
	window.CARD_SET_ID_ENCHANT_ZOFUKUSARETA_ENBO_SHINEN_ARMS_V3 = 2661;
	window.CARD_ID_ENCHANT_INORINO_BANSHO = 2662;
	window.CARD_SET_ID_ENCHANT_INORINO_BANSHO_VIVATUS_ARMS_V1 = 2663;
	window.CARD_SET_ID_ENCHANT_INORINO_BANSHO_VIVATUS_ARMS_V2 = 2664;
	window.CARD_SET_ID_ENCHANT_INORINO_BANSHO_DEMI_FREYA = 2665;
	window.CARD_ID_ENCHANT_HYAKUSHA_KAICHU = 2666;
	window.CARD_ID_ENCHANT_SAISENO_HONO = 2667;
	window.CARD_ID_ENCHANT_SAIHATENO_SHIHAISHA = 2668;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_BIG_EGGRING = 2669;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_HENINO_COELACANTH = 2670;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_BOGYAKUNO_COELACANTH = 2671;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_ANKOKUNO_COELACANTH = 2672;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_IKEINO_COELACANTH = 2673;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_ENTVAIEN = 2674;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_TORYO_TAKO = 2675;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_NAHT_ZEEGAR = 2676;
	window.CARD_SET_ID_ENCHANT_SAIHATENO_SHIHAISHA_KRAKEN = 2677;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_DRAGON_KNIGHT_3 = 2678;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_DRAGON_KNIGHT_3 = 2679;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ARCH_MAGE_3 = 2680;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ARCH_MAGE_3 = 2681;
	window.CARD_ID_ENCHANT_MUNEN_MUSO = 2682;
	window.CARD_ID_AQUILA = 2683;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_AQUILA = 2684;
	window.CARD_ID_SAIKAKYU_RGAN = 2685;
	window.CARD_ID_SOGAN_DOLLOCARIS = 2686;
	window.CARD_ID_TANGAN_DOLLOCARIS = 2687;
	window.CARD_ID_CHUKYU_RGAN = 2688;
	window.CARD_ID_DOKUTSU_CALMARING = 2689;
	window.CARD_ID_DOKUTSU_FUTOKA = 2690;
	window.CARD_ID_HEART_HUNTER_AT = 2691;
	window.CARD_ID_CALMARING = 2692;
	window.CARD_ID_ULTRA_LIMACINA = 2693;
	window.CARD_SET_ID_ENCHANT_IKYONO_TOKATSUSHA_ULTRA_LIMACINA = 2694;
	window.CARD_ID_HAIKISARETA_GENSHI_RGAN = 2695;
	window.CARD_ID_HALLUCIGENIA = 2696;
	window.CARD_ID_HIKARU_WAKAME = 2697;
	window.CARD_ID_BABY_HALLUCIGENIA = 2698;
	window.CARD_ID_LIMACINA = 2699;
	window.CARD_ID_GENSHI_RGAN = 2700;
	window.CARD_ID_MAKIKOMARETA_CHUKYU_RGAN = 2701;
	window.CARD_ID_ICE_FUNAMUSHI = 2702;
	window.CARD_ID_S_JUNCEA = 2703;
	window.CARD_SET_ID_ENCHANT_CHISHIKINO_TANKYUSHA_S_JUNCEA = 2704;
	window.CARD_ID_HAIKISARETA_CHUKYU_RGAN = 2705;
	window.CARD_ID_KAIZOSARETA_ZYOKYU_RGAN = 2706;
	window.CARD_ID_ICE_STRAW = 2707;
	window.CARD_ID_KAKYU_RGAN = 2708;
	window.CARD_ID_FUTOKA = 2709;
	window.CARD_ID_ENCHANT_SEKKANO_MARYOKU_RENBU_1 = 2710;
	window.CARD_ID_ENCHANT_SEKKANO_MARYOKU_RENMA_1 = 2711;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_RUNE_KNIGHT_1 = 2712;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_ROYAL_GUARD_1 = 2713;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_ROYAL_GUARD_2 = 2714;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_MECHANIC_1 = 2715;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_MECHANIC_2 = 2716;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_GENETIC_1 = 2717;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_GUILLOTINE_CROSS_1 = 2718;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_SHADOW_CHASER_1 = 2719;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_SHADOW_CHASER_2 = 2720;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_WARLOCK_1 = 2721;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_SOURCERER_1 = 2722;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_ARC_BISHOP_1 = 2723;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_SHURA_1 = 2724;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_RANGER_1 = 2725;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_MINSTREL_WANDERER_1 = 2726;
	window.CARD_ID_ENCHANT_HYOKANO_MARYOKU_MINSTREL_WANDERER_2 = 2727;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ABYSS_CHASER_3 = 2728;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_ABYSS_CHASER_3 = 2729;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_WIND_HAWK_3 = 2730;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_WIND_HAWK_3 = 2731;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_CARDINAL_4 = 2732;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAIHO_CARDINAL_4 = 2733;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_CARDINAL_5 = 2734;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_CARDINAL_5 = 2735;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_BIOLO_3 = 2736;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_BIOLO_3 = 2737;
	window.CARD_ID_ENCHANT_SENARU_BOGO = 2738;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_INQUISITOR_2 = 2739;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_INQUISITOR_2 = 2740;
	window.CARD_ID_ENCHANT_SENZAI_KAIHO_ELEMENTAL_MASTER_3 = 2741;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_ELEMENTAL_MASTER_3 = 2742;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_SPELL_FIST_1 = 2756;
	window.CARD_SET_ID_ENCHANT_GOKETSU_OR_SHINRI_AND_INSPIRATION_1 = 2805;
	window.CARD_ID_EXTRA_JORKER = 2892;
	window.CARD_ID_GENERAL_ORK = 2916;
	window.CARD_ID_LOOKIE = 2957;
	window.CARD_ID_HIMITSU_NO_HANE_LEIZI = 2967;
	window.CARD_ID_SENZAI_KAIHOU_TENTEI_IV = 3071;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_SLUGSHOT = 3079;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAKUSEI_PSYCHIC_WAVE_2 = 3081;
	window.CARD_ID_HARD_ROCK_TITAN = 3125;
	window.CARD_ID_DEAD_SERA = 3127;
	window.CARD_ID_PUNCH_BUG = 3132;
	window.CARD_ID_ELITE_RGAN_HEALER = 3209;
	window.CARD_ID_JOR_MUNGANDR_GUARDIAN = 3210;
	window.CARD_ID_FAKE_IWIN_SOLDIERS = 3211;
	window.CARD_ID_ICEBEAR = 3220;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_GUILLOTINE_CROSS_3 = 3345;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAIHO_GENETIC_3 = 3349;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_HUNDRED_SPEAR = 3375;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_FEINT_BOMB = 3379;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_PINPOINT_ATTACK = 3381;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_COLD_THROWER = 3383;
	window.CARD_SET_ID_ENCHANT_SENZAI_KAKUSEI_DARK_CLAW = 3385;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_CRAZY_WEED = 3392;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_SHURA_SHINDAN = 3394;
	window.CARD_SET_ID_ENCHANT_SHINRINO_KAIHO_SENZAI_KAKUSEI_ESUFU = 3398;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_BAKURETSU_KUNAI = 3400;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_DRAGON_TAIL = 3402;
	window.CARD_SET_ID_ENCHANT_GOKETSU_SENZAI_KAKUSEI_TAROU_NO_KIZU = 3404;
	window.CARD_ID_COTNESS = 3428;
	window.CARD_ID_MEDJAY = 3700;
	window.CARD_ID_JACKONETTE = 3706;
	window.CARD_ID_SEA_WIND = 3742;
	window.CARD_ID_YORDOS_EXECUTOR = 3748;
	window.CARD_ID_INFINITE2_ECLIPSE = 4020;
	window.CARD_ID_VOLIMPET = 4152;
	window.CARD_ID_POLLUTED_SILK_FROG = 4155;
	window.CARD_ID_ENCROACHED_DIMIK = 4159;
	window.CARD_ID_NYAISE = 4160
	window.CARD_ID_SHADOW_JAILER = 4161;
	window.CARD_ID_BLOODY_SLASHER = 4174;
	window.CARD_ID_SHADIEST = 4175;
	window.CARD_ID_THE_CHIEF_KNIGHT_OF_ABYSS = 4178;
	...
	window.CARD_ID_MAX = CardObjNew.length;
	...
	*/
	...
	for (var i = 0; i < card_ordered_info.length; i++) {
