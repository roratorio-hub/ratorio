...
CardObjNew[4402] = [4402,100,0,"","",20064,2000,20063,2000,0];
...
CardObjNew[4420] = [4420,100,0,"","物理攻撃命中時、一定確率で敵にオートスペル[ワイルドウォーク]が習得Lvで発動",0];
...
CardObjNew[4446] = [4446,100,0,"","",20176,1000,20177,1000,0];
...
CardObjNew[4464] = [4464,100,0,"","",20292,100,20293,100,0];
	...
	CardObjNew[4465] = [4465,2,"傲慢な祈る者","オウマンナイノルモノ","",43,30,353,30,309,30,0];
	CardObjNew[4466] = [4466,2,"傲慢なヴォイドミミック","オウマンナヴォイドミミック","",57000000157,25,57000000152,25,45000000151,50,45000000153,50,0];
	CardObjNew[4467] = [4467,2,"傲慢な共感する者","オウマンナキョウカンスルモノ","",41,30,351,30,305,30,0];
	CardObjNew[4468] = [4468,2,"傲慢なクロウデューク","オウマンナクロウデューク","",341,5,342,5,346,5,348,5,349,5,500000000000000380n,1,0];
	CardObjNew[4469] = [4469,2,"傲慢なクロウバロン","オウマンナクロウバロン","兜上段に装備時、固定詠唱時間 - 70%",343,5,344,5,347,5,340,5,345,5,0];
	CardObjNew[4470] = [4470,2,"傲慢な幸福を与える者","オウマンナコウフクヲアタエルモノ","",42,30,352,30,304,30,0];
	CardObjNew[4471] = [4471,2,"傲慢なタナトス","オウマンナタナトス","",63,10,66,10,23,1,0];
	CardObjNew[4472] = [4472,100,0,"","",15,15,63,10,0];
	CardObjNew[4473] = [4473,100,0,"","物理攻撃命中時、一定確率で敵に与えたダメージの3%をSPとして吸収",210,10,25,10,0];
	CardObjNew[4474] = [4474,2,"傲慢なタナトスの憎悪","オウマンナタナトスノゾウオ","",16,15,62,15,68,15,381,1,0];
	CardObjNew[4475] = [4475,100,0,"","",151,50,0];
	CardObjNew[4476] = [4476,100,0,"","",151,50,0];
	CardObjNew[4477] = [4477,2,"傲慢な微笑む者","オウマンナホホエムモノ","",44,30,354,30,302,30,0];
	CardObjNew[4478] = [4478,4,"傲慢なタナトスの憤怒","オウマンナタナトスノフンヌ","",80,15,0];
	CardObjNew[4479] = [4479,100,0,"","",15,50,80,15,0];
	CardObjNew[4480] = [4480,100,0,"","",80,15,0];
	CardObjNew[4481] = [4481,4,"傲慢な暴走したタナトス","オウマンナボウソウシタタナトス","純粋なStrとIntとDexの合計が10上がる度に追加で物理・魔法攻撃時、念属性モンスターに与えるダメージ + 3%",0];
	CardObjNew[4482] = [4482,100,0,"","絶対に新毒状態にならない",0];
	CardObjNew[4483] = [4483,100,0,"","",15,50,67,50,0];
	CardObjNew[4484] = [4484,5,"傲慢なタナトスの怨望","オウマンナタナトスノエンボウ","",100211,3,100061,3,0];
	CardObjNew[4485] = [4485,100,0,"","",100061,7,0];
	CardObjNew[4486] = [4486,100,0,"","[スパイラルピアース]で受けるダメージ - 100%",60,35,0];
	CardObjNew[4487] = [4487,5,"傲慢なタナトスの恐怖","オウマンナタナトスノキョウフ","",100215,3,100065,3,0];
	CardObjNew[4488] = [4488,100,0,"","",100065,7,0];
	CardObjNew[4489] = [4489,100,0,"","[Mセルフディストラクション]で受けるダメージ - 100%",60,35,0];
	CardObjNew[4490] = [4490,5,"傲慢なタナトスの絶望","オウマンナタナトスノゼツボウ","",80,10,63,50,0];
	CardObjNew[4491] = [4491,100,0,"","物理攻撃命中時、一定確率で敵に与えたダメージの3%をHPとして吸収",63,50,0];
	CardObjNew[4492] = [4492,100,0,"","",74,15,0];
	CardObjNew[4493] = [4493,6,"傲慢なタナトスの悲しみ","オウマンナタナトスノカナシミ","",89,10,170,50,176,50,16,-50,0];
	CardObjNew[4494] = [4494,100,0,"","",89,10,220,152,0];
	CardObjNew[4495] = [4495,100,0,"","1秒毎にSP + 1%",0];
	CardObjNew[4496] = [4496,6,"傲慢なタナトスの苦悩","オウマンナタナトスノクノウ","",6376,25,6370,25,6382,25,0];
	CardObjNew[4497] = [4497,100,0,"","",344,30,0];
	CardObjNew[4498] = [4498,100,0,"","",0];
	CardObjNew[4499] = [4499,7,"傲慢なエルディスト","オウマンナエルディスト","",57000000157,10,57000000152,10,45000000157,15,45000000152,15,0];
	CardObjNew[4500] = [4500,7,"傲慢な監視する者","オウマンナカンシスルモノ","",80,2,89,2,65000000074,10,0];
	CardObjNew[4501] = [4501,7,"傲慢な執行する者","オウマンナシッコウスルモノ","",80,4,61000000086,15,0];
	CardObjNew[4502] = [4502,7,"傲慢なタナトスの後悔","オウマンナタナトスノコウカイ","物理・魔法攻撃命中時、一定確率で自分に発生している[狂乱]状態を解除する",16,15,89,15,0];
	CardObjNew[4503] = [4503,100,0,"","",298,50,0];
	CardObjNew[4504] = [4504,100,0,"","",156,100,0];
	CardObjNew[4505] = [4505,7,"傲慢な慰める者","オウマンナナグサメルモノ","",70,4,66000000010,30,0];
	CardObjNew[4506] = [4506,7,"傲慢なブックオブデス","オウマンナブックオブデス","",56000000155,10,56000000159,10,44000000155,15,44000000159,15,0];
	CardObjNew[4507] = [4507,7,"傲慢な保護する者","オウマンナホゴスルモノ","",89,4,64000000298,50,0];
