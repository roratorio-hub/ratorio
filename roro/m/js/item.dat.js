(function () {
	...
	// --- 2025-04-15 ---
	ItemObjNew[5415] = [5415,52,0,0,0,0,10,100,"ヴァンパイアストール","ヴァンパイアストール","",243,3,100000000000260,1,100000000000265,1,0];
	ItemObjNew[5416] = [5416,66,192,0,0,1,10,200,"オーバードライブランページエコーズ","オーバードライブランページエコーズ","物理・魔法攻撃命中時、一定確率で自分に発生している[リバウンド]状態を解除する",12,15,243,3,260,15,265,15,10000000000017,1,10000000000100,1,10000000000013,50,10000000000014,5,50000000000080,1,50000000000089,1,0];
	ItemObjNew[5417] = [5417,66,192,0,0,0,10,200,"コンセクレイト・フィデス・モニーレ","コンセクレイト・フィデス・モニーレ","物理・魔法攻撃命中時、一定確率で自分に発生している[狂乱]状態を解除する",12,15,243,3,10000000000017,1,10000000000100,1,10000000000013,50,10000000000014,5,50000000000080,1,50000000000089,1,0];
	ItemObjNew[5418] = [5418,100,0,0,0,0,0,0,0,0,"物理・魔法攻撃命中時、一定確率で自分に発生している[狂乱]状態を解除する",74,15,0];
	ItemObjNew[5419] = [5419,64,192,0,0,1,10,200,"ぱかぱかにゃんこのぽかぽかソックス","ぱかぱかにゃんこのぽかぽかソックス","",233,3,89,40,243,3,220,63,50000000005922,1,50000000005920,1,100000000006247,1,100000000006248,1,0];
	ItemObjNew[5420] = [5420,61,0,80,0,1,80,100,"イルシオンシールドIII","イルシオンシールドIII","",15,10,16,10,1000000000000060,5,300013,500,300014,50,0];
	ItemObjNew[5421] = [5421,61,0,80,0,1,80,100,"オートマティックシールドIII","オートマティックシールドIII","",15,15,16,15,4000000000000015,15,4000000000000016,15,100026,1,100267,1,100096,1,100268,1,0];
