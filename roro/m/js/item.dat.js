(function () {
	...
	ItemObjNew = [
		...
		[4231,62,0,40,2780,1,40,100,"フェアリーオブエデン","フエアリイオフエテン","精錬値が6以上の時、追加で絶対にノックバックしない<BR>精錬値が8以上の時、追加で[エナジーコート]Lv1習得時、Def + 300 , Mdef + 15<BR>装備解除時、[エナジーコート]を解除する",199,58,79,5,77,5,243,5,100012,1,100089,2,6000217,10,8000220,132,10000000000100068n,2,10000000010000214n,25,0],
		...
		[4528,100,0,0,0,0,0,0,0,0,"",19621,25000,10000000005613,2,10000000005610,2,219,2868,219,3394,0],	// グレース天地 + ノブレス
		...
		[4574,60,0,150,4030,1,100,90,"アラマズドの天恵","アラマストノテンケイ","精錬値が7以上の時、追加で、絶対にノックバックしない",19,15,194,1,12,10,31,40,37,40,272,40,47,40,49,40,171,40,177,40,273,40,357,40,359,40,100068,2,5000018,300,5000019,30,5000243,7,10000000000100030n,4,10000000000100036n,4,10000000000100038n,4,10000000000100039n,4,10000000000100170n,4,10000000000100176n,4,10000000000100178n,4,10000000000100179n,4,10000000010000046n,40,10000000010000040n,40,10000000010000045n,40,10000000010000048n,40,10000000010000356n,40,10000000010000350n,40,10000000010000355n,40,10000000010000358n,40,0],
		...
		[4679,61,0,60,0,0,30,100,"ブラックミスリルガード","フラツクミスリルカアト","精錬値が5以上の時、追加で、[フェイス]習得時、追加で、聖属性攻撃で受けるダメージ + 20%<BR>精錬値が7以上の時、追加で、絶対にノックバックしない",199,156,194,1,79,40,77,40,100015,3,100016,3,5000066,20,5000068,20,10000000000100019n,2,10000000010000066n,5,10000000010000068n,5,0],
	...
	ItemObjNew[5157] = [5157,999,0,40,2780,1,40,100,"[廃止][★1] フェアリーオブエデン","フエアリイオフエテン","精錬値が6以上の時、追加で絶対にノックバックしない<BR>精錬値が8以上の時、追加で[エナジーコート]Lv1習得時、Def + 300 , Mdef + 15<BR>装備解除時、[エナジーコート]を解除する",199,58,79,5,77,5,243,5,100012,1,100089,2,6000217,10,8000220,132,100068,2,10000214,25,0];
	...
	ItemObjNew[5212] = [5212,60,177,100,0,1,100,200,"がおがおタイガーパジャマ","カオカオタイカアハシヤマ","[がおがおタイガーパジャマ]の精錬値が7以上の時、絶対にノックバックしない",243,7,100000000006221,1,100000000006222,1,100000000006223,1,100260,7,7000012,10,9000194,1,9019936,45000,10000262,15,0];
	// --- 2024/06/04 サマーパッケ ---
	...
	ItemObjNew[5227] = [5227,60,177,100,0,1,100,200,"ふかふかフォーンローブ","フカフカフオオンロオフ","精錬値が7以上の時、絶対にノックバックしない",243,7,100000000006247,1,100000000006248,1,100265,7,7000012,10,9000194,1,9019923,2500,9019928,2500,10000269,15,0];
	...
	ItemObjNew[5241] = [5241,9,163,120, 2500004,1,240,220,"モカダスゼドガル","モカタスセトカル","精錬値が9以上の時、追加で魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,100,270,243,45,77,40,66,15,100089,10,7006059,25,7006057,25,7006053,25,7006066,25,10000233,20,0];
	...
	ItemObjNew[5264] = [5264,9,163,120,2600004,4,240,220,"フラッシュディテクトスタッフ","フラツシユテイテクトスタツフ","精錬値が10の時、追加で魔法攻撃命中時、一定確率で10秒間、地属性魔法攻撃で与えるダメージ + 50%",194,1,100,270,89,60,77,40,9531,4000,7005531,50,9005531,50,0];
	...
	ItemObjNew[5369] = [5369,100,0,0,0,0,0,0,0,0,"詠唱が中断されない",243,3,0];
	...
	ItemObjNew[5417] = [5417,66,192,0,0,0,10,200,"コンセクレイト・フィデス・モニーレ","コンセクレイトフイテスモニイレ","物理・魔法攻撃命中時、一定確率で自分に発生している[狂乱]状態を解除する",12,15,243,3,10000000000017,1,10000000000100,1,10000000000013,50,10000000000014,5,50000000000080,1,50000000000089,1,0];
	...
	ItemObjNew[5425] = [5425,60,0,15,0,1,30,250,"暴食のオルレアンの制服","ボウショクノオルレアンノセイフク","精錬値が7以上の時、詠唱が中断されない<br>精錬値が9以上の時、固定詠唱時間 - 70%",243,7,100261,4,100266,4,7000012,10,10000000000000079n,5,10000000000000077n,5,10000000010000065n,15,10000000010000262n,15,10000000010000269n,15,10000000000100261n,3,10000000000100266n,3,0];
	ItemObjNew[5426] = [5426,9,163,120,4,1,250,250,"暴食のスタッフオブディストラクション","ボウショクノスタッフオブディストラクション","",194,1,88,270,243,45,100000000006069,1,100000000006070,1,100000000006068,1,100000000006067,1,100266,3,10000000000000077n,40,10030000000005530n,1,10000000000100266n,7,10000000010000074n,30,10000000010000065n,25,0];
