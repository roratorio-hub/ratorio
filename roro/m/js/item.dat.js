(function () {
	...
	ItemObjNew[5047] = [5047,11,160,150,2400004,3,280,220,"ウィキッドカタール","ウイキツトカタアル","",88,250,80,110,7006022,10,7006014,10,9006022,15,9006014,15,10000230,20,0];
	...
	// --- 2024/08/28 ---
	ItemObjNew[5237] = [5237,2,165,150, 2500004,1,120,220,"モカダスサスィア","モカタスサスイア","精錬値が9以上の時、追加で魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",88,130,243,10,66,5,100089,10,7006096,25,7006093,25,10000233,20,0];
	ItemObjNew[5238] = [5238,1,166,120, 2500004,1,60,220,"モカダスタシリパティ","モカタスタシリハテイ","精錬値が9以上の時、追加で物理攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",88,120,243,10,66,5,100080,13,7006100,25,7006101,25,7006106,25,10000230,20,0];
	ItemObjNew[5239] = [5239,5,159,200, 2500004,1,350,220,"モカダスファンジラ","モカタスフアンシラ","精錬値が9以上の時、追加で物理攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",88,230,243,45,77,40,66,15,100080,13,7006008,25,7006010,25,10000230,20,0];
	ItemObjNew[5240] = [5240,6,164,180, 2500004,1,180,220,"モカダスタバル","モカタスタハル","精錬値が9以上の時、追加で物理攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,110,243,10,66,5,100080,13,7006237,25,7006238,25,10000230,20,0];
	...
	ItemObjNew[5243] = [5243,9,177,150, 2500004,1,40,220,"モカダスチャメン","モカタスチヤメン","精錬値が9以上の時、追加で魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,180,243,10,66,5,100089,10,7006247,25,7006248,25,10000233,20,0];
	ItemObjNew[5244] = [5244,9,161,60,  2500004,1,30,220,"モカダスバル","モカタスハル","精錬値が9以上の時、追加で魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,180,243,10,66,5,100089,10,7006028,25,7006033,25,7006039,25,10000233,20,0];
	...
	ItemObjNew[5250] = [5250,8,171,150, 2500004,1,150,220,"モカダスダワブラント","モカタスタワフラント","精錬値が9以上の時、追加で物理攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,110,243,10,66,5,100080,13,7006239,25,10000230,20,0];
	...
	ItemObjNew[5254] = [5254,12,172,120,2500004,1,80,220,"モカダスカグァズ","モカタスカクアス","精錬値が9以上の時、追加で物理攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,140,243,10,66,5,100080,13,7006175,25,7006176,25,7006177,25,7006178,25,7006179,25,7006180,25,10000230,20,0];
	ItemObjNew[5255] = [5255,12,170,120,2500004,1,80,220,"モカダスキテブ","モカタスキテフ","精錬値が9以上の時、追加で魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,88,140,243,10,66,5,100089,10,7006149,25,7006146,25,7006147,25,7006150,25,7006148,25,7006157,25,10000233,20,0];
	...
	ItemObjNew[5296] = [5296,3,159,280,4,1,340,220,"ディムグレイシアツーハンドソード","テイムクレイシアツウハントソオト","",88,230,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5297] = [5297,11,160,150,4,1,280,220,"ディムグレイシアカタール","テイムクレイシアカタアル","",88,250,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5298] = [5298,7,164,320,4,1,400,220,"ディムグレイシアツーハンドアックス","テイムクレイシアツウハントアツクス","",194,1,88,200,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5299] = [5299,5,159,200,4,1,350,220,"ディムグレイシアランス","テイムクレイシアランス","",88,230,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5300] = [5300,9,163,120,4,1,240,220,"ディムグレイシアスタッフ","テイムクレイシアスタツフ","",195,1,194,1,88,270,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5301] = [5301,16,174,150,4,1,150,220,"ディムグレイシア風魔手裏剣","テイムクレイシアフウマシユリケン","",194,1,88,160,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	ItemObjNew[5302] = [5302,10,76,160,4,1,90,220,"ディムグレイシアボウ","テイムクレイシアホウ","",88,170,243,40,100261,6,100266,3,10000000000000077n,40,10000000000100261n,7,10000000000100266n,7,10000000010000009n,100,10000000010000065n,25,0];
	...
	ItemObjNew[5308] = [5308,2,171,150,4,1,120,220,"ディムグレイシアソード","テイムクレイシアソオト","",88,130,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5309] = [5309,2,176,150,4,1,120,220,"ディムグレイシアベーシックソード","テイムクレイシアヘエシツクソオト","",88,130,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5310] = [5310,1,195,120,4,1,60,220,"ディムグレイシアナイフ","テイムクレイシアナイフ","",88,120,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5311] = [5311,1,174,120,4,1,60,220,"ディムグレイシアダガー","テイムクレイシアタカア","",88,120,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5312] = [5312,6,164,180,4,1,180,220,"ディムグレイシアアックス","テイムクレイシアアツクス","",194,1,88,110,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5313] = [5313,4,51,150,4,1,180,220,"ディムグレイシアスピア","テイムクレイシアスヒア","",88,110,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5314] = [5314,12,95,120,4,1,80,220,"ディムグレイシアブック","テイムクレイシアフツク","",194,1,88,140,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5315] = [5315,9,77,60,4,1,30,220,"ディムグレイシアワンド","テイムクレイシアワント","",194,1,88,180,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5316] = [5316,9,177,150,4,1,40,220,"ディムグレイシアフォックステイル","テイムクレイシアフオツクステイル","",194,1,88,180,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5317] = [5317,13,167,140,4,1,40,220,"ディムグレイシアナックル","テイムクレイシアナツクル","",88,100,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5318] = [5318,14,168,180,4,1,25,220,"ディムグレイシアバイオリン","テイムクレイシアハイオリン","",88,120,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5319] = [5319,15,169,150,4,1,50,220,"ディムグレイシアウィップ","テイムクレイシアウイツフ","",88,120,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];
	ItemObjNew[5320] = [5320,8,161,150,4,1,150,220,"ディムグレイシアメイス","テイムクレイシアメイス","",194,1,88,110,243,10,100261,6,100266,3,10000000000100261n,7,10000000000100266n,7,10000000010000009n,50,10000000010000065n,10,0];	
	// --- 2024/10/15 --- 
	...
	ItemObjNew[5488] = [5488,63,0,15,0,1,50,100,"マギアヴィタ","マギアヴィタ","精錬値が10以上の時、固定詠唱時間 - 80%",19,15,194,1,79,5,77,5,243,10,100217,3,7000074,15,7000080,15,7000089,15,9000074,25,9000080,25,9000089,25,10000260,15,10000265,15,0];
	ItemObjNew[5489] = [5489,100,0,0,0,0,0,0,0,0,"",15,40,80,30,89,30,0];
	ItemObjNew[5490] = [5490,62,0,38,0,1,40,100,"グラットンサーベラス","グラットンサーベラス","精錬値が9以上の時、追加で<br>　物理攻撃命中時、一定確率で敵に与えたダメージの5%をSPとして吸収<br>　物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる",194,1,79,5,77,5,243,5,100015,2,100016,2,67,7,7000217,10,7000262,10,7000269,10,9000262,15,9000269,15,0];
