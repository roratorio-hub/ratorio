(function () {
	...
	ItemObjNew = [
		...
		[4823,1,166,120,4,1,60,200,"不治の魔剣","フシノマケン","精錬値が8以上の時、追加で、[アビス球体攻撃]で与えるダメージ + 25%（※計算機未対応）<BR>精錬値が10の時、追加で、魔法攻撃命中時、一定確率で10秒間、無属性魔法攻撃で与えるダメージ + 50%",88,120,194,1,197,3,243,10,8107,100,8105,100,100097,10,100098,10,100099,10,8006107,25,8006105,25,8006308,25,0],
		...
		[4908,50,192,10,0,1,50,200,"ヤマネコニット帽(白)","ヤマネコニツトホウシロ","",230,3,243,13,79,20,77,20,80,40,100000000006100,1,100000000006101,1,100000000006106,1,100000000006305,1,100000000006306,1,100230,1,10000086,25,10000074,20,0],
	...
	ItemObjNew[5193] = [5193,50,166,10,0,1,50,200,"時間のサークレット(アビスチェイサー)","シカンノサアクレツトアヒスチエイサア","精錬値が7以上の時、<br>[トライアングルショット]使用時、一定確率で20秒間、[アンリミット]Lv5状態になる<br>装備解除時、[アンリミット]を解除する",194,1,79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,9000217,10,100000009006102,1,100000009006109,1,100000009006305,1,100000009006306,1,10000234,20,10000010,25,0];
	...
	ItemObjNew[5434] = [5434,50,166,10,0,1,50,200,"暴食のクラウン(アビスチェイサー)","ボウショクノクラウンアビスチェイサー","",194,1,79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,7011596,100,9000217,10,100000009006103,1,100000009006107,1,100000009006105,1,100000009006308,1,0];
	...
	// --- 2025-05-13 ---
	ItemObjNew[5454] = [5454,50,192,10,0,1,50,200,"濃紺のイビルドルイド帽","ノウコンノイビルドルイドボウ","",233,3,243,13,79,20,77,20,89,40,100000000006103,1,100000000006107,1,100000000006105,1,100000000006308,1,100233,1,10000074,20,10000298,50,0];
