(function () {
	...
	// --- 2025-12-16 ---
	ItemObjNew[5613] = [5613,64,0,0,0,1,10,100,"覇王のアミュレット","覇王のアミュレット","[エルヴィラキャンディ]、[エルヴィラキャンディ(YE)]のいずれかを使用時、[オールステータスダウン]状態を回復する",12,15,243,3,10000000000017,1,10000000000100,1,10000000000015,50,10000000000016,5,50000000000080,1,50000000000089,1,0];
	...
	ItemObjNew[5619] = [5619,100,0,0,0,0,0,0,0,0,"武器の精錬値が1上がる度に追加で一部のダメージを反射する効果で受けるダメージ - 10%",0];
