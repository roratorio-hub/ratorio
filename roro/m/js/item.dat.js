(function () {
	...
	ItemObjNew[5193] = [5193,50,166,10,0,1,50,200,"時間のサークレット(アビスチェイサー)","シカンノサアクレツトアヒスチエイサア","[トライアングルショット]使用時、一定確率で20秒間、[アンリミット]Lv5状態になる<br>装備解除時、[アンリミット]を解除する",194,1,79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,9000217,10,100000009006102,1,100000009006109,1,0];
