(function () {
	...
	// --- 2025/04/09 ---
	ItemObjNew[5409] = [5409,77,192,0,0,0,0,200,"エンペリウムアーマー","エンヘリウムアーマー","",194,1,100013,200,7000013,500,8000013,500,9000013,1000,10000013,1000,0];
	ItemObjNew[5410] = [5410,72,192,0,0,0,0,200,"エンペリウムウェポン","エンヘリウムウエホン","",194,1,100017,10,100100,10,7000017,20,7000100,20,8000017,30,8000100,30,9000017,50,9000100,50,10000017,100,10000100,100,0];
	ItemObjNew[5411] = [5411,73,192,0,0,0,0,200,"エンペリウムシールド","エンヘリウムシールト","",194,1,100254,1,100255,1,7000254,5,7000255,5,8000254,10,8000255,10,9000254,10,9000255,10,10000254,15,10000255,15,0];
	ItemObjNew[5412] = [5412,80,192,0,0,0,0,200,"エンペリウムシューズ","エンヘリウムシユース","精錬値が1上がる度に追加で 一部の回復アイテムによるHP回復量 + 1%<br>精錬値が7以上の時、追加で 一部の回復アイテムによるHP回復量 + 2%<br>精錬値が8以上の時、追加で一部の回復アイテムによるHP回復量 + 3%<br>精錬値が9以上の時、追加で 一部の回復アイテムによるHP回復量 + 5%<br>精錬値が10の時、追加で 一部の回復アイテムによるHP回復量 + 5%",194,1,100092,1,7000092,2,8000092,3,9000092,5,10000092,5,0];
	ItemObjNew[5413] = [5413,82,192,0,0,0,0,200,"エンペリウムイヤリング","シヤドウエンヘリウムイヤリング","",194,1,100089,1,7000089,2,8000089,3,9000089,5,10000089,5,0];
	ItemObjNew[5414] = [5414,83,192,0,0,0,0,200,"エンペリウムペンダント","シヤドウエンヘリウムヘンタント","",194,1,100080,1,7000080,2,8000080,3,9000080,5,10000080,5,0];
