...
export const g_ItemIdArrayByKind = [];
...
ItemObjNew[5709] = [5709,50,171,10,0,1,50,200,"傲慢のエンジェリックヘルム(バイオロ)","ゴウマンノエンジェリックヘルム(バイオロ)","精錬値7以上の効果（クレイジーウィードの再使用待機時間減少）はグレースカルティベイションコート装備中かつ潜在覚醒(クレイジーウィードII)と豪傑のセット効果発動時には適用されない",79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,7019732,4500,7019737,5000,9000217,10,100000009006239,1,100000009006314,1,100000009006315,1,10000230,20,10000086,25,10000000000100262n,1,10000000000100269n,1,10000000010000015n,15,10000000010000065n,10,0];
...
ItemObjNew[5717] = [5717,50,167,10,0,1,50,200,"傲慢のエンジェリックヘルム(インクイジター)","ゴウマンノエンジェリックヘルム(インクイジター)","精錬値7以上の効果（潜龍昇天の再使用待機時間減少）はグレース天地スーツとノブレスオブリージュのセット効果発動時には適用されない",79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,7019621,25000,9000217,10,100000009006113,1,100000009006123,1,100000009006124,1,100000009006302,1,10000230,20,10000086,25,10000000000100262n,1,10000000000100269n,1,10000000010000015n,15,10000000010000065n,10,0];
...
ItemObjNew[5719] = [5719,50,163,10,0,1,50,200,"傲慢のエンジェリックヘルム(アークメイジ)","ゴウマンノエンジェリックヘルム(アークメイジ)","精錬値7以上の効果（テレキネシスインテンスの固定詠唱・再使用待機時間減少）は装備解除時にテレキネシスインテンスが解除される",79,20,77,20,243,13,100262,4,100269,4,7000015,10,7000016,10,7011798,100,7019798,185000,9000217,10,100000009006064,1,100000009006069,1,100000009006056,1,100000009006070,1,100000009006063,1,100000009006068,1,100000009006060,1,100000009006067,1,10000233,20,10000298,50,10000000000100262n,1,10000000000100269n,1,10000000010000015n,15,10000000010000065n,10,0];
