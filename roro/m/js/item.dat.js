(function () {
	...
	ItemObjNew = [
		...
		[2376,10,2054,160,4,1,150,130,"嵐の弓","アラシノ","",25,30,19642,2000,19753,2000,23642,-15,23753,-15,0],
		...
		[3139,50,0,0,1160,1,10,130,"古代龍の宝冠","コタイリユウノホウカン","精錬値が1上がる度に追加で、恐怖に対する耐性 + 10%、魔法攻撃で与えるダメージ + 1%、詠唱時間 - 1%<BR>精錬値が7以上の時、追加で[サイキックウェーブ]で与えるダメージ + 15%<BR>精錬値が9以上の時、追加で[サイキックウェーブ]で与えるダメージ + 15%<BR>精錬値が10の時、純粋なIntとDexの合計が10上がる度に追加でInt + 1 , Dex + 1、ソーサラーが装備時、[ガンバンテイン]Lv1使用可能",19,15,7019662,1000,9019662,1000,0],
		...
		[3285,100,0,0,0,0,0,0,0,0,"「スカラバハイヒール」の精錬値が7以上の時、追加で「シビアレインストーム」の再使用待機時間-2秒。<BR>「スカラバハイヒール」の精錬値が7以上、「エルヴンボウ」の精錬値が8以上の時、追加で物理攻撃時、ボスモンスターに与えるダメージ+20%、「シビアレインストーム」で与えるダメージ+8%。<BR>「スカラバハイヒール」の精錬値が7以上、「エルヴンボウ」の精錬値が10の時、追加で物理攻撃時、ボスモンスターに与えるダメージ+30%、「シビアレインストーム」で与えるダメージ+12%。",0],
		...
		[3310,50,0,18,2370,0,100,100,"悪魔の手","アクマノテ","詠唱が中断されない。<BR>精錬値が7以上の時、追加で攻撃速度+5%、「獅子吼」で与えるダメージ+30%。<BR>精錬値が9以上の時、追加で攻撃速度+5%、「獅子吼」で与えるダメージ+50%。<BR>精錬値が10の時、追加で全ての種族のDef100%無視。<BR>「雷光弾」Lv5習得時、追加で「気功」、「金剛」、「獅子吼」、「練気功」の詠唱時間-50%。<BR>「地雷震」Lv5習得時、追加で「獅子吼」の再使用待機時間-9.5秒。<BR>「爆気散弾」Lv5習得時、追加で物理攻撃時、ボスモンスターに与えるダメージ+50%。",19,15,199,623,199,611,199,612,12,10,5622,20,11622,100,0],
		...
		[3627,64,0,0,3220,0,10,1,"獅子宮のリング","シシキユウノリンク","",14,100,80,5,12,5,23610,2,19629,1500,5500000000012,5,5500000000080,5,5500000005610,50,0],
		...
		[3677,63,0,25,3040,0,40,1,"天蝎宮のシューズ","テンカツキユウノシユウス","",19,5,17,50,12,10,15,10,16,10,4800000000017,80,4800000000009,50,4800000000015,10,4800000000016,10,4800000005474,500,4800008019461,1500,0],
		...
		[3978,50,0,18,2390,0,100,100,"ジャスパーサークレット","シヤスハアサアクレツト","ルーンナイトがルーンストーンスキルを発動時、追加でルーンストーンスキルの効果が強化される。または自分自身に対して様々な効果が付与される。<BR>[ジャスパーサークレット]を装備時、攻城戦・新攻城戦・攻城戦TEの砦内・PvP・ターボトラックでは[ベルカナストーン]の追加効果は発揮されず、解除されます<BR>[イグニッションブレイク]Lv5習得時、追加で物理攻撃時、ボスモンスターに与えるダメージ + 50%<BR>[デスバウンド]の習得Lvが1上がる度に、追加で全ての種族のDef 10%無視<BR>[ソニックウェーブ]Lv5習得時、追加で[イグニッションブレイク]の再使用待機時間 - 2.5秒<BR>装備解除時、ルーンストーンスキルの効果を解除する",199,445,199,441,199,440,19,15,12,10,5445,20,5440,20,7000012,5,7005445,30,7005440,30,9000012,5,9005445,50,9005440,50,10000086,50,0],
		...
		[4122,62,0,25,3130,1,30,100,"天魔外道の外套","テンマケトウノカイトウ","[地雷震]Lv5習得時、追加で[獅子吼]の再使用待機時間 - 0.2秒<BR>[爆気散弾]の習得Lvが1上がる度に、追加で[獅子吼]で与えるダメージ + 15%<BR>[雷光弾]の習得Lvが1上がる度に、追加で必中攻撃 + 4%",199,611,199,612,199,623,19,5,15,2,16,2,27,5,28,5,29,5,243,5,5000015,3,5000016,3,5000073,-5,7000015,5,7000016,5,7000073,-5,0],
		...
		[4124,63,0,12,2770,10,20,100,"再生の思念体シューズ","サイセイノシネンタイシユウス","",19,10,15,20,16,20,7264,100,7000012,10,7000074,15,9000012,10,9000074,15,0],
		...
		[4176,13,154,140,1100004,0,40,165,"イラフィースト","イラフイイスト","精錬値が10の時、追加で全てのモンスターに対し、サイズによる武器ダメージのペナルティが発生しない",88,100,194,1,80,110,7019612,9000,10000009005612,1,0],
		...
		[4266,100,0,0,0,0,0,0,0,0,"",5500000023612,130,5500000019612,500,0],
		...
		[4314,64,0,0,3700,1,40,100,"辰戌の腕輪","タツイヌノウテワ","[修羅身弾]Lv10習得時、追加で、物理攻撃時、小・中・大型モンスターに与えるダメージ + 10%<BR>[潜龍昇天]の習得Lvが1上がる度に追加で、MaxHP + 2% , MaxSP + 2%<BR>[点穴 -反-]の習得Lvが1上がる度に追加で、Agi + 4 , Flee + 10",199,613,199,621,199,627,2,7,80,10,10000000005610,2,0],
		...
		[4511,51,0,2,4040,10,30,100,"怨霊怪異の耳","オンリヨウカイイノミミ","詠唱が中断されない<BR>[地雷震]Lv5習得時、追加で、[獅子吼]の固定詠唱時間 - 100%、[獅子吼]の再使用待機時間 - 9.5秒<BR>[雷光弾]Lv5習得時、追加で、攻撃速度 + 15%",199,611,199,623,27,10,28,10,29,10,243,5,0],
		...
		[4521,100,0,0,0,0,0,0,0,0,"",19936,45000,19933,100,0],
		[4522,100,0,0,0,0,0,0,0,0,"",19835,200,10000000005835,3,0],
		...
		[4527,100,0,0,0,0,0,0,0,0,"",19977,500,20000000005968,1,20000000005969,1,20000000005977,1,0],
		[4528,100,0,0,0,0,0,0,0,0,"",19621,25000,10000000005613,2,10000000005610,2,0],
		[4529,100,0,0,0,0,0,0,0,0,"装備解除時、[テレキネシスインテンス]を解除する",19798,120000,30000000005527,1,30000000005518,1,0],
		[4530,100,0,0,0,0,0,0,0,0,"",220,176,108,10,0],
		[4531,100,0,0,0,0,0,0,0,0,"",19541,500,10000000005541,1,10000000005542,1,0],
		...
		[4570,51,0,2,4050,10,30,100,"アスモデウスの翼","アスモテウスノツハサ","[イグニッションブレイク]Lv5習得時、追加で、[リフレッシュ]の固定詠唱時間 - 100%、[イグニッションブレイク]の、再使用待機時間 - 2.5秒<BR>[ソニックウェーブ]Lv10習得時、追加で、必中攻撃 + 25%",199,445,199,440,27,10,28,10,29,10,243,5,154,100,0],
		...
		[4613,63,0,12,0,1,40,100,"エンドオブザワールド","エントオフサワアルト","[クロスインパクト]の習得Lvが1上がる度に追加で、[ハルシネーションウォーク]の再使用待機時間 - 5秒<BR>[クロスリッパースラッシャー]の習得Lvが1上がる度に追加で、物理攻撃で与えるダメージ + 10%<BR>[ハルシネーションウォーク]Lv5習得時、追加で、一般・ボスモンスターから受けるダメージ - 5%<BR>[ローリングカッター]の習得Lvが1上がる度に追加で、[カウンタースラッシュ]で与えるダメージ + 6%、[ローリングカッター]で与えるダメージ + 100%",199,460,199,475,199,473,199,474,19,10,15,3,16,3,243,10,5000015,7,5000016,7,5000074,10,7000015,10,7000016,10,7000074,10,0],
		...
		[4790,52,154,0,0,0,10,100,"サンクトゥス","サンクトウス","[修羅身弾]Lv10習得時、追加で、[爆気散弾]の再使用待機時間 - 0.2秒<BR>[潜龍昇天]Lv10習得時、追加で、物理攻撃時、小・中・大型モンスターに与えるダメージ + 15%",199,613,199,621,15,15,0],
		...
		[4954,2,171,150,3,1,120,220,"グレイシアソード","クレイシアソオト","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,130,243,10,100080,6,100089,3,0],
		[4955,4,51,150,3,1,180,220,"グレイシアスピア","クレイシアスヒア","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,110,243,10,100080,6,100089,3,0],
		[4956,6,164,180,3,1,180,220,"グレイシアアックス","クレイシアアツクス","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,110,243,10,100080,6,100089,3,0],
		[4957,9,77,60,3,1,30,220,"グレイシアワンド","クレイシアワント","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,180,243,10,100080,6,100089,3,0],
		[4958,11,160,150,3,1,280,220,"グレイシアカタール","クレイシアカタアル","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,250,243,40,100080,6,100089,3,0],
		[4959,1,166,120,3,1,60,220,"グレイシアナイフ","クレイシアナイフ","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,120,243,10,100080,6,100089,3,0],
		[4960,13,167,140,3,1,40,220,"グレイシアナックル","クレイシアナツクル","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,100,243,10,100080,6,100089,3,0],
		[4961,8,161,150,3,1,150,220,"グレイシアメイス","クレイシアメイス","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,110,243,10,100080,6,100089,3,0],
		[4962,10,76,160,3,1,90,220,"グレイシアボウ","クレイシアホウ","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,170,243,40,100080,6,100089,3,0],
		[4963,15,169,150,3,1,50,220,"グレイシアウィップ","クレイシアウイツフ","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,120,243,10,100080,6,100089,3,0],
		[4964,14,168,180,3,1,25,220,"グレイシアバイオリン","クレイシアハイオリン","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,120,243,10,100080,6,100089,3,0],
		[4965,12,95,120,3,1,80,220,"グレイシアブック","クレイシアフツク","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",88,140,243,10,100080,6,100089,3,0],
	...
	ItemObjNew[4995] = [4995,63,0,30,0,1,80,100,"トゥーサイドダイヤモンドブーツ","トウサイトタイヤモントフウツ","",194,1,19,15,79,5,77,5,243,10,100015,4,5000074,15,5000080,15,5000089,15,7000074,25,7000080,25,7000089,25,0];
	ItemObjNew[4996] = [4996,100,0,0,0,0,0,0,0,0,"",217,30,80,30,89,30,0]; // トゥーサイドダイヤモンドブーツ + 天地崩壊
	ItemObjNew[4997] = [4997,51,0,2,0,1,10,100,"偽神のイビルアイ","キシンノイヒルアイ","",194,1,10000000000017,1,10000000000100,1,0];
	ItemObjNew[4998] = [4998,100,0,0,0,0,0,0,0,0,"",243,5,66,5,68,5,0]; // 偽神のイビルアイ + 祈りの晩鐘
	ItemObjNew[4999] = [4999,52,0,0,0,0,10,100,"コズミックコネクション","コスミツクコネクシヨン","",194,1,27,15,28,15,29,15,97,15,98,15,99,15,0];
	ItemObjNew[5000] = [5000,100,0,0,0,0,0,0,0,"","詠唱が中断されない",217,10,243,3,0];	// コズミックコネクション + ゾディアック
	ItemObjNew[5001] = [5001,60,0,100,0,1,100,100,"スクリーミングゴーストパーティ","スクリイミンクコオストハアテイ","",194,1,79,5,77,5,243,7,100017,30,100100,30,7000012,10,7000261,15,7000266,15,9000261,25,9000266,25,9000086,25,0];
	ItemObjNew[5002] = [5002,100,0,0,0,0,0,0,"0","","",261,30,266,30,68,15,0];	// スクリーミングゴーストパーティ + 黒翼の使徒
	ItemObjNew[5003] = [5003,65,0,0,0,1,10,200,"星座の印章","セイサノインシヨウ","※計算機の仕様でLv250未満でも全特性ステータス上昇の効果が適用されています",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,236,10,0];
	ItemObjNew[5004] = [5004,65,0,0,0,1,10,200,"星座の印章(力)","セイサノインシヨウチカラ","※計算機の仕様で、純粋なPowが100未満でも必中攻撃+15%が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,86,15,0];
	ItemObjNew[5005] = [5005,65,0,0,0,1,10,200,"星座の印章(体力)","セイサノインシヨウタイリヨク","※計算機の仕様で、純粋なStaが100未満でもDef+300が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,18,300,0];
	ItemObjNew[5006] = [5006,65,0,0,0,1,10,200,"星座の印章(創造)","セイサノインシヨウソウソウ","※計算機の仕様で、純粋なCrtが100未満でもCri+50が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,10,50,0];
	ItemObjNew[5007] = [5007,65,0,0,0,1,10,200,"星座の印章(魔力)","セイサノインシヨウマリヨク","※計算機の仕様で、純粋なSplが100未満でもMdef100%無視が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,298,100,0];
	ItemObjNew[5008] = [5008,65,0,0,0,1,10,200,"星座の印章(聡明)","セイサノインシヨウソウメイ","※計算機の仕様で、純粋なWisが100未満でもMdef+50が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,19,50,0];
	ItemObjNew[5009] = [5009,65,0,0,0,1,10,200,"星座の印章(集中)","セイサノインシヨウシユウチウ","※計算機の仕様で、純粋なConが100未満でもディレイ-15%が適用されます",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,74,15,0];
	ItemObjNew[5010] = [5010,16,174,150,3,1,150,220,"グレイシア風魔手裏剣","クレイシアフウマシユリケン","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",194,1,100,160,243,40,100080,6,100089,3,0];
	ItemObjNew[5011] = [5011,17,175,70,3,1,35,220,"グレイシアハンドガン","クレイシアハントカン","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",194,1,243,40,100080,6,100089,3,0];
	ItemObjNew[5012] = [5012,2,176,150,3,1,120,220,"グレイシアベーシックソード","クレイシアヘエシツクソオト","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",194,1,100,130,243,10,100080,6,100089,3,0];
	ItemObjNew[5013] = [5013,9,177,150,3,1,40,220,"グレイシアフォックステイル","クレイシアフオツクステイル","超越段階が1以上の時、精錬値が1上がる度に追加で、物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%（計算機未対応）",194,1,100,180,243,10,100080,6,100089,3,0];
