(function () {
	...
	ItemObjNew[4999] = [4999,52,0,0,0,0,10,100,"コズミックコネクション","コスミツクコネクシヨン","[ゾディアック]と共に装備時、詠唱が中断されない",194,1,27,15,28,15,29,15,97,15,98,15,99,15,0];
	ItemObjNew[5000] = [5000,100,0,0,0,0,0,0,0,0,"",217,10,243,3,0];
	...
	ItemObjNew[5186] = [5186,100,0,0,0,0,0,0,0,0,"",97,15,98,15,99,15,27,15,28,15,29,15,0];	
	// --- 2024/04/16 ラグ缶 + GHC ---
	...
	ItemObjNew[5190] = [5190,66,192,0,0,0,10,200,"オーバードライブランページ","オオハアトライフランヘエシ","",194,1,12,15,243,3,97,15,98,15,99,15,27,15,28,15,29,15,50000000000089,1,50000000000080,1,0];
	...
	ItemObjNew[5211] = [5211,52,0,0,0,0,10,100,"ネコミミケープ(青)","ネコミミケエフアオ","",194,1,100000000000027,1,100000000000028,1,100000000000029,1,100000000000097,1,100000000000098,1,100000000000099,1,0];
	ItemObjNew[5212] = [5212,60,177,100,0,1,100,200,"がおがおタイガーパジャマ","カオカオタイカアハシヤマ","[がおがおタイガーパジャマ]の精錬値が7以上の時、絶対にノックバックしない",243,13,100000000006221,1,100000000006222,1,100000000006223,1,100027,7,100028,7,100029,7,7000012,10,9000194,1,9019936,45000,0];
