(function () {
	...
	ItemObjNew = [
		...
		[4989,50,192,10,0,1,50,200,"異端審問官のヴェール","イタンシンモンカンノウエエル","",230,3,243,13,79,20,77,20,80,40,100000000006113,1,100000000006124,1,100000000006123,1,100000000006302,1,100230,1,10000010,25,10000074,20,0],
	...
	ItemObjNew[5322] = [5322,50,192,10,0,1,50,200,"白い機械植物帽","シロイキカイシヨクフツホウ","",230,3,243,13,79,20,77,20,80,40,100000000006239,1,100000000006314,1,100000000006315,1,100230,1,10000086,25,10000074,20,0];
	...
	ItemObjNew[5540] = [5540,52,175,0,0,0,10,200,"名誉ある夜警のマント","名誉ある夜警のマント","",243,3,100000000000260,1,100000000000265,1,0];
	...
	// --- 2025-10-14 ---
	ItemObjNew[5550] = [5550,3,199,280,4,0,340,200,"セレスティアルツーハンドソード","セレスティアルツーハンドソード","",194,1,88,230,73,-100,77,40,243,45,100261,6,100266,3,10000000000000079n,40,10000000000100261n,7,10000000000100266n,7,10000000010000217n,10,0];
	ItemObjNew[5551] = [5551,100,0,0,0,0,0,0,0,0,"",15,15,77,10,220,23,0];
	ItemObjNew[5552] = [5552,20,175,120,4,0,250,200,"セレスティアルガトリングガン","セレスティアルガトリングガン","",194,1,73,-100,77,40,243,45,100261,6,100266,3,10000000000000079n,40,10000000000100261n,7,10000000000100266n,7,10000000010000217n,10,0];
	ItemObjNew[5553] = [5553,100,0,0,0,0,0,0,0,0,"",15,15,77,10,220,23,0];
	ItemObjNew[5554] = [5554,52,177,0,0,0,10,200,"あったかキジトラマフラー","あったかキジトラマフラー","",243,3,100000000000260,1,100000000000265,1,0];
	...
	ItemObjNew[5557] = [5557,60,194,100,0,1,100,200,"テオフィルス","テオフィルス","[シビアレインストーム]使用時、20秒間、[アンリミット]Lv5状態になる<br>装備解除時、[アンリミット]を解除する",243,7,100000000006132,1,100000000006131,1,100260,7,7000012,10,7000079,5,7000077,5,9000194,1,10000262,15,0];
