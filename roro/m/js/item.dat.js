(function () {
	...
	ItemObjNew[5004] = [5004,65,192,0,0,1,10,200,"星座の印章(力)","セイサノインシヨウチカラ","（計算機暫定実装）純粋なPowが100の時、追加で必中攻撃 + 15%",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,86,15,0];
	ItemObjNew[5005] = [5005,65,192,0,0,1,10,200,"星座の印章(体力)","セイサノインシヨウタイリヨク","（計算機暫定実装）純粋なStaが100の時、追加でDef + 300",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,18,300,0];
	ItemObjNew[5006] = [5006,65,192,0,0,1,10,200,"星座の印章(創造)","セイサノインシヨウソウソウ","（計算機暫定実装）純粋なCrtが100の時、追加でCri + 50",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,10,50,0];
	ItemObjNew[5007] = [5007,65,192,0,0,1,10,200,"星座の印章(魔力)","セイサノインシヨウマリヨク","（計算機暫定実装）純粋なCrtが100の時、追加で全ての種族のMdef 100%無視",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,298,100,0];
	ItemObjNew[5008] = [5008,65,192,0,0,1,10,200,"星座の印章(聡明)","セイサノインシヨウソウメイ","（計算機暫定実装）純粋なWisが100の時、追加でMdef + 50",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,19,50,0];
	ItemObjNew[5009] = [5009,65,192,0,0,1,10,200,"星座の印章(集中)","セイサノインシヨウシユウチユウ","（計算機暫定実装）純粋なWisが100の時、追加でスキルディレイ - 15%",194,1,12,10,80,10,89,10,243,3,100000000000262,1,100000000000269,1,74,15,0];
	ItemObjNew[5010] = [5010,16,174,150,3,1,150,220,"グレイシア風魔手裏剣","クレイシアフウマシユリケン","（計算機未実装）[グレイシア風魔手裏剣]の超越段階が1以上の時、精錬値が1上がる度に追加で物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%",100,160,194,1,243,40,100080,6,100089,3,0];
	ItemObjNew[5011] = [5011,100,0,0,0,0,0,0,0,0,"",293,100,298,100,10000000000017,1,10000000000100,1,0];
	ItemObjNew[5012] = [5012,17,175,70,3,1,35,220,"グレイシアハンドガン","クレイシアハントカン","（計算機未実装）[グレイシアハンドガン]の超越段階が1以上の時、精錬値が1上がる度に追加で物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%",243,40,100080,6,100089,3,0];
	ItemObjNew[5013] = [5013,100,0,0,0,0,0,0,0,0,"",293,100,298,100,10000000000017,1,10000000000100,1,0];
	ItemObjNew[5014] = [5014,2,176,150,3,1,120,220,"グレイシアベーシックソード","クレイシアヘエシツクソオト","（計算機未実装）[グレイシアベーシックソード]の超越段階が1以上の時、精錬値が1上がる度に追加で物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%",100,130,243,10,100080,6,100089,3,0];
	ItemObjNew[5015] = [5015,100,0,0,0,0,0,0,0,0,"",293,100,298,100,10000000000017,1,10000000000100,1,0];
	ItemObjNew[5016] = [5016,9,177,150,3,1,40,220,"グレイシアフォックステイル","クレイシアフオツクステイル","（計算機未実装）[グレイシアフォックステイル]の超越段階が1以上の時、精錬値が1上がる度に追加で物理・魔法攻撃時、全ての種族のモンスターに与えるダメージ + 7%",194,1,100,180,243,10,100080,6,100089,3,0];
	...
	ItemObjNew[5032] = [5032,64,192,0,0,1,10,200,"リングオブアルテミス","リンクオフアルテミス","",234,3,10,50,80,10,243,3,11497,100,100000000006051,1,100000000006047,1,0];
	...
	ItemObjNew[5038] = [5038,9,173,60,2400004,3,30,220,"ソリッドワンド","ソリツトワント","",100,180,89,60,7006197,10,7006198,10,7006199,10,7006200,10,7006201,10,7006202,10,9006197,15,9006198,15,9006199,15,9006200,15,9006201,15,9006202,15,10000233,20,0];
	...
	ItemObjNew[5040] = [5040,12,170,120,2400004,3,80,220,"ソリッドマニュアル","ソリツトマニユアル","",100,140,89,60,7006149,10,7006146,10,7006147,10,7006150,10,7006148,10,9006149,15,9006146,15,9006147,15,9006150,15,9006148,15,10000233,20,0];
	ItemObjNew[5041] = [5041,9,163,120,2400004,3,240,220,"ソリッドスタッフ","ソリツトスタツフ","",100,270,89,60,77,40,7006069,10,7006070,10,7006068,10,7006067,10,9006069,15,9006070,15,9006068,15,9006067,15,10000233,20,0];
	...
	ItemObjNew[5045] = [5045,12,172,120,2400004,3,80,220,"ウィキッドブック","ウイキツトフツク","",100,140,80,110,7006181,10,7006182,10,7006183,10,9006181,15,9006182,15,9006183,15,10000230,20,0];
	ItemObjNew[5046] = [5046,8,161,150,2400004,3,150,220,"ウィキッドクロス","ウイキツトクロス","",100,110,80,110,7006037,10,7006031,10,9006037,15,9006031,15,10000230,20,0];
	...
	ItemObjNew[5048] = [5048,7,164,320,2400004,3,400,220,"ウィキッドアックス","ウイキツトアツクス","",100,200,77,40,80,110,7006072,10,7006073,10,9006072,15,9006073,15,10000230,20,0];
	ItemObjNew[5049] = [5049,9,173,60,2400004,2,30,200,"フォーティファイドワンド","フオオテイフアイトワント","",100,180,89,60,7006197,10,7006198,10,7006199,10,7006200,10,7006201,10,7006202,10,9006197,15,9006198,15,9006199,15,9006200,15,9006201,15,9006202,15,10000233,20,0];
	ItemObjNew[5050] = [5050,12,172,120,2400004,2,80,200,"リラプスブック","リラフスフツク","",100,140,80,110,7006181,10,7006182,10,7006183,10,9006181,15,9006182,15,9006183,15,10000230,20,0];
})();
