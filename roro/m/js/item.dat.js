(function () {
	...
	ItemObjNew = [
		...
		[4268,60,201,120,3160,1,10,100,"インペリアルアニマルローブ","インヘリアルアニマルロオフ","[生命の魂]Lv1習得時、追加で[警戒]使用時、15秒間、物理攻撃時、全ての属性のモンスターに与えるダメージ + 20%、[猪突猛進]状態になる<BR>[警戒]の習得Lvが1上がる度に追加で、[タロウの傷]の固定詠唱時間 - 20%、[タロウの傷]の再使用待機時間 - 1秒<BR>[群れの力]の習得Lvが1上がる度に追加で、物理攻撃で与えるダメージ + 4%、必中攻撃 + 3%<BR>[サベージの魂]Lv5習得時、追加で、BaseLvが3上がる毎にMaxHP + 50、Atk + 1<BR>※[猪突猛進]状態でのダメージ増加については、暫定的に「性能カスタマイズ（スキル関連）」をご利用ください。<BR>　（○○スキルで攻撃時ダメージ上昇の設定欄を調整してください）<BR>　（効果は、『HPが1000上がる度に アニマル系スキルで与えるダメージ + 1%。<BR>　　ただし、HPは[猪突猛進]状態が付与された際の値を参照し、ダメージの増加は最大100%まで』です）",199,939,199,936,199,937,199,938,194,1,100012,1,0],
		[4269,60,201,120,3160,1,10,100,"グレースアニマルローブ","クレエスアニマルロオフ","[生命の魂]Lv1習得時、追加で[警戒]使用時、15秒間、物理攻撃時、全ての属性のモンスターに与えるダメージ + 50%、[猪突猛進]状態になる<BR>[警戒]の習得Lvが1上がる度に追加で、[タロウの傷]の固定詠唱時間 - 20%、[タロウの傷]の再使用待機時間 - 2.5秒<BR>[群れの力]の習得Lvが1上がる度に追加で、物理攻撃時、小・中・大型モンスターに与えるダメージ + 7%、必中攻撃 + 5%<BR>[サベージの魂]Lv5習得時、追加で、BaseLvが1上がる毎にMaxHP + 50、Atk + 1<BR>※[猪突猛進]状態でのダメージ増加については、暫定的に「性能カスタマイズ（スキル関連）」をご利用ください。<BR>　（○○スキルで攻撃時ダメージ上昇の設定欄を調整してください）<BR>　（効果は、『HPが1000上がる度に アニマル系スキルで与えるダメージ + 1%。<BR>　　ただし、HPは[猪突猛進]状態が付与された際の値を参照し、ダメージの増加は最大100%まで』です）",199,939,199,936,199,937,199,938,194,1,12,10,220,137,10000025,20,0],
		...
		[4455,51,0,2,4040,10,10,100,"もふもふラブリーフォックス","モフモフラフリイフオツクス","[警戒]の習得Lvが1上がる度に追加で、Vit + 5<BR>[生命の魂]Lv1習得時、追加で、[うずくまる]、[ニャンジャンプ]の詠唱時間 - 100%、[タロウの傷]使用時、15秒間、[猪突猛進]状態になる<BR>※[猪突猛進]状態でのダメージ増加については、暫定的に「性能カスタマイズ（スキル関連）」をご利用ください。<BR>　（○○スキルで攻撃時ダメージ上昇の設定欄を調整してください）<BR>　（効果は、『HPが1000上がる度に アニマル系スキルで与えるダメージ + 1%。<BR>　　ただし、HPは[猪突猛進]状態が付与された際の値を参照し、ダメージの増加は最大100%まで』です）",199,936,199,939,27,10,28,10,29,10,243,5,157,100,0],
	...
	ItemObjNew[5027] = [5027,9,173,60,4,1,30,200,"ウィワートゥス・フィデス・ソウルスティック","ウイワアトウスフイテススタアタストソウルステイツク","",194,1,100,180,100266,13,0];
	...
	ItemObjNew[5121] = [5121,9,173,60,4,1,30,200,"[★1] ウィワートゥス・フィデス・ソウルスティック","ウイワアトウスフイテススタアタストソウルステイツク","",194,1,100,180,100266,13,105968,5,105969,5,105977,5,10000015,15,10000066,10,0];
