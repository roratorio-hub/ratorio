(function () {
	...
	ItemObjNew[5643] = [5643,50,192,10,0,1,50,200,"青狐耳鈴リボン","青狐耳鈴リボン","",233,3,243,13,79,20,77,20,89,40,100000000006149,1,100000000006146,1,100000000006147,1,100000000006150,1,100000000006148,1,100000000006157,1,100000000006290,1,100233,1,10000074,20,10000298,50,10000000000000217n,10,10000000000000015n,10,10000000000000016n,10,10100000000006149n,1,10100000000006146n,1,10100000000006147n,1,10100000000006150n,1,10100000000006148n,1,10100000000006157n,1,10100000000006290n,1,10000000000100233n,1,10000000010000015n,15,10000000010000262n,15,10000000010000269n,15,0];
	ItemObjNew[5397] = [5397,62,192,38,0,1,40,200,"生命の循環：春","セイメイノシユンカイハル","精錬値が9以上の時、追加で<br>　物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる<br>超越段階が1以上の時、追加で物理・魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,79,5,77,5,243,5,43000000012,20,43000000074,25,100015,2,100016,2,100230,2,7000217,10,7000262,10,7000269,10,9000262,15,9000269,15,10000000000100230n,2,10000000010000015n,15,10000000010000260n,15,10000000010000265n,15,0];
	ItemObjNew[5398] = [5398,62,192,38,0,1,40,200,"生命の循環：夏","セイメイノシユンカイナツ","精錬値が9以上の時、追加で<br>　物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる<br>超越段階が1以上の時、追加で物理・魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,79,5,77,5,243,5,47000000012,20,47000000074,25,100015,2,100016,2,100234,2,7000217,10,7000262,10,7000269,10,9000262,15,9000269,15,10000000000100234n,2,10000000010000015n,15,10000000010000260n,15,10000000010000265n,15,0];
	ItemObjNew[5399] = [5399,62,192,38,0,1,40,200,"生命の循環：秋","セイメイノシユンカイアキ","精錬値が9以上の時、追加で<br>　物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる<br>超越段階が1以上の時、追加で物理・魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,79,5,77,5,243,5,46000000012,20,46000000074,25,100015,2,100016,2,100233,2,7000217,10,7000262,10,7000269,10,9000262,15,9000269,15,10000000000100233n,2,10000000010000015n,15,10000000010000260n,15,10000000010000265n,15,0];
	ItemObjNew[5400] = [5400,62,192,38,0,1,40,200,"生命の循環：冬","セイメイノシユンカイフユ","精錬値が9以上の時、追加で<br>　物理・魔法攻撃命中時、一定確率で10秒間、[神力]状態になる<br>超越段階が1以上の時、追加で物理・魔法攻撃命中時、一定確率で10秒間、1秒毎にHP + 10%",194,1,79,5,77,5,243,5,48000000012,20,48000000074,25,100015,2,100016,2,100235,2,7000217,10,7000262,10,7000269,10,9000262,15,9000269,15,10000000000100235n,2,10000000010000015n,15,10000000010000260n,15,10000000010000265n,15,0];
