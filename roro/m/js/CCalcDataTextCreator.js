...
import { EnumBattleDataIndex } from './const/EnumBattleDataIndex.js';
import { EnumCharaDataIndex } from './const/EnumCharaDataIndex.js';
import {
    EnumItemSpId, ITEM_SP_AGI_PLUS, ITEM_SP_AGI_PLUS_FOR_SET, ITEM_SP_ASPD_UP, ITEM_SP_AUTO_SPELL, ITEM_SP_AUTO_SPELL_HIDDEN_DETAIL,
    ITEM_SP_AUTO_SPELL_LEVEL_UNSPECIFIED, ITEM_SP_DEF_PLUS, ITEM_SP_DEF_UP, ITEM_SP_DEX_PLUS, ITEM_SP_DEX_PLUS_FOR_SET, ITEM_SP_FLEE_PLUS,
    ITEM_SP_HIT_PLUS, ITEM_SP_INT_PLUS, ITEM_SP_INT_PLUS_FOR_SET, ITEM_SP_LEARNED_SKILL_EFFECT, ITEM_SP_LEARN_SKILL, ITEM_SP_LEARN_SKILL_HIDDEN_DETAIL,
    ITEM_SP_LEARN_SKILL_LEVEL_UNSPECIFIED, ITEM_SP_LUK_PLUS, ITEM_SP_LUK_PLUS_FOR_SET, ITEM_SP_MAXHP_PLUS, ITEM_SP_MAXHP_UP, ITEM_SP_MAXSP_PLUS,
    ITEM_SP_MAXSP_UP, ITEM_SP_MDEF_PLUS, ITEM_SP_MDEF_UP, ITEM_SP_SKILL_CAST_TIME, ITEM_SP_STR_PLUS, ITEM_SP_STR_PLUS_FOR_SET,
    ITEM_SP_UNBREAKABLE, ITEM_SP_VIT_PLUS, ITEM_SP_VIT_PLUS_FOR_SET,
} from './const/EnumItemSpId.js';
import { EnumMonsterDataIndex, MONSTER_DATA_INDEX_COUNT } from './const/EnumMonsterDataIndex.js';
