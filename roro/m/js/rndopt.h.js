...
import './item.h.js';
import {
    ITEM_SP_AGI_PLUS, ITEM_SP_ALLSTATUS_PLUS, ITEM_SP_ALL_SPECS_PLUS, ITEM_SP_ASPD_PLUS, ITEM_SP_ASPD_UP, ITEM_SP_ATK_PLUS,
    ITEM_SP_CON_PLUS, ITEM_SP_COST_DOWN, ITEM_SP_CRITICAL_DAMAGE_UP, ITEM_SP_CRITICAL_UP_RACE_ANGEL, ITEM_SP_CRITICAL_UP_RACE_ANIMAL, ITEM_SP_CRITICAL_UP_RACE_DEMON,
    ITEM_SP_CRITICAL_UP_RACE_DRAGON, ITEM_SP_CRITICAL_UP_RACE_FISH, ITEM_SP_CRITICAL_UP_RACE_HUMAN, ITEM_SP_CRITICAL_UP_RACE_INSECT, ITEM_SP_CRITICAL_UP_RACE_PLANT, ITEM_SP_CRITICAL_UP_RACE_SOLID,
    ITEM_SP_CRITICAL_UP_RACE_UNDEAD, ITEM_SP_CRI_PLUS, ITEM_SP_CRT_PLUS, ITEM_SP_C_RATE_PLUS, ITEM_SP_DEF_PLUS, ITEM_SP_DEX_PLUS,
    ITEM_SP_FLEE_PLUS, ITEM_SP_HEAL_UP_USED, ITEM_SP_HEAL_UP_USING, ITEM_SP_HIT_PLUS, ITEM_SP_HPR_UP, ITEM_SP_H_PLUS_PLUS,
    ITEM_SP_IGNORE_DEF_BOSS, ITEM_SP_IGNORE_DEF_NOTBOSS, ITEM_SP_IGNORE_DEF_RACE_ANGEL, ITEM_SP_IGNORE_DEF_RACE_ANIMAL, ITEM_SP_IGNORE_DEF_RACE_DEMON, ITEM_SP_IGNORE_DEF_RACE_DRAGON,
    ITEM_SP_IGNORE_DEF_RACE_FISH, ITEM_SP_IGNORE_DEF_RACE_HUMAN, ITEM_SP_IGNORE_DEF_RACE_INSECT, ITEM_SP_IGNORE_DEF_RACE_PLANT, ITEM_SP_IGNORE_DEF_RACE_SOLID, ITEM_SP_IGNORE_DEF_RACE_UNDEAD,
    ITEM_SP_IGNORE_MDEF_BOSS, ITEM_SP_IGNORE_MDEF_NOTBOSS, ITEM_SP_IGNORE_MDEF_RACE_ANGEL, ITEM_SP_IGNORE_MDEF_RACE_ANIMAL, ITEM_SP_IGNORE_MDEF_RACE_DEMON, ITEM_SP_IGNORE_MDEF_RACE_DRAGON,
    ...
    ITEM_SP_INT_PLUS, ITEM_SP_LONGRANGE_DAMAGE_UP, ITEM_SP_LUCKY_PLUS, ITEM_SP_LUK_PLUS, ITEM_SP_MAGICAL_DAMAGE_UP_BOSS, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_DARK,
    ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_EARTH, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_FIRE, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_HOLY, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_POISON, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_PSYCO, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_UNDEAD,
    ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_VANITY, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_WATER, ITEM_SP_MAGICAL_DAMAGE_UP_MONSTER_ELM_WIND, ITEM_SP_MAGICAL_DAMAGE_UP_NOTBOSS, ITEM_SP_MAGICAL_DAMAGE_UP_PLAYER_ALL, ITEM_SP_MAGICAL_DAMAGE_UP_PLAYER_DORAM,
    ITEM_SP_MAGICAL_DAMAGE_UP_PLAYER_HUMAN, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_ANGEL, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_ANIMAL, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_DEMON, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_DRAGON, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_FISH,
    ITEM_SP_MAGICAL_DAMAGE_UP_RACE_HUMAN, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_HUMAN_NOT_PLAYER, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_INSECT, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_PLANT, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_SOLID, ITEM_SP_MAGICAL_DAMAGE_UP_RACE_UNDEAD,
    ITEM_SP_MAGICAL_DAMAGE_UP_SIZE_LARGE, ITEM_SP_MAGICAL_DAMAGE_UP_SIZE_MEDIUM, ITEM_SP_MAGICAL_DAMAGE_UP_SIZE_SMALL, ITEM_SP_MATK_PLUS_TYPE_NOT_WEAPON, ITEM_SP_MAXHP_PLUS, ITEM_SP_MAXHP_UP,
    ITEM_SP_MAXSP_PLUS, ITEM_SP_MAXSP_UP, ITEM_SP_MDEF_PLUS, ITEM_SP_MRES_PLUS, ITEM_SP_NONE, ITEM_SP_NOT_IMPLEMENTED,
    ITEM_SP_PHYSICAL_DAMAGE_UP_BOSS, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_DARK, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_EARTH, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_FIRE, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_HOLY, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_POISON,
    ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_PSYCO, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_UNDEAD, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_VANITY, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_WATER, ITEM_SP_PHYSICAL_DAMAGE_UP_MONSTER_ELM_WIND, ITEM_SP_PHYSICAL_DAMAGE_UP_NOTBOSS,
    ITEM_SP_PHYSICAL_DAMAGE_UP_PLAYER_ALL, ITEM_SP_PHYSICAL_DAMAGE_UP_PLAYER_DORAM, ITEM_SP_PHYSICAL_DAMAGE_UP_PLAYER_HUMAN, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_ANGEL, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_ANIMAL, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_DEMON,
    ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_DRAGON, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_FISH, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_HUMAN, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_HUMAN_NOT_PLAYER, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_INSECT, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_PLANT,
    ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_SOLID, ITEM_SP_PHYSICAL_DAMAGE_UP_RACE_UNDEAD, ITEM_SP_PHYSICAL_DAMAGE_UP_SIZE_LARGE, ITEM_SP_PHYSICAL_DAMAGE_UP_SIZE_MEDIUM, ITEM_SP_PHYSICAL_DAMAGE_UP_SIZE_SMALL, ITEM_SP_POW_PLUS,
    ITEM_SP_P_ATK_PLUS, ITEM_SP_RESIST_BOSS, ITEM_SP_RESIST_ELM_DARK, ITEM_SP_RESIST_ELM_EARTH, ITEM_SP_RESIST_ELM_FIRE, ITEM_SP_RESIST_ELM_HOLY,
    ...
    ITEM_SP_RESIST_LONGRANGE, ITEM_SP_RESIST_MONSTER_ELM_DARK, ITEM_SP_RESIST_MONSTER_ELM_EARTH, ITEM_SP_RESIST_MONSTER_ELM_FIRE, ITEM_SP_RESIST_MONSTER_ELM_HOLY, ITEM_SP_RESIST_MONSTER_ELM_POISON,
    ITEM_SP_RESIST_MONSTER_ELM_PSYCO, ITEM_SP_RESIST_MONSTER_ELM_UNDEAD, ITEM_SP_RESIST_MONSTER_ELM_VANITY, ITEM_SP_RESIST_MONSTER_ELM_WATER, ITEM_SP_RESIST_MONSTER_ELM_WIND, ITEM_SP_RESIST_NOTBOSS,
    ITEM_SP_RESIST_PLAYER_ALL, ITEM_SP_RESIST_PLAYER_DORAM, ITEM_SP_RESIST_PLAYER_HUMAN, ITEM_SP_RESIST_RACE_ANGEL, ITEM_SP_RESIST_RACE_ANIMAL, ITEM_SP_RESIST_RACE_DEMON,
    ITEM_SP_RESIST_RACE_DRAGON, ITEM_SP_RESIST_RACE_FISH, ITEM_SP_RESIST_RACE_HUMAN, ITEM_SP_RESIST_RACE_INSECT, ITEM_SP_RESIST_RACE_PLANT, ITEM_SP_RESIST_RACE_SOLID,
    ITEM_SP_RESIST_RACE_UNDEAD, ITEM_SP_RESIST_SIZE_LARGE, ITEM_SP_RESIST_SIZE_MEDIUM, ITEM_SP_RESIST_SIZE_SMALL, ITEM_SP_RES_PLUS, ITEM_SP_SIZE_PERFECTION,
    ITEM_SP_SKILL_CAST_TIME, ITEM_SP_SKILL_DELAY_DOWN, ITEM_SP_SPL_PLUS, ITEM_SP_SPR_UP, ITEM_SP_STA_PLUS, ITEM_SP_STR_PLUS,
    ITEM_SP_S_MATK_PLUS, ITEM_SP_UNBREAKABLE, ITEM_SP_USE_ENCHANT_ELM_CONF, ITEM_SP_VIT_PLUS, ITEM_SP_WIS_PLUS,
