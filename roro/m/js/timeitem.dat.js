...
(function () {
	...
	ITEM_SP_TIME_OBJ[301] = [301,"潜在解放(アークメイジXII)","固定詠唱短縮(クライマックス系列AP回復スキル)",[[2,3479]],14069,500,14070,500,14068,500,14067,500,0];
	ITEM_SP_TIME_OBJ_SORT.push(301);
	ITEM_SP_TIME_OBJ[302] = [302,"潜在解放(アークメイジXIV)","消費SP軽減(クライマックス系列AP回復スキル)",[[2,3481]],24069,359,24068,359,24070,329,24067,329,0];
